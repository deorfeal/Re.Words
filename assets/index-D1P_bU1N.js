...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Xc(t){const e=Object.create(null);for(const n of t.split(","))e[n]=1;return n=>n in e}const Fe={},ys=[],gn=()=>{},wv=()=>!1,Ma=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),Zc=t=>t.startsWith("onUpdate:"),et=Object.assign,eu=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Ev=Object.prototype.hasOwnProperty,De=(t,e)=>Ev.call(t,e),le=Array.isArray,vs=t=>to(t)==="[object Map]",Us=t=>to(t)==="[object Set]",hd=t=>to(t)==="[object Date]",ye=t=>typeof t=="function",Je=t=>typeof t=="string",rn=t=>typeof t=="symbol",Ue=t=>t!==null&&typeof t=="object",jp=t=>(Ue(t)||ye(t))&&ye(t.then)&&ye(t.catch),qp=Object.prototype.toString,to=t=>qp.call(t),Tv=t=>to(t).slice(8,-1),Wp=t=>to(t)==="[object Object]",tu=t=>Je(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,vi=Xc(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Fa=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Iv=/-(\w)/g,Jt=Fa(t=>t.replace(Iv,(e,n)=>n?n.toUpperCase():"")),Av=/\B([A-Z])/g,Yr=Fa(t=>t.replace(Av,"-$1").toLowerCase()),Ua=Fa(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ll=Fa(t=>t?`on${Ua(t)}`:""),ar=(t,e)=>!Object.is(t,e),Go=(t,...e)=>{for(let n=0;n<t.length;n++)t[n](...e)},Hp=(t,e,n,r=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:r,value:n})},ua=t=>{const e=parseFloat(t);return isNaN(e)?t:e},bv=t=>{const e=Je(t)?Number(t):NaN;return isNaN(e)?t:e};let dd;const $a=()=>dd||(dd=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function $s(t){if(le(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],s=Je(r)?Pv(r):$s(r);if(s)for(const i in s)e[i]=s[i]}return e}else if(Je(t)||Ue(t))return t}const Cv=/;(?![^(]*\))/g,Sv=/:([^]+)/,Rv=/\/\*[^]*?\*\//g;function Pv(t){const e={};return t.replace(Rv,"").split(Cv).forEach(n=>{if(n){const r=n.split(Sv);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function We(t){let e="";if(Je(t))e=t;else if(le(t))for(let n=0;n<t.length;n++){const r=We(t[n]);r&&(e+=r+" ")}else if(Ue(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const kv="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Vv=Xc(kv);function zp(t){return!!t||t===""}function Ov(t,e){if(t.length!==e.length)return!1;let n=!0;for(let r=0;n&&r<t.length;r++)n=qr(t[r],e[r]);return n}function qr(t,e){if(t===e)return!0;let n=hd(t),r=hd(e);if(n||r)return n&&r?t.getTime()===e.getTime():!1;if(n=rn(t),r=rn(e),n||r)return t===e;if(n=le(t),r=le(e),n||r)return n&&r?Ov(t,e):!1;if(n=Ue(t),r=Ue(e),n||r){if(!n||!r)return!1;const s=Object.keys(t).length,i=Object.keys(e).length;if(s!==i)return!1;for(const o in t){const l=t.hasOwnProperty(o),c=e.hasOwnProperty(o);if(l&&!c||!l&&c||!qr(t[o],e[o]))return!1}}return String(t)===String(e)}function nu(t,e){return t.findIndex(n=>qr(n,e))}const Kp=t=>!!(t&&t.__v_isRef===!0),rt=t=>Je(t)?t:t==null?"":le(t)||Ue(t)&&(t.toString===qp||!ye(t.toString))?Kp(t)?rt(t.value):JSON.stringify(t,Gp,2):String(t),Gp=(t,e)=>Kp(e)?Gp(t,e.value):vs(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,s],i)=>(n[xl(r,i)+" =>"]=s,n),{})}:Us(e)?{[`Set(${e.size})`]:[...e.values()].map(n=>xl(n))}:rn(e)?xl(e):Ue(e)&&!le(e)&&!Wp(e)?String(e):e,xl=(t,e="")=>{var n;return rn(t)?`Symbol(${(n=t.description)!=null?n:e})`:t};/**
* @vue/reactivity v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Dt;class Qp{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=Dt,!e&&Dt&&(this.index=(Dt.scopes||(Dt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,n;if(this.scopes)for(e=0,n=this.scopes.length;e<n;e++)this.scopes[e].pause();for(e=0,n=this.effects.length;e<n;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,n;if(this.scopes)for(e=0,n=this.scopes.length;e<n;e++)this.scopes[e].resume();for(e=0,n=this.effects.length;e<n;e++)this.effects[e].resume()}}run(e){if(this._active){const n=Dt;try{return Dt=this,e()}finally{Dt=n}}}on(){Dt=this}off(){Dt=this.parent}stop(e){if(this._active){this._active=!1;let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(this.effects.length=0,n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Yp(t){return new Qp(t)}function ru(){return Dt}function Jp(t,e=!1){Dt&&Dt.cleanups.push(t)}let $e;const Ml=new WeakSet;class Xp{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Dt&&Dt.active&&Dt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ml.has(this)&&(Ml.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||eg(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,fd(this),tg(this);const e=$e,n=en;$e=this,en=!0;try{return this.fn()}finally{ng(this),$e=e,en=n,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ou(e);this.deps=this.depsTail=void 0,fd(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ml.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){uc(this)&&this.run()}get dirty(){return uc(this)}}let Zp=0,wi,Ei;function eg(t,e=!1){if(t.flags|=8,e){t.next=Ei,Ei=t;return}t.next=wi,wi=t}function su(){Zp++}function iu(){if(--Zp>0)return;if(Ei){let e=Ei;for(Ei=void 0;e;){const n=e.next;e.next=void 0,e.flags&=-9,e=n}}let t;for(;wi;){let e=wi;for(wi=void 0;e;){const n=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(r){t||(t=r)}e=n}}if(t)throw t}function tg(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function ng(t){let e,n=t.depsTail,r=n;for(;r;){const s=r.prevDep;r.version===-1?(r===n&&(n=s),ou(r),Dv(r)):e=r,r.dep.activeLink=r.prevActiveLink,r.prevActiveLink=void 0,r=s}t.deps=e,t.depsTail=n}function uc(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(rg(e.dep.computed)||e.dep.version!==e.version))return!0;return!!t._dirty}function rg(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Li))return;t.globalVersion=Li;const e=t.dep;if(t.flags|=2,e.version>0&&!t.isSSR&&t.deps&&!uc(t)){t.flags&=-3;return}const n=$e,r=en;$e=t,en=!0;try{tg(t);const s=t.fn(t._value);(e.version===0||ar(s,t._value))&&(t._value=s,e.version++)}catch(s){throw e.version++,s}finally{$e=n,en=r,ng(t),t.flags&=-3}}function ou(t,e=!1){const{dep:n,prevSub:r,nextSub:s}=t;if(r&&(r.nextSub=s,t.prevSub=void 0),s&&(s.prevSub=r,t.nextSub=void 0),n.subs===t&&(n.subs=r,!r&&n.computed)){n.computed.flags&=-5;for(let i=n.computed.deps;i;i=i.nextDep)ou(i,!0)}!e&&!--n.sc&&n.map&&n.map.delete(n.key)}function Dv(t){const{prevDep:e,nextDep:n}=t;e&&(e.nextDep=n,t.prevDep=void 0),n&&(n.prevDep=e,t.nextDep=void 0)}let en=!0;const sg=[];function Tr(){sg.push(en),en=!1}function Ir(){const t=sg.pop();en=t===void 0?!0:t}function fd(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const n=$e;$e=void 0;try{e()}finally{$e=n}}}let Li=0;class Nv{constructor(e,n){this.sub=e,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class au{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0}track(e){if(!$e||!en||$e===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==$e)n=this.activeLink=new Nv($e,this),$e.deps?(n.prevDep=$e.depsTail,$e.depsTail.nextDep=n,$e.depsTail=n):$e.deps=$e.depsTail=n,ig(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const r=n.nextDep;r.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=r),n.prevDep=$e.depsTail,n.nextDep=void 0,$e.depsTail.nextDep=n,$e.depsTail=n,$e.deps===n&&($e.deps=r)}return n}trigger(e){this.version++,Li++,this.notify(e)}notify(e){su();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{iu()}}}function ig(t){if(t.dep.sc++,t.sub.flags&4){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let r=e.deps;r;r=r.nextDep)ig(r)}const n=t.dep.subs;n!==t&&(t.prevSub=n,n&&(n.nextSub=t)),t.dep.subs=t}}const ha=new WeakMap,$r=Symbol(""),hc=Symbol(""),xi=Symbol("");function At(t,e,n){if(en&&$e){let r=ha.get(t);r||ha.set(t,r=new Map);let s=r.get(n);s||(r.set(n,s=new au),s.map=r,s.key=n),s.track()}}function Pn(t,e,n,r,s,i){const o=ha.get(t);if(!o){Li++;return}const l=c=>{c&&c.trigger()};if(su(),e==="clear")o.forEach(l);else{const c=le(t),u=c&&tu(n);if(c&&n==="length"){const d=Number(r);o.forEach((p,g)=>{(g==="length"||g===xi||!rn(g)&&g>=d)&&l(p)})}else switch((n!==void 0||o.has(void 0))&&l(o.get(n)),u&&l(o.get(xi)),e){case"add":c?u&&l(o.get("length")):(l(o.get($r)),vs(t)&&l(o.get(hc)));break;case"delete":c||(l(o.get($r)),vs(t)&&l(o.get(hc)));break;case"set":vs(t)&&l(o.get($r));break}}iu()}function Lv(t,e){const n=ha.get(t);return n&&n.get(e)}function ls(t){const e=Se(t);return e===t?e:(At(e,"iterate",xi),Qt(t)?e:e.map(bt))}function Ba(t){return At(t=Se(t),"iterate",xi),t}const xv={__proto__:null,[Symbol.iterator](){return Fl(this,Symbol.iterator,bt)},concat(...t){return ls(this).concat(...t.map(e=>le(e)?ls(e):e))},entries(){return Fl(this,"entries",t=>(t[1]=bt(t[1]),t))},every(t,e){return Cn(this,"every",t,e,void 0,arguments)},filter(t,e){return Cn(this,"filter",t,e,n=>n.map(bt),arguments)},find(t,e){return Cn(this,"find",t,e,bt,arguments)},findIndex(t,e){return Cn(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return Cn(this,"findLast",t,e,bt,arguments)},findLastIndex(t,e){return Cn(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return Cn(this,"forEach",t,e,void 0,arguments)},includes(...t){return Ul(this,"includes",t)},indexOf(...t){return Ul(this,"indexOf",t)},join(t){return ls(this).join(t)},lastIndexOf(...t){return Ul(this,"lastIndexOf",t)},map(t,e){return Cn(this,"map",t,e,void 0,arguments)},pop(){return ci(this,"pop")},push(...t){return ci(this,"push",t)},reduce(t,...e){return pd(this,"reduce",t,e)},reduceRight(t,...e){return pd(this,"reduceRight",t,e)},shift(){return ci(this,"shift")},some(t,e){return Cn(this,"some",t,e,void 0,arguments)},splice(...t){return ci(this,"splice",t)},toReversed(){return ls(this).toReversed()},toSorted(t){return ls(this).toSorted(t)},toSpliced(...t){return ls(this).toSpliced(...t)},unshift(...t){return ci(this,"unshift",t)},values(){return Fl(this,"values",bt)}};function Fl(t,e,n){const r=Ba(t),s=r[e]();return r!==t&&!Qt(t)&&(s._next=s.next,s.next=()=>{const i=s._next();return i.value&&(i.value=n(i.value)),i}),s}const Mv=Array.prototype;function Cn(t,e,n,r,s,i){const o=Ba(t),l=o!==t&&!Qt(t),c=o[e];if(c!==Mv[e]){const p=c.apply(t,i);return l?bt(p):p}let u=n;o!==t&&(l?u=function(p,g){return n.call(this,bt(p),g,t)}:n.length>2&&(u=function(p,g){return n.call(this,p,g,t)}));const d=c.call(o,u,r);return l&&s?s(d):d}function pd(t,e,n,r){const s=Ba(t);let i=n;return s!==t&&(Qt(t)?n.length>3&&(i=function(o,l,c){return n.call(this,o,l,c,t)}):i=function(o,l,c){return n.call(this,o,bt(l),c,t)}),s[e](i,...r)}function Ul(t,e,n){const r=Se(t);At(r,"iterate",xi);const s=r[e](...n);return(s===-1||s===!1)&&uu(n[0])?(n[0]=Se(n[0]),r[e](...n)):s}function ci(t,e,n=[]){Tr(),su();const r=Se(t)[e].apply(t,n);return iu(),Ir(),r}const Fv=Xc("__proto__,__v_isRef,__isVue"),og=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(rn));function Uv(t){rn(t)||(t=String(t));const e=Se(this);return At(e,"has",t),e.hasOwnProperty(t)}class ag{constructor(e=!1,n=!1){this._isReadonly=e,this._isShallow=n}get(e,n,r){if(n==="__v_skip")return e.__v_skip;const s=this._isReadonly,i=this._isShallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return i;if(n==="__v_raw")return r===(s?i?Qv:hg:i?ug:cg).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(r)?e:void 0;const o=le(e);if(!s){let c;if(o&&(c=xv[n]))return c;if(n==="hasOwnProperty")return Uv}const l=Reflect.get(e,n,Ye(e)?e:r);return(rn(n)?og.has(n):Fv(n))||(s||At(e,"get",n),i)?l:Ye(l)?o&&tu(n)?l:l.value:Ue(l)?s?fg(l):no(l):l}}class lg extends ag{constructor(e=!1){super(!1,e)}set(e,n,r,s){let i=e[n];if(!this._isShallow){const c=Wr(i);if(!Qt(r)&&!Wr(r)&&(i=Se(i),r=Se(r)),!le(e)&&Ye(i)&&!Ye(r))return c?!1:(i.value=r,!0)}const o=le(e)&&tu(n)?Number(n)<e.length:De(e,n),l=Reflect.set(e,n,r,Ye(e)?e:s);return e===Se(s)&&(o?ar(r,i)&&Pn(e,"set",n,r):Pn(e,"add",n,r)),l}deleteProperty(e,n){const r=De(e,n);e[n];const s=Reflect.deleteProperty(e,n);return s&&r&&Pn(e,"delete",n,void 0),s}has(e,n){const r=Reflect.has(e,n);return(!rn(n)||!og.has(n))&&At(e,"has",n),r}ownKeys(e){return At(e,"iterate",le(e)?"length":$r),Reflect.ownKeys(e)}}class $v extends ag{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const Bv=new lg,jv=new $v,qv=new lg(!0);const dc=t=>t,No=t=>Reflect.getPrototypeOf(t);function Wv(t,e,n){return function(...r){const s=this.__v_raw,i=Se(s),o=vs(i),l=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,u=s[t](...r),d=n?dc:e?fc:bt;return!e&&At(i,"iterate",c?hc:$r),{next(){const{value:p,done:g}=u.next();return g?{value:p,done:g}:{value:l?[d(p[0]),d(p[1])]:d(p),done:g}},[Symbol.iterator](){return this}}}}function Lo(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Hv(t,e){const n={get(s){const i=this.__v_raw,o=Se(i),l=Se(s);t||(ar(s,l)&&At(o,"get",s),At(o,"get",l));const{has:c}=No(o),u=e?dc:t?fc:bt;if(c.call(o,s))return u(i.get(s));if(c.call(o,l))return u(i.get(l));i!==o&&i.get(s)},get size(){const s=this.__v_raw;return!t&&At(Se(s),"iterate",$r),Reflect.get(s,"size",s)},has(s){const i=this.__v_raw,o=Se(i),l=Se(s);return t||(ar(s,l)&&At(o,"has",s),At(o,"has",l)),s===l?i.has(s):i.has(s)||i.has(l)},forEach(s,i){const o=this,l=o.__v_raw,c=Se(l),u=e?dc:t?fc:bt;return!t&&At(c,"iterate",$r),l.forEach((d,p)=>s.call(i,u(d),u(p),o))}};return et(n,t?{add:Lo("add"),set:Lo("set"),delete:Lo("delete"),clear:Lo("clear")}:{add(s){!e&&!Qt(s)&&!Wr(s)&&(s=Se(s));const i=Se(this);return No(i).has.call(i,s)||(i.add(s),Pn(i,"add",s,s)),this},set(s,i){!e&&!Qt(i)&&!Wr(i)&&(i=Se(i));const o=Se(this),{has:l,get:c}=No(o);let u=l.call(o,s);u||(s=Se(s),u=l.call(o,s));const d=c.call(o,s);return o.set(s,i),u?ar(i,d)&&Pn(o,"set",s,i):Pn(o,"add",s,i),this},delete(s){const i=Se(this),{has:o,get:l}=No(i);let c=o.call(i,s);c||(s=Se(s),c=o.call(i,s)),l&&l.call(i,s);const u=i.delete(s);return c&&Pn(i,"delete",s,void 0),u},clear(){const s=Se(this),i=s.size!==0,o=s.clear();return i&&Pn(s,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(s=>{n[s]=Wv(s,t,e)}),n}function lu(t,e){const n=Hv(t,e);return(r,s,i)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?r:Reflect.get(De(n,s)&&s in r?n:r,s,i)}const zv={get:lu(!1,!1)},Kv={get:lu(!1,!0)},Gv={get:lu(!0,!1)};const cg=new WeakMap,ug=new WeakMap,hg=new WeakMap,Qv=new WeakMap;function Yv(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Jv(t){return t.__v_skip||!Object.isExtensible(t)?0:Yv(Tv(t))}function no(t){return Wr(t)?t:cu(t,!1,Bv,zv,cg)}function dg(t){return cu(t,!1,qv,Kv,ug)}function fg(t){return cu(t,!0,jv,Gv,hg)}function cu(t,e,n,r,s){if(!Ue(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=s.get(t);if(i)return i;const o=Jv(t);if(o===0)return t;const l=new Proxy(t,o===2?r:n);return s.set(t,l),l}function lr(t){return Wr(t)?lr(t.__v_raw):!!(t&&t.__v_isReactive)}function Wr(t){return!!(t&&t.__v_isReadonly)}function Qt(t){return!!(t&&t.__v_isShallow)}function uu(t){return t?!!t.__v_raw:!1}function Se(t){const e=t&&t.__v_raw;return e?Se(e):t}function hu(t){return!De(t,"__v_skip")&&Object.isExtensible(t)&&Hp(t,"__v_skip",!0),t}const bt=t=>Ue(t)?no(t):t,fc=t=>Ue(t)?fg(t):t;function Ye(t){return t?t.__v_isRef===!0:!1}function ge(t){return pg(t,!1)}function Xv(t){return pg(t,!0)}function pg(t,e){return Ye(t)?t:new Zv(t,e)}class Zv{constructor(e,n){this.dep=new au,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?e:Se(e),this._value=n?e:bt(e),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(e){const n=this._rawValue,r=this.__v_isShallow||Qt(e)||Wr(e);e=r?e:Se(e),ar(e,n)&&(this._rawValue=e,this._value=r?e:bt(e),this.dep.trigger())}}function Q(t){return Ye(t)?t.value:t}const e0={get:(t,e,n)=>e==="__v_raw"?t:Q(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const s=t[e];return Ye(s)&&!Ye(n)?(s.value=n,!0):Reflect.set(t,e,n,r)}};function gg(t){return lr(t)?t:new Proxy(t,e0)}function t0(t){const e=le(t)?new Array(t.length):{};for(const n in t)e[n]=r0(t,n);return e}class n0{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0,this._value=void 0}get value(){const e=this._object[this._key];return this._value=e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return Lv(Se(this._object),this._key)}}function r0(t,e,n){const r=t[e];return Ye(r)?r:new n0(t,e,n)}class s0{constructor(e,n,r){this.fn=e,this.setter=n,this._value=void 0,this.dep=new au(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Li-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=r}notify(){if(this.flags|=16,!(this.flags&8)&&$e!==this)return eg(this,!0),!0}get value(){const e=this.dep.track();return rg(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function i0(t,e,n=!1){let r,s;return ye(t)?r=t:(r=t.get,s=t.set),new s0(r,s,n)}const xo={},da=new WeakMap;let xr;function o0(t,e=!1,n=xr){if(n){let r=da.get(n);r||da.set(n,r=[]),r.push(t)}}function a0(t,e,n=Fe){const{immediate:r,deep:s,once:i,scheduler:o,augmentJob:l,call:c}=n,u=F=>s?F:Qt(F)||s===!1||s===0?kn(F,1):kn(F);let d,p,g,m,T=!1,C=!1;if(Ye(t)?(p=()=>t.value,T=Qt(t)):lr(t)?(p=()=>u(t),T=!0):le(t)?(C=!0,T=t.some(F=>lr(F)||Qt(F)),p=()=>t.map(F=>{if(Ye(F))return F.value;if(lr(F))return u(F);if(ye(F))return c?c(F,2):F()})):ye(t)?e?p=c?()=>c(t,2):t:p=()=>{if(g){Tr();try{g()}finally{Ir()}}const F=xr;xr=d;try{return c?c(t,3,[m]):t(m)}finally{xr=F}}:p=gn,e&&s){const F=p,H=s===!0?1/0:s;p=()=>kn(F(),H)}const P=ru(),O=()=>{d.stop(),P&&P.active&&eu(P.effects,d)};if(i&&e){const F=e;e=(...H)=>{F(...H),O()}}let N=C?new Array(t.length).fill(xo):xo;const $=F=>{if(!(!(d.flags&1)||!d.dirty&&!F))if(e){const H=d.run();if(s||T||(C?H.some((ee,S)=>ar(ee,N[S])):ar(H,N))){g&&g();const ee=xr;xr=d;try{const S=[H,N===xo?void 0:C&&N[0]===xo?[]:N,m];c?c(e,3,S):e(...S),N=H}finally{xr=ee}}}else d.run()};return l&&l($),d=new Xp(p),d.scheduler=o?()=>o($,!1):$,m=F=>o0(F,!1,d),g=d.onStop=()=>{const F=da.get(d);if(F){if(c)c(F,4);else for(const H of F)H();da.delete(d)}},e?r?$(!0):N=d.run():o?o($.bind(null,!0),!0):d.run(),O.pause=d.pause.bind(d),O.resume=d.resume.bind(d),O.stop=O,O}function kn(t,e=1/0,n){if(e<=0||!Ue(t)||t.__v_skip||(n=n||new Set,n.has(t)))return t;if(n.add(t),e--,Ye(t))kn(t.value,e,n);else if(le(t))for(let r=0;r<t.length;r++)kn(t[r],e,n);else if(Us(t)||vs(t))t.forEach(r=>{kn(r,e,n)});else if(Wp(t)){for(const r in t)kn(t[r],e,n);for(const r of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,r)&&kn(t[r],e,n)}return t}/**
* @vue/runtime-core v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ro(t,e,n,r){try{return r?t(...r):t()}catch(s){ja(s,e,n)}}function sn(t,e,n,r){if(ye(t)){const s=ro(t,e,n,r);return s&&jp(s)&&s.catch(i=>{ja(i,e,n)}),s}if(le(t)){const s=[];for(let i=0;i<t.length;i++)s.push(sn(t[i],e,n,r));return s}}function ja(t,e,n,r=!0){const s=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||Fe;if(e){let l=e.parent;const c=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${n}`;for(;l;){const d=l.ec;if(d){for(let p=0;p<d.length;p++)if(d[p](t,c,u)===!1)return}l=l.parent}if(i){Tr(),ro(i,null,10,[t,c,u]),Ir();return}}l0(t,n,s,r,o)}function l0(t,e,n,r=!0,s=!1){if(s)throw t;console.error(t)}const Nt=[];let dn=-1;const ws=[];let Xn=null,us=0;const mg=Promise.resolve();let fa=null;function qa(t){const e=fa||mg;return t?e.then(this?t.bind(this):t):e}function c0(t){let e=dn+1,n=Nt.length;for(;e<n;){const r=e+n>>>1,s=Nt[r],i=Mi(s);i<t||i===t&&s.flags&2?e=r+1:n=r}return e}function du(t){if(!(t.flags&1)){const e=Mi(t),n=Nt[Nt.length-1];!n||!(t.flags&2)&&e>=Mi(n)?Nt.push(t):Nt.splice(c0(e),0,t),t.flags|=1,_g()}}function _g(){fa||(fa=mg.then(vg))}function u0(t){le(t)?ws.push(...t):Xn&&t.id===-1?Xn.splice(us+1,0,t):t.flags&1||(ws.push(t),t.flags|=1),_g()}function gd(t,e,n=dn+1){for(;n<Nt.length;n++){const r=Nt[n];if(r&&r.flags&2){if(t&&r.id!==t.uid)continue;Nt.splice(n,1),n--,r.flags&4&&(r.flags&=-2),r(),r.flags&4||(r.flags&=-2)}}}function yg(t){if(ws.length){const e=[...new Set(ws)].sort((n,r)=>Mi(n)-Mi(r));if(ws.length=0,Xn){Xn.push(...e);return}for(Xn=e,us=0;us<Xn.length;us++){const n=Xn[us];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}Xn=null,us=0}}const Mi=t=>t.id==null?t.flags&2?-1:1/0:t.id;function vg(t){try{for(dn=0;dn<Nt.length;dn++){const e=Nt[dn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),ro(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;dn<Nt.length;dn++){const e=Nt[dn];e&&(e.flags&=-2)}dn=-1,Nt.length=0,yg(),fa=null,(Nt.length||ws.length)&&vg()}}let st=null,wg=null;function pa(t){const e=st;return st=t,wg=t&&t.type.__scopeId||null,e}function St(t,e=st,n){if(!e||t._n)return t;const r=(...s)=>{r._d&&Pd(-1);const i=pa(e);let o;try{o=t(...s)}finally{pa(i),r._d&&Pd(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function tn(t,e){if(st===null)return t;const n=Qa(st),r=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[i,o,l,c=Fe]=e[s];i&&(ye(i)&&(i={mounted:i,updated:i}),i.deep&&kn(o),r.push({dir:i,instance:n,value:o,oldValue:void 0,arg:l,modifiers:c}))}return t}function Dr(t,e,n,r){const s=t.dirs,i=e&&e.dirs;for(let o=0;o<s.length;o++){const l=s[o];i&&(l.oldValue=i[o].value);let c=l.dir[r];c&&(Tr(),sn(c,n,8,[t.el,l,t,e]),Ir())}}const Eg=Symbol("_vte"),Tg=t=>t.__isTeleport,Ti=t=>t&&(t.disabled||t.disabled===""),md=t=>t&&(t.defer||t.defer===""),_d=t=>typeof SVGElement<"u"&&t instanceof SVGElement,yd=t=>typeof MathMLElement=="function"&&t instanceof MathMLElement,pc=(t,e)=>{const n=t&&t.to;return Je(n)?e?e(n):null:n},Ig={name:"Teleport",__isTeleport:!0,process(t,e,n,r,s,i,o,l,c,u){const{mc:d,pc:p,pbc:g,o:{insert:m,querySelector:T,createText:C,createComment:P}}=u,O=Ti(e.props);let{shapeFlag:N,children:$,dynamicChildren:F}=e;if(t==null){const H=e.el=C(""),ee=e.anchor=C("");m(H,n,r),m(ee,n,r);const S=(y,I)=>{N&16&&(s&&s.isCE&&(s.ce._teleportTarget=y),d($,y,I,s,i,o,l,c))},v=()=>{const y=e.target=pc(e.props,T),I=Ag(y,e,C,m);y&&(o!=="svg"&&_d(y)?o="svg":o!=="mathml"&&yd(y)&&(o="mathml"),O||(S(y,I),Qo(e,!1)))};O&&(S(n,ee),Qo(e,!0)),md(e.props)?Ot(()=>{v(),e.el.__isMounted=!0},i):v()}else{if(md(e.props)&&!t.el.__isMounted){Ot(()=>{Ig.process(t,e,n,r,s,i,o,l,c,u),delete t.el.__isMounted},i);return}e.el=t.el,e.targetStart=t.targetStart;const H=e.anchor=t.anchor,ee=e.target=t.target,S=e.targetAnchor=t.targetAnchor,v=Ti(t.props),y=v?n:ee,I=v?H:S;if(o==="svg"||_d(ee)?o="svg":(o==="mathml"||yd(ee))&&(o="mathml"),F?(g(t.dynamicChildren,F,y,s,i,o,l),yu(t,e,!0)):c||p(t,e,y,I,s,i,o,l,!1),O)v?e.props&&t.props&&e.props.to!==t.props.to&&(e.props.to=t.props.to):Mo(e,n,H,u,1);else if((e.props&&e.props.to)!==(t.props&&t.props.to)){const R=e.target=pc(e.props,T);R&&Mo(e,R,null,u,0)}else v&&Mo(e,ee,S,u,1);Qo(e,O)}},remove(t,e,n,{um:r,o:{remove:s}},i){const{shapeFlag:o,children:l,anchor:c,targetStart:u,targetAnchor:d,target:p,props:g}=t;if(p&&(s(u),s(d)),i&&s(c),o&16){const m=i||!Ti(g);for(let T=0;T<l.length;T++){const C=l[T];r(C,e,n,m,!!C.dynamicChildren)}}},move:Mo,hydrate:h0};function Mo(t,e,n,{o:{insert:r},m:s},i=2){i===0&&r(t.targetAnchor,e,n);const{el:o,anchor:l,shapeFlag:c,children:u,props:d}=t,p=i===2;if(p&&r(o,e,n),(!p||Ti(d))&&c&16)for(let g=0;g<u.length;g++)s(u[g],e,n,2);p&&r(l,e,n)}function h0(t,e,n,r,s,i,{o:{nextSibling:o,parentNode:l,querySelector:c,insert:u,createText:d}},p){const g=e.target=pc(e.props,c);if(g){const m=Ti(e.props),T=g._lpa||g.firstChild;if(e.shapeFlag&16)if(m)e.anchor=p(o(t),e,l(t),n,r,s,i),e.targetStart=T,e.targetAnchor=T&&o(T);else{e.anchor=o(t);let C=T;for(;C;){if(C&&C.nodeType===8){if(C.data==="teleport start anchor")e.targetStart=C;else if(C.data==="teleport anchor"){e.targetAnchor=C,g._lpa=e.targetAnchor&&o(e.targetAnchor);break}}C=o(C)}e.targetAnchor||Ag(g,e,d,u),p(T&&o(T),e,g,n,r,s,i)}Qo(e,m)}return e.anchor&&o(e.anchor)}const Bs=Ig;function Qo(t,e){const n=t.ctx;if(n&&n.ut){let r,s;for(e?(r=t.el,s=t.anchor):(r=t.targetStart,s=t.targetAnchor);r&&r!==s;)r.nodeType===1&&r.setAttribute("data-v-owner",n.uid),r=r.nextSibling;n.ut()}}function Ag(t,e,n,r){const s=e.targetStart=n(""),i=e.targetAnchor=n("");return s[Eg]=i,t&&(r(s,t),r(i,t)),i}const Zn=Symbol("_leaveCb"),Fo=Symbol("_enterCb");function bg(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Jr(()=>{t.isMounted=!0}),pu(()=>{t.isUnmounting=!0}),t}const Gt=[Function,Array],Cg={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Gt,onEnter:Gt,onAfterEnter:Gt,onEnterCancelled:Gt,onBeforeLeave:Gt,onLeave:Gt,onAfterLeave:Gt,onLeaveCancelled:Gt,onBeforeAppear:Gt,onAppear:Gt,onAfterAppear:Gt,onAppearCancelled:Gt},Sg=t=>{const e=t.subTree;return e.component?Sg(e.component):e},d0={name:"BaseTransition",props:Cg,setup(t,{slots:e}){const n=Xg(),r=bg();return()=>{const s=e.default&&fu(e.default(),!0);if(!s||!s.length)return;const i=Rg(s),o=Se(t),{mode:l}=o;if(r.isLeaving)return $l(i);const c=vd(i);if(!c)return $l(i);let u=Fi(c,o,r,n,p=>u=p);c.type!==Lt&&Hr(c,u);let d=n.subTree&&vd(n.subTree);if(d&&d.type!==Lt&&!Fr(c,d)&&Sg(n).type!==Lt){let p=Fi(d,o,r,n);if(Hr(d,p),l==="out-in"&&c.type!==Lt)return r.isLeaving=!0,p.afterLeave=()=>{r.isLeaving=!1,n.job.flags&8||n.update(),delete p.afterLeave,d=void 0},$l(i);l==="in-out"&&c.type!==Lt?p.delayLeave=(g,m,T)=>{const C=Pg(r,d);C[String(d.key)]=d,g[Zn]=()=>{m(),g[Zn]=void 0,delete u.delayedLeave,d=void 0},u.delayedLeave=()=>{T(),delete u.delayedLeave,d=void 0}}:d=void 0}else d&&(d=void 0);return i}}};function Rg(t){let e=t[0];if(t.length>1){for(const n of t)if(n.type!==Lt){e=n;break}}return e}const f0=d0;function Pg(t,e){const{leavingVNodes:n}=t;let r=n.get(e.type);return r||(r=Object.create(null),n.set(e.type,r)),r}function Fi(t,e,n,r,s){const{appear:i,mode:o,persisted:l=!1,onBeforeEnter:c,onEnter:u,onAfterEnter:d,onEnterCancelled:p,onBeforeLeave:g,onLeave:m,onAfterLeave:T,onLeaveCancelled:C,onBeforeAppear:P,onAppear:O,onAfterAppear:N,onAppearCancelled:$}=e,F=String(t.key),H=Pg(n,t),ee=(y,I)=>{y&&sn(y,r,9,I)},S=(y,I)=>{const R=I[1];ee(y,I),le(y)?y.every(b=>b.length<=1)&&R():y.length<=1&&R()},v={mode:o,persisted:l,beforeEnter(y){let I=c;if(!n.isMounted)if(i)I=P||c;else return;y[Zn]&&y[Zn](!0);const R=H[F];R&&Fr(t,R)&&R.el[Zn]&&R.el[Zn](),ee(I,[y])},enter(y){let I=u,R=d,b=p;if(!n.isMounted)if(i)I=O||u,R=N||d,b=$||p;else return;let E=!1;const Ve=y[Fo]=Xe=>{E||(E=!0,Xe?ee(b,[y]):ee(R,[y]),v.delayedLeave&&v.delayedLeave(),y[Fo]=void 0)};I?S(I,[y,Ve]):Ve()},leave(y,I){const R=String(t.key);if(y[Fo]&&y[Fo](!0),n.isUnmounting)return I();ee(g,[y]);let b=!1;const E=y[Zn]=Ve=>{b||(b=!0,I(),Ve?ee(C,[y]):ee(T,[y]),y[Zn]=void 0,H[R]===t&&delete H[R])};H[R]=t,m?S(m,[y,E]):E()},clone(y){const I=Fi(y,e,n,r,s);return s&&s(I),I}};return v}function $l(t){if(Wa(t))return t=pr(t),t.children=null,t}function vd(t){if(!Wa(t))return Tg(t.type)&&t.children?Rg(t.children):t;const{shapeFlag:e,children:n}=t;if(n){if(e&16)return n[0];if(e&32&&ye(n.default))return n.default()}}function Hr(t,e){t.shapeFlag&6&&t.component?(t.transition=e,Hr(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function fu(t,e=!1,n){let r=[],s=0;for(let i=0;i<t.length;i++){let o=t[i];const l=n==null?o.key:String(n)+String(o.key!=null?o.key:i);o.type===Be?(o.patchFlag&128&&s++,r=r.concat(fu(o.children,e,l))):(e||o.type!==Lt)&&r.push(l!=null?pr(o,{key:l}):o)}if(s>1)for(let i=0;i<r.length;i++)r[i].patchFlag=-2;return r}/*! #__NO_SIDE_EFFECTS__ */function He(t,e){return ye(t)?et({name:t.name},e,{setup:t}):t}function kg(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function ga(t,e,n,r,s=!1){if(le(t)){t.forEach((T,C)=>ga(T,e&&(le(e)?e[C]:e),n,r,s));return}if(Es(r)&&!s){r.shapeFlag&512&&r.type.__asyncResolved&&r.component.subTree.component&&ga(t,e,n,r.component.subTree);return}const i=r.shapeFlag&4?Qa(r.component):r.el,o=s?null:i,{i:l,r:c}=t,u=e&&e.r,d=l.refs===Fe?l.refs={}:l.refs,p=l.setupState,g=Se(p),m=p===Fe?()=>!1:T=>De(g,T);if(u!=null&&u!==c&&(Je(u)?(d[u]=null,m(u)&&(p[u]=null)):Ye(u)&&(u.value=null)),ye(c))ro(c,l,12,[o,d]);else{const T=Je(c),C=Ye(c);if(T||C){const P=()=>{if(t.f){const O=T?m(c)?p[c]:d[c]:c.value;s?le(O)&&eu(O,i):le(O)?O.includes(i)||O.push(i):T?(d[c]=[i],m(c)&&(p[c]=d[c])):(c.value=[i],t.k&&(d[t.k]=c.value))}else T?(d[c]=o,m(c)&&(p[c]=o)):C&&(c.value=o,t.k&&(d[t.k]=o))};o?(P.id=-1,Ot(P,n)):P()}}}$a().requestIdleCallback;$a().cancelIdleCallback;const Es=t=>!!t.type.__asyncLoader,Wa=t=>t.type.__isKeepAlive;function p0(t,e){Vg(t,"a",e)}function g0(t,e){Vg(t,"da",e)}function Vg(t,e,n=ct){const r=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(Ha(e,r,n),n){let s=n.parent;for(;s&&s.parent;)Wa(s.parent.vnode)&&m0(r,e,n,s),s=s.parent}}function m0(t,e,n,r){const s=Ha(e,t,r,!0);Dg(()=>{eu(r[e],s)},n)}function Ha(t,e,n=ct,r=!1){if(n){const s=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{Tr();const l=so(n),c=sn(e,n,t,o);return l(),Ir(),c});return r?s.unshift(i):s.push(i),i}}const $n=t=>(e,n=ct)=>{(!Bi||t==="sp")&&Ha(t,(...r)=>e(...r),n)},_0=$n("bm"),Jr=$n("m"),y0=$n("bu"),Og=$n("u"),pu=$n("bum"),Dg=$n("um"),v0=$n("sp"),w0=$n("rtg"),E0=$n("rtc");function T0(t,e=ct){Ha("ec",t,e)}const I0="components";function gu(t,e){return b0(I0,t,!0,e)||t}const A0=Symbol.for("v-ndc");function b0(t,e,n=!0,r=!1){const s=st||ct;if(s){const i=s.type;{const l=f1(i,!1);if(l&&(l===e||l===Jt(e)||l===Ua(Jt(e))))return i}const o=wd(s[t]||i[t],e)||wd(s.appContext[t],e);return!o&&r?i:o}}function wd(t,e){return t&&(t[e]||t[Jt(e)]||t[Ua(Jt(e))])}function En(t,e,n,r){let s;const i=n,o=le(t);if(o||Je(t)){const l=o&&lr(t);let c=!1;l&&(c=!Qt(t),t=Ba(t)),s=new Array(t.length);for(let u=0,d=t.length;u<d;u++)s[u]=e(c?bt(t[u]):t[u],u,void 0,i)}else if(typeof t=="number"){s=new Array(t);for(let l=0;l<t;l++)s[l]=e(l+1,l,void 0,i)}else if(Ue(t))if(t[Symbol.iterator])s=Array.from(t,(l,c)=>e(l,c,void 0,i));else{const l=Object.keys(t);s=new Array(l.length);for(let c=0,u=l.length;c<u;c++){const d=l[c];s[c]=e(t[d],d,c,i)}}else s=[];return s}function Ed(t,e,n={},r,s){if(st.ce||st.parent&&Es(st.parent)&&st.parent.ce)return e!=="default"&&(n.name=e),X(),xt(Be,null,[de("slot",n,r)],64);let i=t[e];i&&i._c&&(i._d=!1),X();const o=i&&Ng(i(n)),l=n.key||o&&o.key,c=xt(Be,{key:(l&&!rn(l)?l:`_${e}`)+(!o&&r?"_fb":"")},o||[],o&&t._===1?64:-2);return c.scopeId&&(c.slotScopeIds=[c.scopeId+"-s"]),i&&i._c&&(i._d=!0),c}function Ng(t){return t.some(e=>$i(e)?!(e.type===Lt||e.type===Be&&!Ng(e.children)):!0)?t:null}const gc=t=>t?Zg(t)?Qa(t):gc(t.parent):null,Ii=et(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>gc(t.parent),$root:t=>gc(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>mu(t),$forceUpdate:t=>t.f||(t.f=()=>{du(t.update)}),$nextTick:t=>t.n||(t.n=qa.bind(t.proxy)),$watch:t=>G0.bind(t)}),Bl=(t,e)=>t!==Fe&&!t.__isScriptSetup&&De(t,e),C0={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:n,setupState:r,data:s,props:i,accessCache:o,type:l,appContext:c}=t;let u;if(e[0]!=="$"){const m=o[e];if(m!==void 0)switch(m){case 1:return r[e];case 2:return s[e];case 4:return n[e];case 3:return i[e]}else{if(Bl(r,e))return o[e]=1,r[e];if(s!==Fe&&De(s,e))return o[e]=2,s[e];if((u=t.propsOptions[0])&&De(u,e))return o[e]=3,i[e];if(n!==Fe&&De(n,e))return o[e]=4,n[e];mc&&(o[e]=0)}}const d=Ii[e];let p,g;if(d)return e==="$attrs"&&At(t.attrs,"get",""),d(t);if((p=l.__cssModules)&&(p=p[e]))return p;if(n!==Fe&&De(n,e))return o[e]=4,n[e];if(g=c.config.globalProperties,De(g,e))return g[e]},set({_:t},e,n){const{data:r,setupState:s,ctx:i}=t;return Bl(s,e)?(s[e]=n,!0):r!==Fe&&De(r,e)?(r[e]=n,!0):De(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:s,propsOptions:i}},o){let l;return!!n[o]||t!==Fe&&De(t,o)||Bl(e,o)||(l=i[0])&&De(l,o)||De(r,o)||De(Ii,o)||De(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:De(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function Td(t){return le(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let mc=!0;function S0(t){const e=mu(t),n=t.proxy,r=t.ctx;mc=!1,e.beforeCreate&&Id(e.beforeCreate,t,"bc");const{data:s,computed:i,methods:o,watch:l,provide:c,inject:u,created:d,beforeMount:p,mounted:g,beforeUpdate:m,updated:T,activated:C,deactivated:P,beforeDestroy:O,beforeUnmount:N,destroyed:$,unmounted:F,render:H,renderTracked:ee,renderTriggered:S,errorCaptured:v,serverPrefetch:y,expose:I,inheritAttrs:R,components:b,directives:E,filters:Ve}=e;if(u&&R0(u,r,null),o)for(const pe in o){const Ee=o[pe];ye(Ee)&&(r[pe]=Ee.bind(n))}if(s){const pe=s.call(n,n);Ue(pe)&&(t.data=no(pe))}if(mc=!0,i)for(const pe in i){const Ee=i[pe],Bt=ye(Ee)?Ee.bind(n,n):ye(Ee.get)?Ee.get.bind(n,n):gn,Xt=!ye(Ee)&&ye(Ee.set)?Ee.set.bind(n):gn,zt=we({get:Bt,set:Xt});Object.defineProperty(r,pe,{enumerable:!0,configurable:!0,get:()=>zt.value,set:ze=>zt.value=ze})}if(l)for(const pe in l)Lg(l[pe],r,n,pe);if(c){const pe=ye(c)?c.call(n):c;Reflect.ownKeys(pe).forEach(Ee=>{Ai(Ee,pe[Ee])})}d&&Id(d,t,"c");function Le(pe,Ee){le(Ee)?Ee.forEach(Bt=>pe(Bt.bind(n))):Ee&&pe(Ee.bind(n))}if(Le(_0,p),Le(Jr,g),Le(y0,m),Le(Og,T),Le(p0,C),Le(g0,P),Le(T0,v),Le(E0,ee),Le(w0,S),Le(pu,N),Le(Dg,F),Le(v0,y),le(I))if(I.length){const pe=t.exposed||(t.exposed={});I.forEach(Ee=>{Object.defineProperty(pe,Ee,{get:()=>n[Ee],set:Bt=>n[Ee]=Bt})})}else t.exposed||(t.exposed={});H&&t.render===gn&&(t.render=H),R!=null&&(t.inheritAttrs=R),b&&(t.components=b),E&&(t.directives=E),y&&kg(t)}function R0(t,e,n=gn){le(t)&&(t=_c(t));for(const r in t){const s=t[r];let i;Ue(s)?"default"in s?i=Ht(s.from||r,s.default,!0):i=Ht(s.from||r):i=Ht(s),Ye(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[r]=i}}function Id(t,e,n){sn(le(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function Lg(t,e,n,r){let s=r.includes(".")?Kg(n,r):()=>n[r];if(Je(t)){const i=e[t];ye(i)&&mt(s,i)}else if(ye(t))mt(s,t.bind(n));else if(Ue(t))if(le(t))t.forEach(i=>Lg(i,e,n,r));else{const i=ye(t.handler)?t.handler.bind(n):e[t.handler];ye(i)&&mt(s,i,t)}}function mu(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,l=i.get(e);let c;return l?c=l:!s.length&&!n&&!r?c=e:(c={},s.length&&s.forEach(u=>ma(c,u,o,!0)),ma(c,e,o)),Ue(e)&&i.set(e,c),c}function ma(t,e,n,r=!1){const{mixins:s,extends:i}=e;i&&ma(t,i,n,!0),s&&s.forEach(o=>ma(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const l=P0[o]||n&&n[o];t[o]=l?l(t[o],e[o]):e[o]}return t}const P0={data:Ad,props:bd,emits:bd,methods:di,computed:di,beforeCreate:Vt,created:Vt,beforeMount:Vt,mounted:Vt,beforeUpdate:Vt,updated:Vt,beforeDestroy:Vt,beforeUnmount:Vt,destroyed:Vt,unmounted:Vt,activated:Vt,deactivated:Vt,errorCaptured:Vt,serverPrefetch:Vt,components:di,directives:di,watch:V0,provide:Ad,inject:k0};function Ad(t,e){return e?t?function(){return et(ye(t)?t.call(this,this):t,ye(e)?e.call(this,this):e)}:e:t}function k0(t,e){return di(_c(t),_c(e))}function _c(t){if(le(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Vt(t,e){return t?[...new Set([].concat(t,e))]:e}function di(t,e){return t?et(Object.create(null),t,e):e}function bd(t,e){return t?le(t)&&le(e)?[...new Set([...t,...e])]:et(Object.create(null),Td(t),Td(e??{})):e}function V0(t,e){if(!t)return e;if(!e)return t;const n=et(Object.create(null),t);for(const r in e)n[r]=Vt(t[r],e[r]);return n}function xg(){return{app:null,config:{isNativeTag:wv,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let O0=0;function D0(t,e){return function(r,s=null){ye(r)||(r=et({},r)),s!=null&&!Ue(s)&&(s=null);const i=xg(),o=new WeakSet,l=[];let c=!1;const u=i.app={_uid:O0++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:g1,get config(){return i.config},set config(d){},use(d,...p){return o.has(d)||(d&&ye(d.install)?(o.add(d),d.install(u,...p)):ye(d)&&(o.add(d),d(u,...p))),u},mixin(d){return i.mixins.includes(d)||i.mixins.push(d),u},component(d,p){return p?(i.components[d]=p,u):i.components[d]},directive(d,p){return p?(i.directives[d]=p,u):i.directives[d]},mount(d,p,g){if(!c){const m=u._ceVNode||de(r,s);return m.appContext=i,g===!0?g="svg":g===!1&&(g=void 0),p&&e?e(m,d):t(m,d,g),c=!0,u._container=d,d.__vue_app__=u,Qa(m.component)}},onUnmount(d){l.push(d)},unmount(){c&&(sn(l,u._instance,16),t(null,u._container),delete u._container.__vue_app__)},provide(d,p){return i.provides[d]=p,u},runWithContext(d){const p=Br;Br=u;try{return d()}finally{Br=p}}};return u}}let Br=null;function Ai(t,e){if(ct){let n=ct.provides;const r=ct.parent&&ct.parent.provides;r===n&&(n=ct.provides=Object.create(r)),n[t]=e}}function Ht(t,e,n=!1){const r=ct||st;if(r||Br){const s=Br?Br._context.provides:r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:void 0;if(s&&t in s)return s[t];if(arguments.length>1)return n&&ye(e)?e.call(r&&r.proxy):e}}function N0(){return!!(ct||st||Br)}const Mg={},Fg=()=>Object.create(Mg),Ug=t=>Object.getPrototypeOf(t)===Mg;function L0(t,e,n,r=!1){const s={},i=Fg();t.propsDefaults=Object.create(null),$g(t,e,s,i);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=r?s:dg(s):t.type.props?t.props=s:t.props=i,t.attrs=i}function x0(t,e,n,r){const{props:s,attrs:i,vnode:{patchFlag:o}}=t,l=Se(s),[c]=t.propsOptions;let u=!1;if((r||o>0)&&!(o&16)){if(o&8){const d=t.vnode.dynamicProps;for(let p=0;p<d.length;p++){let g=d[p];if(za(t.emitsOptions,g))continue;const m=e[g];if(c)if(De(i,g))m!==i[g]&&(i[g]=m,u=!0);else{const T=Jt(g);s[T]=yc(c,l,T,m,t,!1)}else m!==i[g]&&(i[g]=m,u=!0)}}}else{$g(t,e,s,i)&&(u=!0);let d;for(const p in l)(!e||!De(e,p)&&((d=Yr(p))===p||!De(e,d)))&&(c?n&&(n[p]!==void 0||n[d]!==void 0)&&(s[p]=yc(c,l,p,void 0,t,!0)):delete s[p]);if(i!==l)for(const p in i)(!e||!De(e,p))&&(delete i[p],u=!0)}u&&Pn(t.attrs,"set","")}function $g(t,e,n,r){const[s,i]=t.propsOptions;let o=!1,l;if(e)for(let c in e){if(vi(c))continue;const u=e[c];let d;s&&De(s,d=Jt(c))?!i||!i.includes(d)?n[d]=u:(l||(l={}))[d]=u:za(t.emitsOptions,c)||(!(c in r)||u!==r[c])&&(r[c]=u,o=!0)}if(i){const c=Se(n),u=l||Fe;for(let d=0;d<i.length;d++){const p=i[d];n[p]=yc(s,c,p,u[p],t,!De(u,p))}}return o}function yc(t,e,n,r,s,i){const o=t[n];if(o!=null){const l=De(o,"default");if(l&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&ye(c)){const{propsDefaults:u}=s;if(n in u)r=u[n];else{const d=so(s);r=u[n]=c.call(null,e),d()}}else r=c;s.ce&&s.ce._setProp(n,r)}o[0]&&(i&&!l?r=!1:o[1]&&(r===""||r===Yr(n))&&(r=!0))}return r}const M0=new WeakMap;function Bg(t,e,n=!1){const r=n?M0:e.propsCache,s=r.get(t);if(s)return s;const i=t.props,o={},l=[];let c=!1;if(!ye(t)){const d=p=>{c=!0;const[g,m]=Bg(p,e,!0);et(o,g),m&&l.push(...m)};!n&&e.mixins.length&&e.mixins.forEach(d),t.extends&&d(t.extends),t.mixins&&t.mixins.forEach(d)}if(!i&&!c)return Ue(t)&&r.set(t,ys),ys;if(le(i))for(let d=0;d<i.length;d++){const p=Jt(i[d]);Cd(p)&&(o[p]=Fe)}else if(i)for(const d in i){const p=Jt(d);if(Cd(p)){const g=i[d],m=o[p]=le(g)||ye(g)?{type:g}:et({},g),T=m.type;let C=!1,P=!0;if(le(T))for(let O=0;O<T.length;++O){const N=T[O],$=ye(N)&&N.name;if($==="Boolean"){C=!0;break}else $==="String"&&(P=!1)}else C=ye(T)&&T.name==="Boolean";m[0]=C,m[1]=P,(C||De(m,"default"))&&l.push(p)}}const u=[o,l];return Ue(t)&&r.set(t,u),u}function Cd(t){return t[0]!=="$"&&!vi(t)}const jg=t=>t[0]==="_"||t==="$stable",_u=t=>le(t)?t.map(fn):[fn(t)],F0=(t,e,n)=>{if(e._n)return e;const r=St((...s)=>_u(e(...s)),n);return r._c=!1,r},qg=(t,e,n)=>{const r=t._ctx;for(const s in t){if(jg(s))continue;const i=t[s];if(ye(i))e[s]=F0(s,i,r);else if(i!=null){const o=_u(i);e[s]=()=>o}}},Wg=(t,e)=>{const n=_u(e);t.slots.default=()=>n},Hg=(t,e,n)=>{for(const r in e)(n||r!=="_")&&(t[r]=e[r])},U0=(t,e,n)=>{const r=t.slots=Fg();if(t.vnode.shapeFlag&32){const s=e._;s?(Hg(r,e,n),n&&Hp(r,"_",s,!0)):qg(e,r)}else e&&Wg(t,e)},$0=(t,e,n)=>{const{vnode:r,slots:s}=t;let i=!0,o=Fe;if(r.shapeFlag&32){const l=e._;l?n&&l===1?i=!1:Hg(s,e,n):(i=!e.$stable,qg(e,s)),o=e}else e&&(Wg(t,e),o={default:1});if(i)for(const l in s)!jg(l)&&o[l]==null&&delete s[l]},Ot=t1;function B0(t){return j0(t)}function j0(t,e){const n=$a();n.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:o,createText:l,createComment:c,setText:u,setElementText:d,parentNode:p,nextSibling:g,setScopeId:m=gn,insertStaticContent:T}=t,C=(w,A,V,j=null,x=null,q=null,Y=void 0,K=null,z=!!A.dynamicChildren)=>{if(w===A)return;w&&!Fr(w,A)&&(j=M(w),ze(w,x,q,!0),w=null),A.patchFlag===-2&&(z=!1,A.dynamicChildren=null);const{type:W,ref:ue,shapeFlag:Z}=A;switch(W){case Ka:P(w,A,V,j);break;case Lt:O(w,A,V,j);break;case Wl:w==null&&N(A,V,j,Y);break;case Be:b(w,A,V,j,x,q,Y,K,z);break;default:Z&1?H(w,A,V,j,x,q,Y,K,z):Z&6?E(w,A,V,j,x,q,Y,K,z):(Z&64||Z&128)&&W.process(w,A,V,j,x,q,Y,K,z,se)}ue!=null&&x&&ga(ue,w&&w.ref,q,A||w,!A)},P=(w,A,V,j)=>{if(w==null)r(A.el=l(A.children),V,j);else{const x=A.el=w.el;A.children!==w.children&&u(x,A.children)}},O=(w,A,V,j)=>{w==null?r(A.el=c(A.children||""),V,j):A.el=w.el},N=(w,A,V,j)=>{[w.el,w.anchor]=T(w.children,A,V,j,w.el,w.anchor)},$=({el:w,anchor:A},V,j)=>{let x;for(;w&&w!==A;)x=g(w),r(w,V,j),w=x;r(A,V,j)},F=({el:w,anchor:A})=>{let V;for(;w&&w!==A;)V=g(w),s(w),w=V;s(A)},H=(w,A,V,j,x,q,Y,K,z)=>{A.type==="svg"?Y="svg":A.type==="math"&&(Y="mathml"),w==null?ee(A,V,j,x,q,Y,K,z):y(w,A,x,q,Y,K,z)},ee=(w,A,V,j,x,q,Y,K)=>{let z,W;const{props:ue,shapeFlag:Z,transition:ae,dirs:ie}=w;if(z=w.el=o(w.type,q,ue&&ue.is,ue),Z&8?d(z,w.children):Z&16&&v(w.children,z,null,j,x,jl(w,q),Y,K),ie&&Dr(w,null,j,"created"),S(z,w,w.scopeId,Y,j),ue){for(const ke in ue)ke!=="value"&&!vi(ke)&&i(z,ke,null,ue[ke],q,j);"value"in ue&&i(z,"value",null,ue.value,q),(W=ue.onVnodeBeforeMount)&&un(W,j,w)}ie&&Dr(w,null,j,"beforeMount");const he=q0(x,ae);he&&ae.beforeEnter(z),r(z,A,V),((W=ue&&ue.onVnodeMounted)||he||ie)&&Ot(()=>{W&&un(W,j,w),he&&ae.enter(z),ie&&Dr(w,null,j,"mounted")},x)},S=(w,A,V,j,x)=>{if(V&&m(w,V),j)for(let q=0;q<j.length;q++)m(w,j[q]);if(x){let q=x.subTree;if(A===q||Qg(q.type)&&(q.ssContent===A||q.ssFallback===A)){const Y=x.vnode;S(w,Y,Y.scopeId,Y.slotScopeIds,x.parent)}}},v=(w,A,V,j,x,q,Y,K,z=0)=>{for(let W=z;W<w.length;W++){const ue=w[W]=K?er(w[W]):fn(w[W]);C(null,ue,A,V,j,x,q,Y,K)}},y=(w,A,V,j,x,q,Y)=>{const K=A.el=w.el;let{patchFlag:z,dynamicChildren:W,dirs:ue}=A;z|=w.patchFlag&16;const Z=w.props||Fe,ae=A.props||Fe;let ie;if(V&&Nr(V,!1),(ie=ae.onVnodeBeforeUpdate)&&un(ie,V,A,w),ue&&Dr(A,w,V,"beforeUpdate"),V&&Nr(V,!0),(Z.innerHTML&&ae.innerHTML==null||Z.textContent&&ae.textContent==null)&&d(K,""),W?I(w.dynamicChildren,W,K,V,j,jl(A,x),q):Y||Ee(w,A,K,null,V,j,jl(A,x),q,!1),z>0){if(z&16)R(K,Z,ae,V,x);else if(z&2&&Z.class!==ae.class&&i(K,"class",null,ae.class,x),z&4&&i(K,"style",Z.style,ae.style,x),z&8){const he=A.dynamicProps;for(let ke=0;ke<he.length;ke++){const Re=he[ke],yt=Z[Re],at=ae[Re];(at!==yt||Re==="value")&&i(K,Re,yt,at,x,V)}}z&1&&w.children!==A.children&&d(K,A.children)}else!Y&&W==null&&R(K,Z,ae,V,x);((ie=ae.onVnodeUpdated)||ue)&&Ot(()=>{ie&&un(ie,V,A,w),ue&&Dr(A,w,V,"updated")},j)},I=(w,A,V,j,x,q,Y)=>{for(let K=0;K<A.length;K++){const z=w[K],W=A[K],ue=z.el&&(z.type===Be||!Fr(z,W)||z.shapeFlag&70)?p(z.el):V;C(z,W,ue,null,j,x,q,Y,!0)}},R=(w,A,V,j,x)=>{if(A!==V){if(A!==Fe)for(const q in A)!vi(q)&&!(q in V)&&i(w,q,A[q],null,x,j);for(const q in V){if(vi(q))continue;const Y=V[q],K=A[q];Y!==K&&q!=="value"&&i(w,q,K,Y,x,j)}"value"in V&&i(w,"value",A.value,V.value,x)}},b=(w,A,V,j,x,q,Y,K,z)=>{const W=A.el=w?w.el:l(""),ue=A.anchor=w?w.anchor:l("");let{patchFlag:Z,dynamicChildren:ae,slotScopeIds:ie}=A;ie&&(K=K?K.concat(ie):ie),w==null?(r(W,V,j),r(ue,V,j),v(A.children||[],V,ue,x,q,Y,K,z)):Z>0&&Z&64&&ae&&w.dynamicChildren?(I(w.dynamicChildren,ae,V,x,q,Y,K),(A.key!=null||x&&A===x.subTree)&&yu(w,A,!0)):Ee(w,A,V,ue,x,q,Y,K,z)},E=(w,A,V,j,x,q,Y,K,z)=>{A.slotScopeIds=K,w==null?A.shapeFlag&512?x.ctx.activate(A,V,j,Y,z):Ve(A,V,j,x,q,Y,z):Xe(w,A,z)},Ve=(w,A,V,j,x,q,Y)=>{const K=w.component=l1(w,j,x);if(Wa(w)&&(K.ctx.renderer=se),c1(K,!1,Y),K.asyncDep){if(x&&x.registerDep(K,Le,Y),!w.el){const z=K.subTree=de(Lt);O(null,z,A,V)}}else Le(K,w,A,V,x,q,Y)},Xe=(w,A,V)=>{const j=A.component=w.component;if(Z0(w,A,V))if(j.asyncDep&&!j.asyncResolved){pe(j,A,V);return}else j.next=A,j.update();else A.el=w.el,j.vnode=A},Le=(w,A,V,j,x,q,Y)=>{const K=()=>{if(w.isMounted){let{next:Z,bu:ae,u:ie,parent:he,vnode:ke}=w;{const vt=zg(w);if(vt){Z&&(Z.el=ke.el,pe(w,Z,Y)),vt.asyncDep.then(()=>{w.isUnmounted||K()});return}}let Re=Z,yt;Nr(w,!1),Z?(Z.el=ke.el,pe(w,Z,Y)):Z=ke,ae&&Go(ae),(yt=Z.props&&Z.props.onVnodeBeforeUpdate)&&un(yt,he,Z,ke),Nr(w,!0);const at=ql(w),ht=w.subTree;w.subTree=at,C(ht,at,p(ht.el),M(ht),w,x,q),Z.el=at.el,Re===null&&e1(w,at.el),ie&&Ot(ie,x),(yt=Z.props&&Z.props.onVnodeUpdated)&&Ot(()=>un(yt,he,Z,ke),x)}else{let Z;const{el:ae,props:ie}=A,{bm:he,m:ke,parent:Re,root:yt,type:at}=w,ht=Es(A);if(Nr(w,!1),he&&Go(he),!ht&&(Z=ie&&ie.onVnodeBeforeMount)&&un(Z,Re,A),Nr(w,!0),ae&&xe){const vt=()=>{w.subTree=ql(w),xe(ae,w.subTree,w,x,null)};ht&&at.__asyncHydrate?at.__asyncHydrate(ae,w,vt):vt()}else{yt.ce&&yt.ce._injectChildStyle(at);const vt=w.subTree=ql(w);C(null,vt,V,j,w,x,q),A.el=vt.el}if(ke&&Ot(ke,x),!ht&&(Z=ie&&ie.onVnodeMounted)){const vt=A;Ot(()=>un(Z,Re,vt),x)}(A.shapeFlag&256||Re&&Es(Re.vnode)&&Re.vnode.shapeFlag&256)&&w.a&&Ot(w.a,x),w.isMounted=!0,A=V=j=null}};w.scope.on();const z=w.effect=new Xp(K);w.scope.off();const W=w.update=z.run.bind(z),ue=w.job=z.runIfDirty.bind(z);ue.i=w,ue.id=w.uid,z.scheduler=()=>du(ue),Nr(w,!0),W()},pe=(w,A,V)=>{A.component=w;const j=w.vnode.props;w.vnode=A,w.next=null,x0(w,A.props,j,V),$0(w,A.children,V),Tr(),gd(w),Ir()},Ee=(w,A,V,j,x,q,Y,K,z=!1)=>{const W=w&&w.children,ue=w?w.shapeFlag:0,Z=A.children,{patchFlag:ae,shapeFlag:ie}=A;if(ae>0){if(ae&128){Xt(W,Z,V,j,x,q,Y,K,z);return}else if(ae&256){Bt(W,Z,V,j,x,q,Y,K,z);return}}ie&8?(ue&16&&Mt(W,x,q),Z!==W&&d(V,Z)):ue&16?ie&16?Xt(W,Z,V,j,x,q,Y,K,z):Mt(W,x,q,!0):(ue&8&&d(V,""),ie&16&&v(Z,V,j,x,q,Y,K,z))},Bt=(w,A,V,j,x,q,Y,K,z)=>{w=w||ys,A=A||ys;const W=w.length,ue=A.length,Z=Math.min(W,ue);let ae;for(ae=0;ae<Z;ae++){const ie=A[ae]=z?er(A[ae]):fn(A[ae]);C(w[ae],ie,V,null,x,q,Y,K,z)}W>ue?Mt(w,x,q,!0,!1,Z):v(A,V,j,x,q,Y,K,z,Z)},Xt=(w,A,V,j,x,q,Y,K,z)=>{let W=0;const ue=A.length;let Z=w.length-1,ae=ue-1;for(;W<=Z&&W<=ae;){const ie=w[W],he=A[W]=z?er(A[W]):fn(A[W]);if(Fr(ie,he))C(ie,he,V,null,x,q,Y,K,z);else break;W++}for(;W<=Z&&W<=ae;){const ie=w[Z],he=A[ae]=z?er(A[ae]):fn(A[ae]);if(Fr(ie,he))C(ie,he,V,null,x,q,Y,K,z);else break;Z--,ae--}if(W>Z){if(W<=ae){const ie=ae+1,he=ie<ue?A[ie].el:j;for(;W<=ae;)C(null,A[W]=z?er(A[W]):fn(A[W]),V,he,x,q,Y,K,z),W++}}else if(W>ae)for(;W<=Z;)ze(w[W],x,q,!0),W++;else{const ie=W,he=W,ke=new Map;for(W=he;W<=ae;W++){const Pt=A[W]=z?er(A[W]):fn(A[W]);Pt.key!=null&&ke.set(Pt.key,W)}let Re,yt=0;const at=ae-he+1;let ht=!1,vt=0;const qn=new Array(at);for(W=0;W<at;W++)qn[W]=0;for(W=ie;W<=Z;W++){const Pt=w[W];if(yt>=at){ze(Pt,x,q,!0);continue}let Kt;if(Pt.key!=null)Kt=ke.get(Pt.key);else for(Re=he;Re<=ae;Re++)if(qn[Re-he]===0&&Fr(Pt,A[Re])){Kt=Re;break}Kt===void 0?ze(Pt,x,q,!0):(qn[Kt-he]=W+1,Kt>=vt?vt=Kt:ht=!0,C(Pt,A[Kt],V,null,x,q,Y,K,z),yt++)}const ns=ht?W0(qn):ys;for(Re=ns.length-1,W=at-1;W>=0;W--){const Pt=he+W,Kt=A[Pt],rs=Pt+1<ue?A[Pt+1].el:j;qn[W]===0?C(null,Kt,V,rs,x,q,Y,K,z):ht&&(Re<0||W!==ns[Re]?zt(Kt,V,rs,2):Re--)}}},zt=(w,A,V,j,x=null)=>{const{el:q,type:Y,transition:K,children:z,shapeFlag:W}=w;if(W&6){zt(w.component.subTree,A,V,j);return}if(W&128){w.suspense.move(A,V,j);return}if(W&64){Y.move(w,A,V,se);return}if(Y===Be){r(q,A,V);for(let Z=0;Z<z.length;Z++)zt(z[Z],A,V,j);r(w.anchor,A,V);return}if(Y===Wl){$(w,A,V);return}if(j!==2&&W&1&&K)if(j===0)K.beforeEnter(q),r(q,A,V),Ot(()=>K.enter(q),x);else{const{leave:Z,delayLeave:ae,afterLeave:ie}=K,he=()=>r(q,A,V),ke=()=>{Z(q,()=>{he(),ie&&ie()})};ae?ae(q,he,ke):ke()}else r(q,A,V)},ze=(w,A,V,j=!1,x=!1)=>{const{type:q,props:Y,ref:K,children:z,dynamicChildren:W,shapeFlag:ue,patchFlag:Z,dirs:ae,cacheIndex:ie}=w;if(Z===-2&&(x=!1),K!=null&&ga(K,null,V,w,!0),ie!=null&&(A.renderCache[ie]=void 0),ue&256){A.ctx.deactivate(w);return}const he=ue&1&&ae,ke=!Es(w);let Re;if(ke&&(Re=Y&&Y.onVnodeBeforeUnmount)&&un(Re,A,w),ue&6)cn(w.component,V,j);else{if(ue&128){w.suspense.unmount(V,j);return}he&&Dr(w,null,A,"beforeUnmount"),ue&64?w.type.remove(w,A,V,se,j):W&&!W.hasOnce&&(q!==Be||Z>0&&Z&64)?Mt(W,A,V,!1,!0):(q===Be&&Z&384||!x&&ue&16)&&Mt(z,A,V),j&&Ke(w)}(ke&&(Re=Y&&Y.onVnodeUnmounted)||he)&&Ot(()=>{Re&&un(Re,A,w),he&&Dr(w,null,A,"unmounted")},V)},Ke=w=>{const{type:A,el:V,anchor:j,transition:x}=w;if(A===Be){jn(V,j);return}if(A===Wl){F(w);return}const q=()=>{s(V),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(w.shapeFlag&1&&x&&!x.persisted){const{leave:Y,delayLeave:K}=x,z=()=>Y(V,q);K?K(w.el,q,z):z()}else q()},jn=(w,A)=>{let V;for(;w!==A;)V=g(w),s(w),w=V;s(A)},cn=(w,A,V)=>{const{bum:j,scope:x,job:q,subTree:Y,um:K,m:z,a:W}=w;Sd(z),Sd(W),j&&Go(j),x.stop(),q&&(q.flags|=8,ze(Y,w,A,V)),K&&Ot(K,A),Ot(()=>{w.isUnmounted=!0},A),A&&A.pendingBranch&&!A.isUnmounted&&w.asyncDep&&!w.asyncResolved&&w.suspenseId===A.pendingId&&(A.deps--,A.deps===0&&A.resolve())},Mt=(w,A,V,j=!1,x=!1,q=0)=>{for(let Y=q;Y<w.length;Y++)ze(w[Y],A,V,j,x)},M=w=>{if(w.shapeFlag&6)return M(w.component.subTree);if(w.shapeFlag&128)return w.suspense.next();const A=g(w.anchor||w.el),V=A&&A[Eg];return V?g(V):A};let te=!1;const J=(w,A,V)=>{w==null?A._vnode&&ze(A._vnode,null,null,!0):C(A._vnode||null,w,A,null,null,null,V),A._vnode=w,te||(te=!0,gd(),yg(),te=!1)},se={p:C,um:ze,m:zt,r:Ke,mt:Ve,mc:v,pc:Ee,pbc:I,n:M,o:t};let be,xe;return{render:J,hydrate:be,createApp:D0(J,be)}}function jl({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function Nr({effect:t,job:e},n){n?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function q0(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function yu(t,e,n=!1){const r=t.children,s=e.children;if(le(r)&&le(s))for(let i=0;i<r.length;i++){const o=r[i];let l=s[i];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[i]=er(s[i]),l.el=o.el),!n&&l.patchFlag!==-2&&yu(o,l)),l.type===Ka&&(l.el=o.el)}}function W0(t){const e=t.slice(),n=[0];let r,s,i,o,l;const c=t.length;for(r=0;r<c;r++){const u=t[r];if(u!==0){if(s=n[n.length-1],t[s]<u){e[r]=s,n.push(r);continue}for(i=0,o=n.length-1;i<o;)l=i+o>>1,t[n[l]]<u?i=l+1:o=l;u<t[n[i]]&&(i>0&&(e[r]=n[i-1]),n[i]=r)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}function zg(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:zg(e)}function Sd(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const H0=Symbol.for("v-scx"),z0=()=>Ht(H0);function K0(t,e){return vu(t,null,e)}function mt(t,e,n){return vu(t,e,n)}function vu(t,e,n=Fe){const{immediate:r,deep:s,flush:i,once:o}=n,l=et({},n),c=e&&r||!e&&i!=="post";let u;if(Bi){if(i==="sync"){const m=z0();u=m.__watcherHandles||(m.__watcherHandles=[])}else if(!c){const m=()=>{};return m.stop=gn,m.resume=gn,m.pause=gn,m}}const d=ct;l.call=(m,T,C)=>sn(m,d,T,C);let p=!1;i==="post"?l.scheduler=m=>{Ot(m,d&&d.suspense)}:i!=="sync"&&(p=!0,l.scheduler=(m,T)=>{T?m():du(m)}),l.augmentJob=m=>{e&&(m.flags|=4),p&&(m.flags|=2,d&&(m.id=d.uid,m.i=d))};const g=a0(t,e,l);return Bi&&(u?u.push(g):c&&g()),g}function G0(t,e,n){const r=this.proxy,s=Je(t)?t.includes(".")?Kg(r,t):()=>r[t]:t.bind(r,r);let i;ye(e)?i=e:(i=e.handler,n=e);const o=so(this),l=vu(s,i.bind(r),n);return o(),l}function Kg(t,e){const n=e.split(".");return()=>{let r=t;for(let s=0;s<n.length&&r;s++)r=r[n[s]];return r}}const Q0=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${Jt(e)}Modifiers`]||t[`${Yr(e)}Modifiers`];function Y0(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||Fe;let s=n;const i=e.startsWith("update:"),o=i&&Q0(r,e.slice(7));o&&(o.trim&&(s=n.map(d=>Je(d)?d.trim():d)),o.number&&(s=n.map(ua)));let l,c=r[l=Ll(e)]||r[l=Ll(Jt(e))];!c&&i&&(c=r[l=Ll(Yr(e))]),c&&sn(c,t,6,s);const u=r[l+"Once"];if(u){if(!t.emitted)t.emitted={};else if(t.emitted[l])return;t.emitted[l]=!0,sn(u,t,6,s)}}function Gg(t,e,n=!1){const r=e.emitsCache,s=r.get(t);if(s!==void 0)return s;const i=t.emits;let o={},l=!1;if(!ye(t)){const c=u=>{const d=Gg(u,e,!0);d&&(l=!0,et(o,d))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!i&&!l?(Ue(t)&&r.set(t,null),null):(le(i)?i.forEach(c=>o[c]=null):et(o,i),Ue(t)&&r.set(t,o),o)}function za(t,e){return!t||!Ma(e)?!1:(e=e.slice(2).replace(/Once$/,""),De(t,e[0].toLowerCase()+e.slice(1))||De(t,Yr(e))||De(t,e))}function ql(t){const{type:e,vnode:n,proxy:r,withProxy:s,propsOptions:[i],slots:o,attrs:l,emit:c,render:u,renderCache:d,props:p,data:g,setupState:m,ctx:T,inheritAttrs:C}=t,P=pa(t);let O,N;try{if(n.shapeFlag&4){const F=s||r,H=F;O=fn(u.call(H,F,d,p,m,g,T)),N=l}else{const F=e;O=fn(F.length>1?F(p,{attrs:l,slots:o,emit:c}):F(p,null)),N=e.props?l:J0(l)}}catch(F){bi.length=0,ja(F,t,1),O=de(Lt)}let $=O;if(N&&C!==!1){const F=Object.keys(N),{shapeFlag:H}=$;F.length&&H&7&&(i&&F.some(Zc)&&(N=X0(N,i)),$=pr($,N,!1,!0))}return n.dirs&&($=pr($,null,!1,!0),$.dirs=$.dirs?$.dirs.concat(n.dirs):n.dirs),n.transition&&Hr($,n.transition),O=$,pa(P),O}const J0=t=>{let e;for(const n in t)(n==="class"||n==="style"||Ma(n))&&((e||(e={}))[n]=t[n]);return e},X0=(t,e)=>{const n={};for(const r in t)(!Zc(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function Z0(t,e,n){const{props:r,children:s,component:i}=t,{props:o,children:l,patchFlag:c}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?Rd(r,o,u):!!o;if(c&8){const d=e.dynamicProps;for(let p=0;p<d.length;p++){const g=d[p];if(o[g]!==r[g]&&!za(u,g))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:r===o?!1:r?o?Rd(r,o,u):!0:!!o;return!1}function Rd(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(e[i]!==t[i]&&!za(n,i))return!0}return!1}function e1({vnode:t,parent:e},n){for(;e;){const r=e.subTree;if(r.suspense&&r.suspense.activeBranch===t&&(r.el=t.el),r===t)(t=e.vnode).el=n,e=e.parent;else break}}const Qg=t=>t.__isSuspense;function t1(t,e){e&&e.pendingBranch?le(t)?e.effects.push(...t):e.effects.push(t):u0(t)}const Be=Symbol.for("v-fgt"),Ka=Symbol.for("v-txt"),Lt=Symbol.for("v-cmt"),Wl=Symbol.for("v-stc"),bi=[];let qt=null;function X(t=!1){bi.push(qt=t?null:[])}function n1(){bi.pop(),qt=bi[bi.length-1]||null}let Ui=1;function Pd(t,e=!1){Ui+=t,t<0&&qt&&e&&(qt.hasOnce=!0)}function Yg(t){return t.dynamicChildren=Ui>0?qt||ys:null,n1(),Ui>0&&qt&&qt.push(t),t}function oe(t,e,n,r,s,i){return Yg(L(t,e,n,r,s,i,!0))}function xt(t,e,n,r,s){return Yg(de(t,e,n,r,s,!0))}function $i(t){return t?t.__v_isVNode===!0:!1}function Fr(t,e){return t.type===e.type&&t.key===e.key}const Jg=({key:t})=>t??null,Yo=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Je(t)||Ye(t)||ye(t)?{i:st,r:t,k:e,f:!!n}:t:null);function L(t,e=null,n=null,r=0,s=null,i=t===Be?0:1,o=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Jg(e),ref:e&&Yo(e),scopeId:wg,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:st};return l?(wu(c,n),i&128&&t.normalize(c)):n&&(c.shapeFlag|=Je(n)?8:16),Ui>0&&!o&&qt&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&qt.push(c),c}const de=r1;function r1(t,e=null,n=null,r=0,s=null,i=!1){if((!t||t===A0)&&(t=Lt),$i(t)){const l=pr(t,e,!0);return n&&wu(l,n),Ui>0&&!i&&qt&&(l.shapeFlag&6?qt[qt.indexOf(t)]=l:qt.push(l)),l.patchFlag=-2,l}if(p1(t)&&(t=t.__vccOpts),e){e=s1(e);let{class:l,style:c}=e;l&&!Je(l)&&(e.class=We(l)),Ue(c)&&(uu(c)&&!le(c)&&(c=et({},c)),e.style=$s(c))}const o=Je(t)?1:Qg(t)?128:Tg(t)?64:Ue(t)?4:ye(t)?2:0;return L(t,e,n,r,s,o,i,!0)}function s1(t){return t?uu(t)||Ug(t)?et({},t):t:null}function pr(t,e,n=!1,r=!1){const{props:s,ref:i,patchFlag:o,children:l,transition:c}=t,u=e?i1(s||{},e):s,d={__v_isVNode:!0,__v_skip:!0,type:t.type,props:u,key:u&&Jg(u),ref:e&&e.ref?n&&i?le(i)?i.concat(Yo(e)):[i,Yo(e)]:Yo(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:l,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Be?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:c,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&pr(t.ssContent),ssFallback:t.ssFallback&&pr(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return c&&r&&Hr(d,c.clone(d)),d}function Ga(t=" ",e=0){return de(Ka,null,t,e)}function pt(t="",e=!1){return e?(X(),xt(Lt,null,t)):de(Lt,null,t)}function fn(t){return t==null||typeof t=="boolean"?de(Lt):le(t)?de(Be,null,t.slice()):$i(t)?er(t):de(Ka,null,String(t))}function er(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:pr(t)}function wu(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(le(e))n=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),wu(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!Ug(e)?e._ctx=st:s===3&&st&&(st.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ye(e)?(e={default:e,_ctx:st},n=32):(e=String(e),r&64?(n=16,e=[Ga(e)]):n=8);t.children=e,t.shapeFlag|=n}function i1(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=We([e.class,r.class]));else if(s==="style")e.style=$s([e.style,r.style]);else if(Ma(s)){const i=e[s],o=r[s];o&&i!==o&&!(le(i)&&i.includes(o))&&(e[s]=i?[].concat(i,o):o)}else s!==""&&(e[s]=r[s])}return e}function un(t,e,n,r=null){sn(t,e,7,[n,r])}const o1=xg();let a1=0;function l1(t,e,n){const r=t.type,s=(e?e.appContext:t.appContext)||o1,i={uid:a1++,vnode:t,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Qp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Bg(r,s),emitsOptions:Gg(r,s),emit:null,emitted:null,propsDefaults:Fe,inheritAttrs:r.inheritAttrs,ctx:Fe,data:Fe,props:Fe,attrs:Fe,slots:Fe,refs:Fe,setupState:Fe,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Y0.bind(null,i),t.ce&&t.ce(i),i}let ct=null;const Xg=()=>ct||st;let _a,vc;{const t=$a(),e=(n,r)=>{let s;return(s=t[n])||(s=t[n]=[]),s.push(r),i=>{s.length>1?s.forEach(o=>o(i)):s[0](i)}};_a=e("__VUE_INSTANCE_SETTERS__",n=>ct=n),vc=e("__VUE_SSR_SETTERS__",n=>Bi=n)}const so=t=>{const e=ct;return _a(t),t.scope.on(),()=>{t.scope.off(),_a(e)}},kd=()=>{ct&&ct.scope.off(),_a(null)};function Zg(t){return t.vnode.shapeFlag&4}let Bi=!1;function c1(t,e=!1,n=!1){e&&vc(e);const{props:r,children:s}=t.vnode,i=Zg(t);L0(t,r,i,e),U0(t,s,n);const o=i?u1(t,e):void 0;return e&&vc(!1),o}function u1(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,C0);const{setup:r}=n;if(r){Tr();const s=t.setupContext=r.length>1?d1(t):null,i=so(t),o=ro(r,t,0,[t.props,s]),l=jp(o);if(Ir(),i(),(l||t.sp)&&!Es(t)&&kg(t),l){if(o.then(kd,kd),e)return o.then(c=>{Vd(t,c,e)}).catch(c=>{ja(c,t,0)});t.asyncDep=o}else Vd(t,o,e)}else em(t,e)}function Vd(t,e,n){ye(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Ue(e)&&(t.setupState=gg(e)),em(t,n)}let Od;function em(t,e,n){const r=t.type;if(!t.render){if(!e&&Od&&!r.render){const s=r.template||mu(t).template;if(s){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:l,compilerOptions:c}=r,u=et(et({isCustomElement:i,delimiters:l},o),c);r.render=Od(s,u)}}t.render=r.render||gn}{const s=so(t);Tr();try{S0(t)}finally{Ir(),s()}}}const h1={get(t,e){return At(t,"get",""),t[e]}};function d1(t){const e=n=>{t.exposed=n||{}};return{attrs:new Proxy(t.attrs,h1),slots:t.slots,emit:t.emit,expose:e}}function Qa(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(gg(hu(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Ii)return Ii[n](t)},has(e,n){return n in e||n in Ii}})):t.proxy}function f1(t,e=!0){return ye(t)?t.displayName||t.name:t.name||e&&t.__name}function p1(t){return ye(t)&&"__vccOpts"in t}const we=(t,e)=>i0(t,e,Bi);function Eu(t,e,n){const r=arguments.length;return r===2?Ue(e)&&!le(e)?$i(e)?de(t,null,[e]):de(t,e):de(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&$i(n)&&(n=[n]),de(t,e,n))}const g1="3.5.13";/**
* @vue/runtime-dom v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let wc;const Dd=typeof window<"u"&&window.trustedTypes;if(Dd)try{wc=Dd.createPolicy("vue",{createHTML:t=>t})}catch{}const tm=wc?t=>wc.createHTML(t):t=>t,m1="http://www.w3.org/2000/svg",_1="http://www.w3.org/1998/Math/MathML",Rn=typeof document<"u"?document:null,Nd=Rn&&Rn.createElement("template"),y1={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const s=e==="svg"?Rn.createElementNS(m1,t):e==="mathml"?Rn.createElementNS(_1,t):n?Rn.createElement(t,{is:n}):Rn.createElement(t);return t==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:t=>Rn.createTextNode(t),createComment:t=>Rn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Rn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,r,s,i){const o=n?n.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===i||!(s=s.nextSibling)););else{Nd.innerHTML=tm(r==="svg"?`<svg>${t}</svg>`:r==="mathml"?`<math>${t}</math>`:t);const l=Nd.content;if(r==="svg"||r==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}e.insertBefore(l,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},Kn="transition",ui="animation",Cs=Symbol("_vtc"),nm={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},rm=et({},Cg,nm),v1=t=>(t.displayName="Transition",t.props=rm,t),Ya=v1((t,{slots:e})=>Eu(f0,sm(t),e)),Lr=(t,e=[])=>{le(t)?t.forEach(n=>n(...e)):t&&t(...e)},Ld=t=>t?le(t)?t.some(e=>e.length>1):t.length>1:!1;function sm(t){const e={};for(const b in t)b in nm||(e[b]=t[b]);if(t.css===!1)return e;const{name:n="v",type:r,duration:s,enterFromClass:i=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:c=i,appearActiveClass:u=o,appearToClass:d=l,leaveFromClass:p=`${n}-leave-from`,leaveActiveClass:g=`${n}-leave-active`,leaveToClass:m=`${n}-leave-to`}=t,T=w1(s),C=T&&T[0],P=T&&T[1],{onBeforeEnter:O,onEnter:N,onEnterCancelled:$,onLeave:F,onLeaveCancelled:H,onBeforeAppear:ee=O,onAppear:S=N,onAppearCancelled:v=$}=e,y=(b,E,Ve,Xe)=>{b._enterCancelled=Xe,Yn(b,E?d:l),Yn(b,E?u:o),Ve&&Ve()},I=(b,E)=>{b._isLeaving=!1,Yn(b,p),Yn(b,m),Yn(b,g),E&&E()},R=b=>(E,Ve)=>{const Xe=b?S:N,Le=()=>y(E,b,Ve);Lr(Xe,[E,Le]),xd(()=>{Yn(E,b?c:i),hn(E,b?d:l),Ld(Xe)||Md(E,r,C,Le)})};return et(e,{onBeforeEnter(b){Lr(O,[b]),hn(b,i),hn(b,o)},onBeforeAppear(b){Lr(ee,[b]),hn(b,c),hn(b,u)},onEnter:R(!1),onAppear:R(!0),onLeave(b,E){b._isLeaving=!0;const Ve=()=>I(b,E);hn(b,p),b._enterCancelled?(hn(b,g),Ec()):(Ec(),hn(b,g)),xd(()=>{b._isLeaving&&(Yn(b,p),hn(b,m),Ld(F)||Md(b,r,P,Ve))}),Lr(F,[b,Ve])},onEnterCancelled(b){y(b,!1,void 0,!0),Lr($,[b])},onAppearCancelled(b){y(b,!0,void 0,!0),Lr(v,[b])},onLeaveCancelled(b){I(b),Lr(H,[b])}})}function w1(t){if(t==null)return null;if(Ue(t))return[Hl(t.enter),Hl(t.leave)];{const e=Hl(t);return[e,e]}}function Hl(t){return bv(t)}function hn(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t[Cs]||(t[Cs]=new Set)).add(e)}function Yn(t,e){e.split(/\s+/).forEach(r=>r&&t.classList.remove(r));const n=t[Cs];n&&(n.delete(e),n.size||(t[Cs]=void 0))}function xd(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let E1=0;function Md(t,e,n,r){const s=t._endId=++E1,i=()=>{s===t._endId&&r()};if(n!=null)return setTimeout(i,n);const{type:o,timeout:l,propCount:c}=im(t,e);if(!o)return r();const u=o+"end";let d=0;const p=()=>{t.removeEventListener(u,g),i()},g=m=>{m.target===t&&++d>=c&&p()};setTimeout(()=>{d<c&&p()},l+1),t.addEventListener(u,g)}function im(t,e){const n=window.getComputedStyle(t),r=T=>(n[T]||"").split(", "),s=r(`${Kn}Delay`),i=r(`${Kn}Duration`),o=Fd(s,i),l=r(`${ui}Delay`),c=r(`${ui}Duration`),u=Fd(l,c);let d=null,p=0,g=0;e===Kn?o>0&&(d=Kn,p=o,g=i.length):e===ui?u>0&&(d=ui,p=u,g=c.length):(p=Math.max(o,u),d=p>0?o>u?Kn:ui:null,g=d?d===Kn?i.length:c.length:0);const m=d===Kn&&/\b(transform|all)(,|$)/.test(r(`${Kn}Property`).toString());return{type:d,timeout:p,propCount:g,hasTransform:m}}function Fd(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,r)=>Ud(n)+Ud(t[r])))}function Ud(t){return t==="auto"?0:Number(t.slice(0,-1).replace(",","."))*1e3}function Ec(){return document.body.offsetHeight}function T1(t,e,n){const r=t[Cs];r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const $d=Symbol("_vod"),I1=Symbol("_vsh"),A1=Symbol(""),b1=/(^|;)\s*display\s*:/;function C1(t,e,n){const r=t.style,s=Je(n);let i=!1;if(n&&!s){if(e)if(Je(e))for(const o of e.split(";")){const l=o.slice(0,o.indexOf(":")).trim();n[l]==null&&Jo(r,l,"")}else for(const o in e)n[o]==null&&Jo(r,o,"");for(const o in n)o==="display"&&(i=!0),Jo(r,o,n[o])}else if(s){if(e!==n){const o=r[A1];o&&(n+=";"+o),r.cssText=n,i=b1.test(n)}}else e&&t.removeAttribute("style");$d in t&&(t[$d]=i?r.display:"",t[I1]&&(r.display="none"))}const Bd=/\s*!important$/;function Jo(t,e,n){if(le(n))n.forEach(r=>Jo(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=S1(t,e);Bd.test(n)?t.setProperty(Yr(r),n.replace(Bd,""),"important"):t[r]=n}}const jd=["Webkit","Moz","ms"],zl={};function S1(t,e){const n=zl[e];if(n)return n;let r=Jt(e);if(r!=="filter"&&r in t)return zl[e]=r;r=Ua(r);for(let s=0;s<jd.length;s++){const i=jd[s]+r;if(i in t)return zl[e]=i}return e}const qd="http://www.w3.org/1999/xlink";function Wd(t,e,n,r,s,i=Vv(e)){r&&e.startsWith("xlink:")?n==null?t.removeAttributeNS(qd,e.slice(6,e.length)):t.setAttributeNS(qd,e,n):n==null||i&&!zp(n)?t.removeAttribute(e):t.setAttribute(e,i?"":rn(n)?String(n):n)}function Hd(t,e,n,r,s){if(e==="innerHTML"||e==="textContent"){n!=null&&(t[e]=e==="innerHTML"?tm(n):n);return}const i=t.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const l=i==="OPTION"?t.getAttribute("value")||"":t.value,c=n==null?t.type==="checkbox"?"on":"":String(n);(l!==c||!("_value"in t))&&(t.value=c),n==null&&t.removeAttribute(e),t._value=n;return}let o=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=zp(n):n==null&&l==="string"?(n="",o=!0):l==="number"&&(n=0,o=!0)}try{t[e]=n}catch{}o&&t.removeAttribute(s||e)}function Vn(t,e,n,r){t.addEventListener(e,n,r)}function R1(t,e,n,r){t.removeEventListener(e,n,r)}const zd=Symbol("_vei");function P1(t,e,n,r,s=null){const i=t[zd]||(t[zd]={}),o=i[e];if(r&&o)o.value=r;else{const[l,c]=k1(e);if(r){const u=i[e]=D1(r,s);Vn(t,l,u,c)}else o&&(R1(t,l,o,c),i[e]=void 0)}}const Kd=/(?:Once|Passive|Capture)$/;function k1(t){let e;if(Kd.test(t)){e={};let r;for(;r=t.match(Kd);)t=t.slice(0,t.length-r[0].length),e[r[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Yr(t.slice(2)),e]}let Kl=0;const V1=Promise.resolve(),O1=()=>Kl||(V1.then(()=>Kl=0),Kl=Date.now());function D1(t,e){const n=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=n.attached)return;sn(N1(r,n.value),e,5,[r])};return n.value=t,n.attached=O1(),n}function N1(t,e){if(le(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>s=>!s._stopped&&r&&r(s))}else return e}const Gd=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,L1=(t,e,n,r,s,i)=>{const o=s==="svg";e==="class"?T1(t,r,o):e==="style"?C1(t,n,r):Ma(e)?Zc(e)||P1(t,e,n,r,i):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):x1(t,e,r,o))?(Hd(t,e,r),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Wd(t,e,r,o,i,e!=="value")):t._isVueCE&&(/[A-Z]/.test(e)||!Je(r))?Hd(t,Jt(e),r,i,e):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),Wd(t,e,r,o))};function x1(t,e,n,r){if(r)return!!(e==="innerHTML"||e==="textContent"||e in t&&Gd(e)&&ye(n));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=t.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return Gd(e)&&Je(n)?!1:e in t}const om=new WeakMap,am=new WeakMap,ya=Symbol("_moveCb"),Qd=Symbol("_enterCb"),M1=t=>(delete t.props.mode,t),F1=M1({name:"TransitionGroup",props:et({},rm,{tag:String,moveClass:String}),setup(t,{slots:e}){const n=Xg(),r=bg();let s,i;return Og(()=>{if(!s.length)return;const o=t.moveClass||`${t.name||"v"}-move`;if(!j1(s[0].el,n.vnode.el,o))return;s.forEach(U1),s.forEach($1);const l=s.filter(B1);Ec(),l.forEach(c=>{const u=c.el,d=u.style;hn(u,o),d.transform=d.webkitTransform=d.transitionDuration="";const p=u[ya]=g=>{g&&g.target!==u||(!g||/transform$/.test(g.propertyName))&&(u.removeEventListener("transitionend",p),u[ya]=null,Yn(u,o))};u.addEventListener("transitionend",p)})}),()=>{const o=Se(t),l=sm(o);let c=o.tag||Be;if(s=[],i)for(let u=0;u<i.length;u++){const d=i[u];d.el&&d.el instanceof Element&&(s.push(d),Hr(d,Fi(d,l,r,n)),om.set(d,d.el.getBoundingClientRect()))}i=e.default?fu(e.default()):[];for(let u=0;u<i.length;u++){const d=i[u];d.key!=null&&Hr(d,Fi(d,l,r,n))}return de(c,null,i)}}}),va=F1;function U1(t){const e=t.el;e[ya]&&e[ya](),e[Qd]&&e[Qd]()}function $1(t){am.set(t,t.el.getBoundingClientRect())}function B1(t){const e=om.get(t),n=am.get(t),r=e.left-n.left,s=e.top-n.top;if(r||s){const i=t.el.style;return i.transform=i.webkitTransform=`translate(${r}px,${s}px)`,i.transitionDuration="0s",t}}function j1(t,e,n){const r=t.cloneNode(),s=t[Cs];s&&s.forEach(l=>{l.split(/\s+/).forEach(c=>c&&r.classList.remove(c))}),n.split(/\s+/).forEach(l=>l&&r.classList.add(l)),r.style.display="none";const i=e.nodeType===1?e:e.parentNode;i.appendChild(r);const{hasTransform:o}=im(r);return i.removeChild(r),o}const gr=t=>{const e=t.props["onUpdate:modelValue"]||!1;return le(e)?n=>Go(e,n):e};function q1(t){t.target.composing=!0}function Yd(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Yt=Symbol("_assign"),mn={created(t,{modifiers:{lazy:e,trim:n,number:r}},s){t[Yt]=gr(s);const i=r||s.props&&s.props.type==="number";Vn(t,e?"change":"input",o=>{if(o.target.composing)return;let l=t.value;n&&(l=l.trim()),i&&(l=ua(l)),t[Yt](l)}),n&&Vn(t,"change",()=>{t.value=t.value.trim()}),e||(Vn(t,"compositionstart",q1),Vn(t,"compositionend",Yd),Vn(t,"change",Yd))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,oldValue:n,modifiers:{lazy:r,trim:s,number:i}},o){if(t[Yt]=gr(o),t.composing)return;const l=(i||t.type==="number")&&!/^0\d/.test(t.value)?ua(t.value):t.value,c=e??"";l!==c&&(document.activeElement===t&&t.type!=="range"&&(r&&e===n||s&&t.value.trim()===c)||(t.value=c))}},W1={deep:!0,created(t,e,n){t[Yt]=gr(n),Vn(t,"change",()=>{const r=t._modelValue,s=Ss(t),i=t.checked,o=t[Yt];if(le(r)){const l=nu(r,s),c=l!==-1;if(i&&!c)o(r.concat(s));else if(!i&&c){const u=[...r];u.splice(l,1),o(u)}}else if(Us(r)){const l=new Set(r);i?l.add(s):l.delete(s),o(l)}else o(cm(t,i))})},mounted:Jd,beforeUpdate(t,e,n){t[Yt]=gr(n),Jd(t,e,n)}};function Jd(t,{value:e,oldValue:n},r){t._modelValue=e;let s;if(le(e))s=nu(e,r.props.value)>-1;else if(Us(e))s=e.has(r.props.value);else{if(e===n)return;s=qr(e,cm(t,!0))}t.checked!==s&&(t.checked=s)}const H1={created(t,{value:e},n){t.checked=qr(e,n.props.value),t[Yt]=gr(n),Vn(t,"change",()=>{t[Yt](Ss(t))})},beforeUpdate(t,{value:e,oldValue:n},r){t[Yt]=gr(r),e!==n&&(t.checked=qr(e,r.props.value))}},lm={deep:!0,created(t,{value:e,modifiers:{number:n}},r){const s=Us(e);Vn(t,"change",()=>{const i=Array.prototype.filter.call(t.options,o=>o.selected).map(o=>n?ua(Ss(o)):Ss(o));t[Yt](t.multiple?s?new Set(i):i:i[0]),t._assigning=!0,qa(()=>{t._assigning=!1})}),t[Yt]=gr(r)},mounted(t,{value:e}){Xd(t,e)},beforeUpdate(t,e,n){t[Yt]=gr(n)},updated(t,{value:e}){t._assigning||Xd(t,e)}};function Xd(t,e){const n=t.multiple,r=le(e);if(!(n&&!r&&!Us(e))){for(let s=0,i=t.options.length;s<i;s++){const o=t.options[s],l=Ss(o);if(n)if(r){const c=typeof l;c==="string"||c==="number"?o.selected=e.some(u=>String(u)===String(l)):o.selected=nu(e,l)>-1}else o.selected=e.has(l);else if(qr(Ss(o),e)){t.selectedIndex!==s&&(t.selectedIndex=s);return}}!n&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function Ss(t){return"_value"in t?t._value:t.value}function cm(t,e){const n=e?"_trueValue":"_falseValue";return n in t?t[n]:e}const Zd={created(t,e,n){Uo(t,e,n,null,"created")},mounted(t,e,n){Uo(t,e,n,null,"mounted")},beforeUpdate(t,e,n,r){Uo(t,e,n,r,"beforeUpdate")},updated(t,e,n,r){Uo(t,e,n,r,"updated")}};function z1(t,e){switch(t){case"SELECT":return lm;case"TEXTAREA":return mn;default:switch(e){case"checkbox":return W1;case"radio":return H1;default:return mn}}}function Uo(t,e,n,r,s){const o=z1(t.tagName,n.props&&n.props.type)[s];o&&o(t,e,n,r)}const K1=["ctrl","shift","alt","meta"],G1={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>K1.some(n=>t[`${n}Key`]&&!e.includes(n))},ji=(t,e)=>{const n=t._withMods||(t._withMods={}),r=e.join(".");return n[r]||(n[r]=(s,...i)=>{for(let o=0;o<e.length;o++){const l=G1[e[o]];if(l&&l(s,e))return}return t(s,...i)})},Q1=et({patchProp:L1},y1);let ef;function Y1(){return ef||(ef=B0(Q1))}const J1=(...t)=>{const e=Y1().createApp(...t),{mount:n}=e;return e.mount=r=>{const s=Z1(r);if(!s)return;const i=e._component;!ye(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const o=n(s,!1,X1(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function X1(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function Z1(t){return Je(t)?document.querySelector(t):t}var ew=!1;/*!
 * pinia v2.2.6
 * (c) 2024 Eduardo San Martin Morote
 * @license MIT
 */let um;const Ja=t=>um=t,hm=Symbol();function Tc(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Ci;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Ci||(Ci={}));function tw(){const t=Yp(!0),e=t.run(()=>ge({}));let n=[],r=[];const s=hu({install(i){Ja(s),s._a=i,i.provide(hm,s),i.config.globalProperties.$pinia=s,r.forEach(o=>n.push(o)),r=[]},use(i){return!this._a&&!ew?r.push(i):n.push(i),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const dm=()=>{};function tf(t,e,n,r=dm){t.push(e);const s=()=>{const i=t.indexOf(e);i>-1&&(t.splice(i,1),r())};return!n&&ru()&&Jp(s),s}function cs(t,...e){t.slice().forEach(n=>{n(...e)})}const nw=t=>t(),nf=Symbol(),Gl=Symbol();function Ic(t,e){t instanceof Map&&e instanceof Map?e.forEach((n,r)=>t.set(r,n)):t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],s=t[n];Tc(s)&&Tc(r)&&t.hasOwnProperty(n)&&!Ye(r)&&!lr(r)?t[n]=Ic(s,r):t[n]=r}return t}const rw=Symbol();function sw(t){return!Tc(t)||!t.hasOwnProperty(rw)}const{assign:Jn}=Object;function iw(t){return!!(Ye(t)&&t.effect)}function ow(t,e,n,r){const{state:s,actions:i,getters:o}=e,l=n.state.value[t];let c;function u(){l||(n.state.value[t]=s?s():{});const d=t0(n.state.value[t]);return Jn(d,i,Object.keys(o||{}).reduce((p,g)=>(p[g]=hu(we(()=>{Ja(n);const m=n._s.get(t);return o[g].call(m,m)})),p),{}))}return c=fm(t,u,e,n,r,!0),c}function fm(t,e,n={},r,s,i){let o;const l=Jn({actions:{}},n),c={deep:!0};let u,d,p=[],g=[],m;const T=r.state.value[t];!i&&!T&&(r.state.value[t]={}),ge({});let C;function P(v){let y;u=d=!1,typeof v=="function"?(v(r.state.value[t]),y={type:Ci.patchFunction,storeId:t,events:m}):(Ic(r.state.value[t],v),y={type:Ci.patchObject,payload:v,storeId:t,events:m});const I=C=Symbol();qa().then(()=>{C===I&&(u=!0)}),d=!0,cs(p,y,r.state.value[t])}const O=i?function(){const{state:y}=n,I=y?y():{};this.$patch(R=>{Jn(R,I)})}:dm;function N(){o.stop(),p=[],g=[],r._s.delete(t)}const $=(v,y="")=>{if(nf in v)return v[Gl]=y,v;const I=function(){Ja(r);const R=Array.from(arguments),b=[],E=[];function Ve(pe){b.push(pe)}function Xe(pe){E.push(pe)}cs(g,{args:R,name:I[Gl],store:H,after:Ve,onError:Xe});let Le;try{Le=v.apply(this&&this.$id===t?this:H,R)}catch(pe){throw cs(E,pe),pe}return Le instanceof Promise?Le.then(pe=>(cs(b,pe),pe)).catch(pe=>(cs(E,pe),Promise.reject(pe))):(cs(b,Le),Le)};return I[nf]=!0,I[Gl]=y,I},F={_p:r,$id:t,$onAction:tf.bind(null,g),$patch:P,$reset:O,$subscribe(v,y={}){const I=tf(p,v,y.detached,()=>R()),R=o.run(()=>mt(()=>r.state.value[t],b=>{(y.flush==="sync"?d:u)&&v({storeId:t,type:Ci.direct,events:m},b)},Jn({},c,y)));return I},$dispose:N},H=no(F);r._s.set(t,H);const S=(r._a&&r._a.runWithContext||nw)(()=>r._e.run(()=>(o=Yp()).run(()=>e({action:$}))));for(const v in S){const y=S[v];if(Ye(y)&&!iw(y)||lr(y))i||(T&&sw(y)&&(Ye(y)?y.value=T[v]:Ic(y,T[v])),r.state.value[t][v]=y);else if(typeof y=="function"){const I=$(y,v);S[v]=I,l.actions[v]=y}}return Jn(H,S),Jn(Se(H),S),Object.defineProperty(H,"$state",{get:()=>r.state.value[t],set:v=>{P(y=>{Jn(y,v)})}}),r._p.forEach(v=>{Jn(H,o.run(()=>v({store:H,app:r._a,pinia:r,options:l})))}),T&&i&&n.hydrate&&n.hydrate(H.$state,T),u=!0,d=!0,H}/*! #__NO_SIDE_EFFECTS__ */function js(t,e,n){let r,s;const i=typeof e=="function";typeof t=="string"?(r=t,s=i?n:e):(s=t,r=t.id);function o(l,c){const u=N0();return l=l||(u?Ht(hm,null):null),l&&Ja(l),l=um,l._s.has(r)||(i?fm(r,e,s,l):ow(r,s,l)),l._s.get(r)}return o.$id=r,o}/*!
  * vue-router v4.5.0
  * (c) 2024 Eduardo San Martin Morote
  * @license MIT
  */const hs=typeof document<"u";function pm(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function aw(t){return t.__esModule||t[Symbol.toStringTag]==="Module"||t.default&&pm(t.default)}const Oe=Object.assign;function Ql(t,e){const n={};for(const r in e){const s=e[r];n[r]=on(s)?s.map(t):t(s)}return n}const Si=()=>{},on=Array.isArray,gm=/#/g,lw=/&/g,cw=/\//g,uw=/=/g,hw=/\?/g,mm=/\+/g,dw=/%5B/g,fw=/%5D/g,_m=/%5E/g,pw=/%60/g,ym=/%7B/g,gw=/%7C/g,vm=/%7D/g,mw=/%20/g;function Tu(t){return encodeURI(""+t).replace(gw,"|").replace(dw,"[").replace(fw,"]")}function _w(t){return Tu(t).replace(ym,"{").replace(vm,"}").replace(_m,"^")}function Ac(t){return Tu(t).replace(mm,"%2B").replace(mw,"+").replace(gm,"%23").replace(lw,"%26").replace(pw,"`").replace(ym,"{").replace(vm,"}").replace(_m,"^")}function yw(t){return Ac(t).replace(uw,"%3D")}function vw(t){return Tu(t).replace(gm,"%23").replace(hw,"%3F")}function ww(t){return t==null?"":vw(t).replace(cw,"%2F")}function qi(t){try{return decodeURIComponent(""+t)}catch{}return""+t}const Ew=/\/$/,Tw=t=>t.replace(Ew,"");function Yl(t,e,n="/"){let r,s={},i="",o="";const l=e.indexOf("#");let c=e.indexOf("?");return l<c&&l>=0&&(c=-1),c>-1&&(r=e.slice(0,c),i=e.slice(c+1,l>-1?l:e.length),s=t(i)),l>-1&&(r=r||e.slice(0,l),o=e.slice(l,e.length)),r=Cw(r??e,n),{fullPath:r+(i&&"?")+i+o,path:r,query:s,hash:qi(o)}}function Iw(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function rf(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Aw(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Rs(e.matched[r],n.matched[s])&&wm(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Rs(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function wm(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!bw(t[n],e[n]))return!1;return!0}function bw(t,e){return on(t)?sf(t,e):on(e)?sf(e,t):t===e}function sf(t,e){return on(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function Cw(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,o,l;for(o=0;o<r.length;o++)if(l=r[o],l!==".")if(l==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(o).join("/")}const Gn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var Wi;(function(t){t.pop="pop",t.push="push"})(Wi||(Wi={}));var Ri;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Ri||(Ri={}));function Sw(t){if(!t)if(hs){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Tw(t)}const Rw=/^[^#]+#/;function Pw(t,e){return t.replace(Rw,"#")+e}function kw(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Xa=()=>({left:window.scrollX,top:window.scrollY});function Vw(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=kw(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function of(t,e){return(history.state?history.state.position-e:-1)+t}const bc=new Map;function Ow(t,e){bc.set(t,e)}function Dw(t){const e=bc.get(t);return bc.delete(t),e}let Nw=()=>location.protocol+"//"+location.host;function Em(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let l=s.includes(t.slice(i))?t.slice(i).length:1,c=s.slice(l);return c[0]!=="/"&&(c="/"+c),rf(c,"")}return rf(n,t)+r+s}function Lw(t,e,n,r){let s=[],i=[],o=null;const l=({state:g})=>{const m=Em(t,location),T=n.value,C=e.value;let P=0;if(g){if(n.value=m,e.value=g,o&&o===T){o=null;return}P=C?g.position-C.position:0}else r(m);s.forEach(O=>{O(n.value,T,{delta:P,type:Wi.pop,direction:P?P>0?Ri.forward:Ri.back:Ri.unknown})})};function c(){o=n.value}function u(g){s.push(g);const m=()=>{const T=s.indexOf(g);T>-1&&s.splice(T,1)};return i.push(m),m}function d(){const{history:g}=window;g.state&&g.replaceState(Oe({},g.state,{scroll:Xa()}),"")}function p(){for(const g of i)g();i=[],window.removeEventListener("popstate",l),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",l),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:c,listen:u,destroy:p}}function af(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Xa():null}}function xw(t){const{history:e,location:n}=window,r={value:Em(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,u,d){const p=t.indexOf("#"),g=p>-1?(n.host&&document.querySelector("base")?t:t.slice(p))+c:Nw()+t+c;try{e[d?"replaceState":"pushState"](u,"",g),s.value=u}catch(m){console.error(m),n[d?"replace":"assign"](g)}}function o(c,u){const d=Oe({},e.state,af(s.value.back,c,s.value.forward,!0),u,{position:s.value.position});i(c,d,!0),r.value=c}function l(c,u){const d=Oe({},s.value,e.state,{forward:c,scroll:Xa()});i(d.current,d,!0);const p=Oe({},af(r.value,c,null),{position:d.position+1},u);i(c,p,!1),r.value=c}return{location:r,state:s,push:l,replace:o}}function Mw(t){t=Sw(t);const e=xw(t),n=Lw(t,e.state,e.location,e.replace);function r(i,o=!0){o||n.pauseListeners(),history.go(i)}const s=Oe({location:"",base:t,go:r,createHref:Pw.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Fw(t){return t=location.host?t||location.pathname+location.search:"",t.includes("#")||(t+="#"),Mw(t)}function Uw(t){return typeof t=="string"||t&&typeof t=="object"}function Tm(t){return typeof t=="string"||typeof t=="symbol"}const Im=Symbol("");var lf;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(lf||(lf={}));function Ps(t,e){return Oe(new Error,{type:t,[Im]:!0},e)}function Sn(t,e){return t instanceof Error&&Im in t&&(e==null||!!(t.type&e))}const cf="[^/]+?",$w={sensitive:!1,strict:!1,start:!0,end:!0},Bw=/[.+*?^${}()[\]/\\]/g;function jw(t,e){const n=Oe({},$w,e),r=[];let s=n.start?"^":"";const i=[];for(const u of t){const d=u.length?[]:[90];n.strict&&!u.length&&(s+="/");for(let p=0;p<u.length;p++){const g=u[p];let m=40+(n.sensitive?.25:0);if(g.type===0)p||(s+="/"),s+=g.value.replace(Bw,"\\$&"),m+=40;else if(g.type===1){const{value:T,repeatable:C,optional:P,regexp:O}=g;i.push({name:T,repeatable:C,optional:P});const N=O||cf;if(N!==cf){m+=10;try{new RegExp(`(${N})`)}catch(F){throw new Error(`Invalid custom RegExp for param "${T}" (${N}): `+F.message)}}let $=C?`((?:${N})(?:/(?:${N}))*)`:`(${N})`;p||($=P&&u.length<2?`(?:/${$})`:"/"+$),P&&($+="?"),s+=$,m+=20,P&&(m+=-8),C&&(m+=-20),N===".*"&&(m+=-50)}d.push(m)}r.push(d)}if(n.strict&&n.end){const u=r.length-1;r[u][r[u].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&!s.endsWith("/")&&(s+="(?:/|$)");const o=new RegExp(s,n.sensitive?"":"i");function l(u){const d=u.match(o),p={};if(!d)return null;for(let g=1;g<d.length;g++){const m=d[g]||"",T=i[g-1];p[T.name]=m&&T.repeatable?m.split("/"):m}return p}function c(u){let d="",p=!1;for(const g of t){(!p||!d.endsWith("/"))&&(d+="/"),p=!1;for(const m of g)if(m.type===0)d+=m.value;else if(m.type===1){const{value:T,repeatable:C,optional:P}=m,O=T in u?u[T]:"";if(on(O)&&!C)throw new Error(`Provided param "${T}" is an array but it is not repeatable (* or + modifiers)`);const N=on(O)?O.join("/"):O;if(!N)if(P)g.length<2&&(d.endsWith("/")?d=d.slice(0,-1):p=!0);else throw new Error(`Missing required param "${T}"`);d+=N}}return d||"/"}return{re:o,score:r,keys:i,parse:l,stringify:c}}function qw(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===80?-1:1:t.length>e.length?e.length===1&&e[0]===80?1:-1:0}function Am(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=qw(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(uf(r))return 1;if(uf(s))return-1}return s.length-r.length}function uf(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Ww={type:0,value:""},Hw=/[a-zA-Z0-9_]/;function zw(t){if(!t)return[[]];if(t==="/")return[[Ww]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(m){throw new Error(`ERR (${n})/"${u}": ${m}`)}let n=0,r=n;const s=[];let i;function o(){i&&s.push(i),i=[]}let l=0,c,u="",d="";function p(){u&&(n===0?i.push({type:0,value:u}):n===1||n===2||n===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:u,regexp:d,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),u="")}function g(){u+=c}for(;l<t.length;){if(c=t[l++],c==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:c==="/"?(u&&p(),o()):c===":"?(p(),n=1):g();break;case 4:g(),n=r;break;case 1:c==="("?n=2:Hw.test(c)?g():(p(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&l--);break;case 2:c===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+c:n=3:d+=c;break;case 3:p(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&l--,d="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${u}"`),p(),o(),s}function Kw(t,e,n){const r=jw(zw(t.path),n),s=Oe(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function Gw(t,e){const n=[],r=new Map;e=pf({strict:!1,end:!0,sensitive:!1},e);function s(p){return r.get(p)}function i(p,g,m){const T=!m,C=df(p);C.aliasOf=m&&m.record;const P=pf(e,p),O=[C];if("alias"in p){const F=typeof p.alias=="string"?[p.alias]:p.alias;for(const H of F)O.push(df(Oe({},C,{components:m?m.record.components:C.components,path:H,aliasOf:m?m.record:C})))}let N,$;for(const F of O){const{path:H}=F;if(g&&H[0]!=="/"){const ee=g.record.path,S=ee[ee.length-1]==="/"?"":"/";F.path=g.record.path+(H&&S+H)}if(N=Kw(F,g,P),m?m.alias.push(N):($=$||N,$!==N&&$.alias.push(N),T&&p.name&&!ff(N)&&o(p.name)),bm(N)&&c(N),C.children){const ee=C.children;for(let S=0;S<ee.length;S++)i(ee[S],N,m&&m.children[S])}m=m||N}return $?()=>{o($)}:Si}function o(p){if(Tm(p)){const g=r.get(p);g&&(r.delete(p),n.splice(n.indexOf(g),1),g.children.forEach(o),g.alias.forEach(o))}else{const g=n.indexOf(p);g>-1&&(n.splice(g,1),p.record.name&&r.delete(p.record.name),p.children.forEach(o),p.alias.forEach(o))}}function l(){return n}function c(p){const g=Jw(p,n);n.splice(g,0,p),p.record.name&&!ff(p)&&r.set(p.record.name,p)}function u(p,g){let m,T={},C,P;if("name"in p&&p.name){if(m=r.get(p.name),!m)throw Ps(1,{location:p});P=m.record.name,T=Oe(hf(g.params,m.keys.filter($=>!$.optional).concat(m.parent?m.parent.keys.filter($=>$.optional):[]).map($=>$.name)),p.params&&hf(p.params,m.keys.map($=>$.name))),C=m.stringify(T)}else if(p.path!=null)C=p.path,m=n.find($=>$.re.test(C)),m&&(T=m.parse(C),P=m.record.name);else{if(m=g.name?r.get(g.name):n.find($=>$.re.test(g.path)),!m)throw Ps(1,{location:p,currentLocation:g});P=m.record.name,T=Oe({},g.params,p.params),C=m.stringify(T)}const O=[];let N=m;for(;N;)O.unshift(N.record),N=N.parent;return{name:P,path:C,params:T,matched:O,meta:Yw(O)}}t.forEach(p=>i(p));function d(){n.length=0,r.clear()}return{addRoute:i,resolve:u,removeRoute:o,clearRoutes:d,getRoutes:l,getRecordMatcher:s}}function hf(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function df(t){const e={path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:t.aliasOf,beforeEnter:t.beforeEnter,props:Qw(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function Qw(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function ff(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Yw(t){return t.reduce((e,n)=>Oe(e,n.meta),{})}function pf(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function Jw(t,e){let n=0,r=e.length;for(;n!==r;){const i=n+r>>1;Am(t,e[i])<0?r=i:n=i+1}const s=Xw(t);return s&&(r=e.lastIndexOf(s,r-1)),r}function Xw(t){let e=t;for(;e=e.parent;)if(bm(e)&&Am(t,e)===0)return e}function bm({record:t}){return!!(t.name||t.components&&Object.keys(t.components).length||t.redirect)}function Zw(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(mm," "),o=i.indexOf("="),l=qi(o<0?i:i.slice(0,o)),c=o<0?null:qi(i.slice(o+1));if(l in e){let u=e[l];on(u)||(u=e[l]=[u]),u.push(c)}else e[l]=c}return e}function gf(t){let e="";for(let n in t){const r=t[n];if(n=yw(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(on(r)?r.map(i=>i&&Ac(i)):[r&&Ac(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function eE(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=on(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const tE=Symbol(""),mf=Symbol(""),Za=Symbol(""),Iu=Symbol(""),Cc=Symbol("");function hi(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function tr(t,e,n,r,s,i=o=>o()){const o=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((l,c)=>{const u=g=>{g===!1?c(Ps(4,{from:n,to:e})):g instanceof Error?c(g):Uw(g)?c(Ps(2,{from:e,to:g})):(o&&r.enterCallbacks[s]===o&&typeof g=="function"&&o.push(g),l())},d=i(()=>t.call(r&&r.instances[s],e,n,u));let p=Promise.resolve(d);t.length<3&&(p=p.then(u)),p.catch(g=>c(g))})}function Jl(t,e,n,r,s=i=>i()){const i=[];for(const o of t)for(const l in o.components){let c=o.components[l];if(!(e!=="beforeRouteEnter"&&!o.instances[l]))if(pm(c)){const d=(c.__vccOpts||c)[e];d&&i.push(tr(d,n,r,o,l,s))}else{let u=c();i.push(()=>u.then(d=>{if(!d)throw new Error(`Couldn't resolve component "${l}" at "${o.path}"`);const p=aw(d)?d.default:d;o.mods[l]=d,o.components[l]=p;const m=(p.__vccOpts||p)[e];return m&&tr(m,n,r,o,l,s)()}))}}return i}function _f(t){const e=Ht(Za),n=Ht(Iu),r=we(()=>{const c=Q(t.to);return e.resolve(c)}),s=we(()=>{const{matched:c}=r.value,{length:u}=c,d=c[u-1],p=n.matched;if(!d||!p.length)return-1;const g=p.findIndex(Rs.bind(null,d));if(g>-1)return g;const m=yf(c[u-2]);return u>1&&yf(d)===m&&p[p.length-1].path!==m?p.findIndex(Rs.bind(null,c[u-2])):g}),i=we(()=>s.value>-1&&oE(n.params,r.value.params)),o=we(()=>s.value>-1&&s.value===n.matched.length-1&&wm(n.params,r.value.params));function l(c={}){if(iE(c)){const u=e[Q(t.replace)?"replace":"push"](Q(t.to)).catch(Si);return t.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:r,href:we(()=>r.value.href),isActive:i,isExactActive:o,navigate:l}}function nE(t){return t.length===1?t[0]:t}const rE=He({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:_f,setup(t,{slots:e}){const n=no(_f(t)),{options:r}=Ht(Za),s=we(()=>({[vf(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[vf(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&nE(e.default(n));return t.custom?i:Eu("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),sE=rE;function iE(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function oE(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!on(s)||s.length!==r.length||r.some((i,o)=>i!==s[o]))return!1}return!0}function yf(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const vf=(t,e,n)=>t??e??n,aE=He({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Ht(Cc),s=we(()=>t.route||r.value),i=Ht(mf,0),o=we(()=>{let u=Q(i);const{matched:d}=s.value;let p;for(;(p=d[u])&&!p.components;)u++;return u}),l=we(()=>s.value.matched[o.value]);Ai(mf,we(()=>o.value+1)),Ai(tE,l),Ai(Cc,s);const c=ge();return mt(()=>[c.value,l.value,t.name],([u,d,p],[g,m,T])=>{d&&(d.instances[p]=u,m&&m!==d&&u&&u===g&&(d.leaveGuards.size||(d.leaveGuards=m.leaveGuards),d.updateGuards.size||(d.updateGuards=m.updateGuards))),u&&d&&(!m||!Rs(d,m)||!g)&&(d.enterCallbacks[p]||[]).forEach(C=>C(u))},{flush:"post"}),()=>{const u=s.value,d=t.name,p=l.value,g=p&&p.components[d];if(!g)return wf(n.default,{Component:g,route:u});const m=p.props[d],T=m?m===!0?u.params:typeof m=="function"?m(u):m:null,P=Eu(g,Oe({},T,e,{onVnodeUnmounted:O=>{O.component.isUnmounted&&(p.instances[d]=null)},ref:c}));return wf(n.default,{Component:P,route:u})||P}}});function wf(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Cm=aE;function lE(t){const e=Gw(t.routes,t),n=t.parseQuery||Zw,r=t.stringifyQuery||gf,s=t.history,i=hi(),o=hi(),l=hi(),c=Xv(Gn);let u=Gn;hs&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Ql.bind(null,M=>""+M),p=Ql.bind(null,ww),g=Ql.bind(null,qi);function m(M,te){let J,se;return Tm(M)?(J=e.getRecordMatcher(M),se=te):se=M,e.addRoute(se,J)}function T(M){const te=e.getRecordMatcher(M);te&&e.removeRoute(te)}function C(){return e.getRoutes().map(M=>M.record)}function P(M){return!!e.getRecordMatcher(M)}function O(M,te){if(te=Oe({},te||c.value),typeof M=="string"){const A=Yl(n,M,te.path),V=e.resolve({path:A.path},te),j=s.createHref(A.fullPath);return Oe(A,V,{params:g(V.params),hash:qi(A.hash),redirectedFrom:void 0,href:j})}let J;if(M.path!=null)J=Oe({},M,{path:Yl(n,M.path,te.path).path});else{const A=Oe({},M.params);for(const V in A)A[V]==null&&delete A[V];J=Oe({},M,{params:p(A)}),te.params=p(te.params)}const se=e.resolve(J,te),be=M.hash||"";se.params=d(g(se.params));const xe=Iw(r,Oe({},M,{hash:_w(be),path:se.path})),w=s.createHref(xe);return Oe({fullPath:xe,hash:be,query:r===gf?eE(M.query):M.query||{}},se,{redirectedFrom:void 0,href:w})}function N(M){return typeof M=="string"?Yl(n,M,c.value.path):Oe({},M)}function $(M,te){if(u!==M)return Ps(8,{from:te,to:M})}function F(M){return S(M)}function H(M){return F(Oe(N(M),{replace:!0}))}function ee(M){const te=M.matched[M.matched.length-1];if(te&&te.redirect){const{redirect:J}=te;let se=typeof J=="function"?J(M):J;return typeof se=="string"&&(se=se.includes("?")||se.includes("#")?se=N(se):{path:se},se.params={}),Oe({query:M.query,hash:M.hash,params:se.path!=null?{}:M.params},se)}}function S(M,te){const J=u=O(M),se=c.value,be=M.state,xe=M.force,w=M.replace===!0,A=ee(J);if(A)return S(Oe(N(A),{state:typeof A=="object"?Oe({},be,A.state):be,force:xe,replace:w}),te||J);const V=J;V.redirectedFrom=te;let j;return!xe&&Aw(r,se,J)&&(j=Ps(16,{to:V,from:se}),zt(se,se,!0,!1)),(j?Promise.resolve(j):I(V,se)).catch(x=>Sn(x)?Sn(x,2)?x:Xt(x):Ee(x,V,se)).then(x=>{if(x){if(Sn(x,2))return S(Oe({replace:w},N(x.to),{state:typeof x.to=="object"?Oe({},be,x.to.state):be,force:xe}),te||V)}else x=b(V,se,!0,w,be);return R(V,se,x),x})}function v(M,te){const J=$(M,te);return J?Promise.reject(J):Promise.resolve()}function y(M){const te=jn.values().next().value;return te&&typeof te.runWithContext=="function"?te.runWithContext(M):M()}function I(M,te){let J;const[se,be,xe]=cE(M,te);J=Jl(se.reverse(),"beforeRouteLeave",M,te);for(const A of se)A.leaveGuards.forEach(V=>{J.push(tr(V,M,te))});const w=v.bind(null,M,te);return J.push(w),Mt(J).then(()=>{J=[];for(const A of i.list())J.push(tr(A,M,te));return J.push(w),Mt(J)}).then(()=>{J=Jl(be,"beforeRouteUpdate",M,te);for(const A of be)A.updateGuards.forEach(V=>{J.push(tr(V,M,te))});return J.push(w),Mt(J)}).then(()=>{J=[];for(const A of xe)if(A.beforeEnter)if(on(A.beforeEnter))for(const V of A.beforeEnter)J.push(tr(V,M,te));else J.push(tr(A.beforeEnter,M,te));return J.push(w),Mt(J)}).then(()=>(M.matched.forEach(A=>A.enterCallbacks={}),J=Jl(xe,"beforeRouteEnter",M,te,y),J.push(w),Mt(J))).then(()=>{J=[];for(const A of o.list())J.push(tr(A,M,te));return J.push(w),Mt(J)}).catch(A=>Sn(A,8)?A:Promise.reject(A))}function R(M,te,J){l.list().forEach(se=>y(()=>se(M,te,J)))}function b(M,te,J,se,be){const xe=$(M,te);if(xe)return xe;const w=te===Gn,A=hs?history.state:{};J&&(se||w?s.replace(M.fullPath,Oe({scroll:w&&A&&A.scroll},be)):s.push(M.fullPath,be)),c.value=M,zt(M,te,J,w),Xt()}let E;function Ve(){E||(E=s.listen((M,te,J)=>{if(!cn.listening)return;const se=O(M),be=ee(se);if(be){S(Oe(be,{replace:!0,force:!0}),se).catch(Si);return}u=se;const xe=c.value;hs&&Ow(of(xe.fullPath,J.delta),Xa()),I(se,xe).catch(w=>Sn(w,12)?w:Sn(w,2)?(S(Oe(N(w.to),{force:!0}),se).then(A=>{Sn(A,20)&&!J.delta&&J.type===Wi.pop&&s.go(-1,!1)}).catch(Si),Promise.reject()):(J.delta&&s.go(-J.delta,!1),Ee(w,se,xe))).then(w=>{w=w||b(se,xe,!1),w&&(J.delta&&!Sn(w,8)?s.go(-J.delta,!1):J.type===Wi.pop&&Sn(w,20)&&s.go(-1,!1)),R(se,xe,w)}).catch(Si)}))}let Xe=hi(),Le=hi(),pe;function Ee(M,te,J){Xt(M);const se=Le.list();return se.length?se.forEach(be=>be(M,te,J)):console.error(M),Promise.reject(M)}function Bt(){return pe&&c.value!==Gn?Promise.resolve():new Promise((M,te)=>{Xe.add([M,te])})}function Xt(M){return pe||(pe=!M,Ve(),Xe.list().forEach(([te,J])=>M?J(M):te()),Xe.reset()),M}function zt(M,te,J,se){const{scrollBehavior:be}=t;if(!hs||!be)return Promise.resolve();const xe=!J&&Dw(of(M.fullPath,0))||(se||!J)&&history.state&&history.state.scroll||null;return qa().then(()=>be(M,te,xe)).then(w=>w&&Vw(w)).catch(w=>Ee(w,M,te))}const ze=M=>s.go(M);let Ke;const jn=new Set,cn={currentRoute:c,listening:!0,addRoute:m,removeRoute:T,clearRoutes:e.clearRoutes,hasRoute:P,getRoutes:C,resolve:O,options:t,push:F,replace:H,go:ze,back:()=>ze(-1),forward:()=>ze(1),beforeEach:i.add,beforeResolve:o.add,afterEach:l.add,onError:Le.add,isReady:Bt,install(M){const te=this;M.component("RouterLink",sE),M.component("RouterView",Cm),M.config.globalProperties.$router=te,Object.defineProperty(M.config.globalProperties,"$route",{enumerable:!0,get:()=>Q(c)}),hs&&!Ke&&c.value===Gn&&(Ke=!0,F(s.location).catch(be=>{}));const J={};for(const be in Gn)Object.defineProperty(J,be,{get:()=>c.value[be],enumerable:!0});M.provide(Za,te),M.provide(Iu,dg(J)),M.provide(Cc,c);const se=M.unmount;jn.add(M),M.unmount=function(){jn.delete(M),jn.size<1&&(u=Gn,E&&E(),E=null,c.value=Gn,Ke=!1,pe=!1),se()}}};function Mt(M){return M.reduce((te,J)=>te.then(()=>y(J)),Promise.resolve())}return cn}function cE(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const l=e.matched[o];l&&(t.matched.find(u=>Rs(u,l))?r.push(l):n.push(l));const c=t.matched[o];c&&(e.matched.find(u=>Rs(u,c))||s.push(c))}return[n,r,s]}function Au(){return Ht(Za)}function uE(t){return Ht(Iu)}var Ef={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LT="firebase-heartbeat-database",xT=1,Hi="firebase-heartbeat-store";let nc=null;function Mm(){return nc||(nc=ZE(LT,xT,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Hi)}catch(n){console.warn(n)}}}}).catch(t=>{throw ur.create("idb-open",{originalErrorMessage:t.message})})),nc}async function MT(t){try{const n=(await Mm()).transaction(Hi),r=await n.objectStore(Hi).get(Fm(t));return await n.done,r}catch(e){if(e instanceof Bn)xn.warn(e.message);else{const n=ur.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});xn.warn(n.message)}}}async function Rf(t,e){try{const r=(await Mm()).transaction(Hi,"readwrite");await r.objectStore(Hi).put(e,Fm(t)),await r.done}catch(n){if(n instanceof Bn)xn.warn(n.message);else{const r=ur.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});xn.warn(r.message)}}}function Fm(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qT(t){ks(new zr("platform-logger",e=>new nT(e),"PRIVATE")),ks(new zr("heartbeat",e=>new $T(e),"PRIVATE")),hr(Pc,Cf,t),hr(Pc,Cf,"esm2017"),hr("fire-js","")}qT("");function Ru(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(t);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(t,r[s])&&(n[r[s]]=t[r[s]]);return n}function Um(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const WT=Um,$m=new io("auth","Firebase",Um());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ia=new bu("@firebase/auth");function HT(t,...e){Ia.logLevel<=Te.WARN&&Ia.warn(`Auth (${qs}): ${t}`,...e)}function Xo(t,...e){Ia.logLevel<=Te.ERROR&&Ia.error(`Auth (${qs}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tI(t,e){return br(t,"POST","/v1/accounts:delete",e)}async function Hm(t,e){return br(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aI(t,e){const n=await qm(t,{},async()=>{const r=oo({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=t.config,o=Wm(t,s,"/v1/token",`key=${i}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",jm.fetch()(o,{method:"POST",headers:l,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function lI(t,e){return br(t,"POST","/v2/accounts:revokeToken",Ar(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CA=new ao(3e4,6e4);function Wf(){const t=yn().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function SA(t){return new Promise((e,n)=>{var r,s,i;function o(){Wf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Wf(),n(_n(t,"network-request-failed"))},timeout:CA.get()})}if(!((s=(r=yn().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=yn().gapi)===null||i===void 0)&&i.load)o();else{const l=vI("iframefcb");return yn()[l]=()=>{gapi.load?o():n(_n(t,"network-request-failed"))},r_(`${yI()}?onload=${l}`).catch(c=>n(c))}}).catch(e=>{throw ta=null,e})}let ta=null;function RA(t){return ta=ta||SA(t),ta}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qA="__/auth/handler",WA="emulator/auth/handler",HA=encodeURIComponent("fac");async function zf(t,e,n,r,s,i){fe(t.config.authDomain,t,"auth-domain-config-required"),fe(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:qs,eventId:s};if(e instanceof o_){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",DE(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,p]of Object.entries({}))o[d]=p}if(e instanceof co){const d=e.getScopes().filter(p=>p!=="");d.length>0&&(o.scopes=d.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const d of Object.keys(l))l[d]===void 0&&delete l[d];const c=await t._getAppCheckToken(),u=c?`#${HA}=${encodeURIComponent(c)}`:"";return`${zA(t)}?${oo(l).slice(1)}${u}`}function zA({config:t}){return t.emulator?ku(t,WA):`https://${t.authDomain}/${qA}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XA=5*60,ZA=Om("authIdTokenMaxAge")||XA;let Qf=null;const eb=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>ZA)return;const s=n==null?void 0:n.token;Qf!==s&&(Qf=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Vs(t=xm()){const e=Su(t,"auth");if(e.isInitialized())return e.getImmediate();const n=AI(t,{popupRedirectResolver:GA,persistence:[iA,KI,f_]}),r=Om("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=eb(i.toString());qI(n,o,()=>o(n.currentUser)),jI(n,l=>o(l))}}const s=km("auth");return s&&CI(n,`http://${s}`),n}function tb(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}mI({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=_n("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",tb().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});JA("Browser");const nb="/Re.Words/images/logo.svg",w_=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},rb={},sb={class:"greeting"},ib={class:"container"},ob={class:"greeting__inner"};function ab(t,e){const n=gu("router-link");return X(),oe("section",sb,[L("div",ib,[L("div",ob,[e[1]||(e[1]=L("div",{class:"greeting__logo logo"},[L("img",{class:"logo__img",src:nb,alt:"logo"})],-1)),e[2]||(e[2]=L("h1",{class:"greeting__title"}," Note of words in your pocket ",-1)),de(n,{class:"greeting__btn btn btn--white",to:"/entrance"},{default:St(()=>e[0]||(e[0]=[Ga(" Start ")])),_:1})])])])}const lb=w_(rb,[["render",ab]]),sl=js("loader",()=>{const t=ge(!1);function e(){t.value=!0}function n(){t.value=!1}return{isLoading:t,showLoader:e,hideLoader:n}});function E_(){return Math.floor(Math.random()*1e6).toString()}const In=js("alert",()=>{const t=ge([]);function e(r,s){const i=E_(),o={id:i,isVisible:!0,message:r,class:s};t.value.push(o),setTimeout(()=>n(i),2500)}function n(r){const s=t.value.find(i=>i.id===r);s&&(s.isVisible=!1,setTimeout(()=>{t.value=t.value.filter(i=>i.id!==r)},300))}return{alerts:t,showAlert:e,hideAlert:n}}),cb={class:"entrance"},ub={class:"container"},hb={class:"entrance__inner"},db={class:"entrance__title"},fb={class:"entrance__form form",action:"#",method:"post"},pb={class:"form__box form-box"},gb={class:"form__box form-box"},mb=["type"],_b={key:0,width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},yb={key:1,width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},vb={key:0,class:"form__box form-box"},wb=["type"],Eb={key:0,width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},Tb={key:1,width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},Ib={class:"form__buttons buttons"},Ab=He({__name:"EntranceView",setup(t){const e=sl(),n=In(),r=ge(!0),s=ge(!1),i=Au(),o=ge({email:{value:"",error:!1},password:{value:"",error:!1},passwordRepeat:{value:"",error:!1}}),l=we(()=>r.value?"Log In":"Registration"),c=we(()=>r.value?"Registration":"Log In"),u=we(()=>s.value?"text":"password");function d(){r.value=!r.value}function p(){s.value=!s.value}function g(){let P=!0;return o.value.email.value.includes("@")?o.value.email.error=!1:(o.value.email.error=!0,n.showAlert("Invalid email","alert--error"),P=!1),o.value.password.value.length<6?(o.value.password.error=!0,n.showAlert("Password must be at least 6 characters","alert--error"),P=!1):o.value.password.error=!1,!r.value&&o.value.password.value!==o.value.passwordRepeat.value?(o.value.passwordRepeat.error=!0,n.showAlert("Passwords do not match","alert--error"),P=!1):o.value.passwordRepeat.error=!1,P}const m=async()=>{e.showLoader();try{await $I(Vs(),o.value.email.value,o.value.password.value),i.push("/menu")}catch(P){P instanceof Error&&n.showAlert(`${P.message}`,"alert--error")}finally{e.hideLoader()}},T=async()=>{e.showLoader();try{await BI(Vs(),o.value.email.value,o.value.password.value),i.push("/menu")}catch(P){P instanceof Error&&n.showAlert(`${P.message}`,"alert--error")}finally{e.hideLoader()}},C=()=>{g()&&(r.value?T():m())};return(P,O)=>(X(),oe("div",cb,[L("div",ub,[L("div",hb,[L("h1",db,rt(l.value),1),L("form",fb,[L("div",pb,[tn(L("input",{class:We(["form-box__input filling filling--input",{"filling--error":o.value.email.error}]),type:"email",placeholder:"Email","onUpdate:modelValue":O[0]||(O[0]=N=>o.value.email.value=N)},null,2),[[mn,o.value.email.value]])]),L("div",gb,[tn(L("input",{class:We(["form-box__input filling filling--input",{"filling--error":o.value.password.error}]),type:u.value,placeholder:"Password","onUpdate:modelValue":O[1]||(O[1]=N=>o.value.password.value=N)},null,10,mb),[[Zd,o.value.password.value]]),L("div",{class:"form-box__show",onClick:p},[de(va,{name:"opacity"},{default:St(()=>[s.value?pt("",!0):(X(),oe("svg",_b,O[3]||(O[3]=[L("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M7.99328 10.2678C8.29095 10.2678 8.5857 10.2092 8.86071 10.0953C9.13573 9.98135 9.38561 9.81439 9.59609 9.6039C9.80657 9.39342 9.97354 9.14354 10.0875 8.86853C10.2014 8.59352 10.26 8.29876 10.26 8.00109C10.26 7.70342 10.2014 7.40867 10.0875 7.13366C9.97354 6.85865 9.80657 6.60877 9.59609 6.39828C9.38561 6.1878 9.13573 6.02083 8.86071 5.90692C8.5857 5.79301 8.29095 5.73437 7.99328 5.73438C7.39211 5.73438 6.81556 5.97319 6.39047 6.39828C5.96538 6.82337 5.72656 7.39992 5.72656 8.00109C5.72656 8.60226 5.96538 9.17881 6.39047 9.6039C6.81556 10.029 7.39211 10.2678 7.99328 10.2678ZM7.99328 8.96866C7.73667 8.96866 7.49056 8.86672 7.30911 8.68526C7.12765 8.50381 7.02571 8.25771 7.02571 8.00109C7.02571 7.74448 7.12765 7.49837 7.30911 7.31692C7.49056 7.13547 7.73667 7.03353 7.99328 7.03353C8.24989 7.03353 8.496 7.13547 8.67745 7.31692C8.8589 7.49837 8.96084 7.74448 8.96084 8.00109C8.96084 8.25771 8.8589 8.50381 8.67745 8.68526C8.496 8.86672 8.24989 8.96866 7.99328 8.96866Z",fill:"white"},null,-1),L("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M8 3.46484C4.88488 3.46484 2.76518 5.15452 1.64672 6.36624C1.23129 6.80812 1 7.39178 1 7.99828C1 8.60477 1.23129 9.18844 1.64672 9.63031C2.76453 10.842 4.88359 12.5317 8 12.5317C11.1158 12.5317 13.2348 10.842 14.3533 9.63031C14.7687 9.18844 15 8.60477 15 7.99828C15 7.39178 14.7687 6.80812 14.3533 6.36624C13.2355 5.15452 11.1164 3.46484 8 3.46484ZM2.59874 7.24508C3.58897 6.17195 5.38809 4.76011 8 4.76011C10.6119 4.76011 12.4117 6.17195 13.4019 7.24508C13.5963 7.44767 13.7048 7.71754 13.7048 7.99828C13.7048 8.27901 13.5963 8.54888 13.4019 8.75148C12.411 9.8246 10.6119 11.2364 8.00065 11.2364C5.38809 11.2364 3.58832 9.8246 2.59809 8.75148C2.40375 8.54888 2.29523 8.27901 2.29523 7.99828C2.29523 7.71754 2.40375 7.44767 2.59809 7.24508H2.59874Z",fill:"white"},null,-1)]))),s.value?(X(),oe("svg",yb,O[4]||(O[4]=[L("path",{d:"M3.14038 5.05078C2.59879 5.4391 2.09827 5.8817 1.64659 6.37169C1.23124 6.81348 1 7.39703 1 8.0034C1 8.60977 1.23124 9.19332 1.64659 9.63511C2.76547 10.8466 4.88475 12.5359 7.99924 12.5359C8.83841 12.5359 9.60505 12.4129 10.2992 12.2109L9.22303 11.1341C8.81904 11.2056 8.40952 11.2414 7.99924 11.2409C5.38786 11.2409 3.58845 9.82936 2.59842 8.75645C2.40411 8.55389 2.29562 8.28408 2.29562 8.0034C2.29562 7.72272 2.40411 7.4529 2.59842 7.25035C3.03825 6.77179 3.53215 6.34591 4.07019 5.98124L3.14038 5.05208V5.05078Z",fill:"white"},null,-1),L("path",{d:"M5.75193 7.66704C5.69899 8.0179 5.72918 8.37629 5.84006 8.71335C5.95095 9.05042 6.13943 9.35673 6.39034 9.60764C6.64124 9.85854 6.94756 10.047 7.28462 10.1579C7.62168 10.2688 7.98007 10.299 8.33093 10.246L5.75193 7.66704ZM10.2411 8.29447L7.7035 5.7569C8.04727 5.71256 8.39663 5.74766 8.7247 5.85951C9.05278 5.97135 9.35082 6.15696 9.59592 6.40205C9.84101 6.64715 10.0266 6.9452 10.1385 7.27327C10.2503 7.60135 10.2854 7.9507 10.2411 8.29447Z",fill:"white"},null,-1),L("path",{d:"M11.961 10.0062C12.4882 9.64582 12.9726 9.22655 13.4049 8.75652C13.5992 8.55397 13.7077 8.28415 13.7077 8.00347C13.7077 7.72279 13.5992 7.45297 13.4049 7.25042C12.4136 6.17751 10.6142 4.76595 8.00347 4.76595C7.58907 4.76595 7.19409 4.80156 6.82048 4.86567L5.74044 3.78563C6.47633 3.5753 7.23811 3.46937 8.00347 3.47094C11.1186 3.47094 13.2372 5.16028 14.3555 6.37176C14.7708 6.81355 15.0021 7.3971 15.0021 8.00347C15.0021 8.60984 14.7708 9.19339 14.3555 9.63518C13.9799 10.0425 13.4917 10.5028 12.8902 10.9354L11.961 10.0062ZM1.53361 2.44918C1.47177 2.38945 1.42244 2.318 1.38851 2.23901C1.35457 2.16001 1.33671 2.07504 1.33596 1.98907C1.33521 1.90309 1.3516 1.81783 1.38415 1.73825C1.41671 1.65868 1.46479 1.58638 1.52559 1.52559C1.58638 1.46479 1.65868 1.41671 1.73825 1.38415C1.81783 1.3516 1.90309 1.33521 1.98907 1.33596C2.07504 1.33671 2.16001 1.35457 2.23901 1.38851C2.318 1.42244 2.38945 1.47177 2.44918 1.53361L14.4785 13.5629C14.5965 13.6851 14.6617 13.8486 14.6602 14.0184C14.6588 14.1882 14.5907 14.3506 14.4706 14.4706C14.3506 14.5907 14.1882 14.6588 14.0184 14.6602C13.8486 14.6617 13.6851 14.5965 13.5629 14.4785L1.53361 2.44918Z",fill:"white"},null,-1)]))):pt("",!0)]),_:1})])]),r.value?pt("",!0):(X(),oe("div",vb,[tn(L("input",{class:We(["form-box__input filling filling--input",{"filling--error":o.value.passwordRepeat.error}]),type:u.value,placeholder:"Repeat password","onUpdate:modelValue":O[2]||(O[2]=N=>o.value.passwordRepeat.value=N)},null,10,wb),[[Zd,o.value.passwordRepeat.value]]),L("div",{class:"form-box__show",onClick:p},[de(va,{name:"opacity"},{default:St(()=>[s.value?pt("",!0):(X(),oe("svg",Eb,O[5]||(O[5]=[L("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M7.99328 10.2678C8.29095 10.2678 8.5857 10.2092 8.86071 10.0953C9.13573 9.98135 9.38561 9.81439 9.59609 9.6039C9.80657 9.39342 9.97354 9.14354 10.0875 8.86853C10.2014 8.59352 10.26 8.29876 10.26 8.00109C10.26 7.70342 10.2014 7.40867 10.0875 7.13366C9.97354 6.85865 9.80657 6.60877 9.59609 6.39828C9.38561 6.1878 9.13573 6.02083 8.86071 5.90692C8.5857 5.79301 8.29095 5.73437 7.99328 5.73438C7.39211 5.73438 6.81556 5.97319 6.39047 6.39828C5.96538 6.82337 5.72656 7.39992 5.72656 8.00109C5.72656 8.60226 5.96538 9.17881 6.39047 9.6039C6.81556 10.029 7.39211 10.2678 7.99328 10.2678ZM7.99328 8.96866C7.73667 8.96866 7.49056 8.86672 7.30911 8.68526C7.12765 8.50381 7.02571 8.25771 7.02571 8.00109C7.02571 7.74448 7.12765 7.49837 7.30911 7.31692C7.49056 7.13547 7.73667 7.03353 7.99328 7.03353C8.24989 7.03353 8.496 7.13547 8.67745 7.31692C8.8589 7.49837 8.96084 7.74448 8.96084 8.00109C8.96084 8.25771 8.8589 8.50381 8.67745 8.68526C8.496 8.86672 8.24989 8.96866 7.99328 8.96866Z",fill:"white"},null,-1),L("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M8 3.46484C4.88488 3.46484 2.76518 5.15452 1.64672 6.36624C1.23129 6.80812 1 7.39178 1 7.99828C1 8.60477 1.23129 9.18844 1.64672 9.63031C2.76453 10.842 4.88359 12.5317 8 12.5317C11.1158 12.5317 13.2348 10.842 14.3533 9.63031C14.7687 9.18844 15 8.60477 15 7.99828C15 7.39178 14.7687 6.80812 14.3533 6.36624C13.2355 5.15452 11.1164 3.46484 8 3.46484ZM2.59874 7.24508C3.58897 6.17195 5.38809 4.76011 8 4.76011C10.6119 4.76011 12.4117 6.17195 13.4019 7.24508C13.5963 7.44767 13.7048 7.71754 13.7048 7.99828C13.7048 8.27901 13.5963 8.54888 13.4019 8.75148C12.411 9.8246 10.6119 11.2364 8.00065 11.2364C5.38809 11.2364 3.58832 9.8246 2.59809 8.75148C2.40375 8.54888 2.29523 8.27901 2.29523 7.99828C2.29523 7.71754 2.40375 7.44767 2.59809 7.24508H2.59874Z",fill:"white"},null,-1)]))),s.value?(X(),oe("svg",Tb,O[6]||(O[6]=[L("path",{d:"M3.14038 5.05078C2.59879 5.4391 2.09827 5.8817 1.64659 6.37169C1.23124 6.81348 1 7.39703 1 8.0034C1 8.60977 1.23124 9.19332 1.64659 9.63511C2.76547 10.8466 4.88475 12.5359 7.99924 12.5359C8.83841 12.5359 9.60505 12.4129 10.2992 12.2109L9.22303 11.1341C8.81904 11.2056 8.40952 11.2414 7.99924 11.2409C5.38786 11.2409 3.58845 9.82936 2.59842 8.75645C2.40411 8.55389 2.29562 8.28408 2.29562 8.0034C2.29562 7.72272 2.40411 7.4529 2.59842 7.25035C3.03825 6.77179 3.53215 6.34591 4.07019 5.98124L3.14038 5.05208V5.05078Z",fill:"white"},null,-1),L("path",{d:"M5.75193 7.66704C5.69899 8.0179 5.72918 8.37629 5.84006 8.71335C5.95095 9.05042 6.13943 9.35673 6.39034 9.60764C6.64124 9.85854 6.94756 10.047 7.28462 10.1579C7.62168 10.2688 7.98007 10.299 8.33093 10.246L5.75193 7.66704ZM10.2411 8.29447L7.7035 5.7569C8.04727 5.71256 8.39663 5.74766 8.7247 5.85951C9.05278 5.97135 9.35082 6.15696 9.59592 6.40205C9.84101 6.64715 10.0266 6.9452 10.1385 7.27327C10.2503 7.60135 10.2854 7.9507 10.2411 8.29447Z",fill:"white"},null,-1),L("path",{d:"M11.961 10.0062C12.4882 9.64582 12.9726 9.22655 13.4049 8.75652C13.5992 8.55397 13.7077 8.28415 13.7077 8.00347C13.7077 7.72279 13.5992 7.45297 13.4049 7.25042C12.4136 6.17751 10.6142 4.76595 8.00347 4.76595C7.58907 4.76595 7.19409 4.80156 6.82048 4.86567L5.74044 3.78563C6.47633 3.5753 7.23811 3.46937 8.00347 3.47094C11.1186 3.47094 13.2372 5.16028 14.3555 6.37176C14.7708 6.81355 15.0021 7.3971 15.0021 8.00347C15.0021 8.60984 14.7708 9.19339 14.3555 9.63518C13.9799 10.0425 13.4917 10.5028 12.8902 10.9354L11.961 10.0062ZM1.53361 2.44918C1.47177 2.38945 1.42244 2.318 1.38851 2.23901C1.35457 2.16001 1.33671 2.07504 1.33596 1.98907C1.33521 1.90309 1.3516 1.81783 1.38415 1.73825C1.41671 1.65868 1.46479 1.58638 1.52559 1.52559C1.58638 1.46479 1.65868 1.41671 1.73825 1.38415C1.81783 1.3516 1.90309 1.33521 1.98907 1.33596C2.07504 1.33671 2.16001 1.35457 2.23901 1.38851C2.318 1.42244 2.38945 1.47177 2.44918 1.53361L14.4785 13.5629C14.5965 13.6851 14.6617 13.8486 14.6602 14.0184C14.6588 14.1882 14.5907 14.3506 14.4706 14.4706C14.3506 14.5907 14.1882 14.6588 14.0184 14.6602C13.8486 14.6617 13.6851 14.5965 13.5629 14.4785L1.53361 2.44918Z",fill:"white"},null,-1)]))):pt("",!0)]),_:1})])])),L("div",Ib,[L("div",{class:"buttons__btn btn btn--transparent",onClick:d},rt(c.value),1),L("button",{class:"buttons__btn btn btn--white",type:"button",onClick:ji(C,["prevent"])}," Submit ")])])])])]))}}),bb=He({__name:"Account",setup(t){const e=Au(),n=async()=>{await WI(Vs()),e.push("/entrance")};return(r,s)=>(X(),oe("div",{class:"head__account account filling filling--round",onClick:n},s[0]||(s[0]=[L("svg",{width:"15",height:"22",viewBox:"0 0 15 22",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M11.1169 11.9102H6.74548C6.43245 11.8982 6.13613 11.7608 5.91879 11.5271C5.70145 11.2934 5.58002 10.9815 5.58002 10.6569C5.58002 10.3323 5.70145 10.0204 5.91879 9.78669C6.13613 9.55297 6.43245 9.41564 6.74548 9.40357H11.1169L9.69714 7.76254C9.48525 7.51596 9.37545 7.19293 9.39142 6.86319C9.4074 6.53345 9.54787 6.22344 9.78253 6.00008C9.89794 5.89012 10.0333 5.80504 10.1807 5.74981C10.3282 5.69458 10.4848 5.67029 10.6414 5.67836C10.798 5.68644 10.9514 5.72671 11.0929 5.79683C11.2343 5.86695 11.3608 5.96553 11.4651 6.08681L14.683 9.80776C14.8852 10.038 14.9981 10.3376 15 10.6488C15.0018 10.9601 14.8925 11.2611 14.693 11.4939L11.4651 15.2252C11.3611 15.3469 11.2347 15.4458 11.0933 15.5162C10.9519 15.5866 10.7984 15.6271 10.6417 15.6353C10.4851 15.6436 10.3284 15.6194 10.1809 15.5641C10.0334 15.5089 9.89794 15.4238 9.78253 15.3137C9.54787 15.0904 9.4074 14.7803 9.39142 14.4506C9.37545 14.1209 9.48525 13.7978 9.69714 13.5513L11.1169 11.9102ZM7.18915 18.8334C7.34492 18.8657 7.49304 18.9294 7.62505 19.0209C7.75706 19.1125 7.87037 19.2301 7.95852 19.367C8.04667 19.5039 8.10793 19.6575 8.1388 19.8189C8.16967 19.9804 8.16955 20.1465 8.13843 20.3079C8.10732 20.4693 8.04584 20.6228 7.95748 20.7596C7.86913 20.8964 7.75564 21.0138 7.62349 21.1051C7.49134 21.1964 7.34313 21.2599 7.18731 21.2919C7.03149 21.3239 6.87111 21.3238 6.71534 21.2915L6.15112 21.1736C2.14971 20.3513 0 19.8847 0 13.9121V7.04784C0 1.32678 2.30709 0.879225 6.12768 0.14024L6.72538 0.0222801C7.03998 -0.0400597 7.3656 0.0296414 7.63059 0.21605C7.89559 0.402459 8.07827 0.690305 8.13843 1.01627C8.1986 1.34223 8.13133 1.6796 7.95142 1.95417C7.77151 2.22875 7.4937 2.41802 7.1791 2.48036L6.57135 2.60179C3.98299 3.10312 2.41926 3.40496 2.41926 7.05131V13.9121C2.41926 17.8342 3.88756 18.1552 6.62158 18.7172L7.18915 18.8334Z",fill:"white"})],-1)])))}}),Cb={class:"head"},Sb={class:"head__inner"},Rb={class:"head__title"},Pb={key:0,width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},T_=He({__name:"Head",props:{title:{},isBack:{type:Boolean}},setup(t){const e=t;return(n,r)=>{const s=gu("router-link");return X(),oe("div",Cb,[L("div",Sb,[de(s,{class:"head__link",to:"/menu"},{default:St(()=>[L("h1",Rb,[e.isBack?(X(),oe("svg",Pb,r[0]||(r[0]=[L("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M18.7511 10.0008C18.7511 9.83503 18.6853 9.67606 18.5681 9.55885C18.4508 9.44164 18.2919 9.37579 18.1261 9.37579H3.38487L7.31862 5.44329C7.37673 5.38518 7.42282 5.31619 7.45427 5.24027C7.48572 5.16434 7.50191 5.08297 7.50191 5.00079C7.50191 4.91861 7.48572 4.83723 7.45427 4.76131C7.42282 4.68539 7.37673 4.6164 7.31862 4.55829C7.26051 4.50018 7.19152 4.45408 7.1156 4.42264C7.03967 4.39119 6.9583 4.375 6.87612 4.375C6.79394 4.375 6.71256 4.39119 6.63664 4.42264C6.56071 4.45408 6.49173 4.50018 6.43362 4.55829L1.43362 9.55829C1.37541 9.61635 1.32923 9.68532 1.29773 9.76125C1.26622 9.83718 1.25 9.91858 1.25 10.0008C1.25 10.083 1.26622 10.1644 1.29773 10.2403C1.32923 10.3163 1.37541 10.3852 1.43362 10.4433L6.43362 15.4433C6.49173 15.5014 6.56071 15.5475 6.63664 15.5789C6.71256 15.6104 6.79394 15.6266 6.87612 15.6266C6.9583 15.6266 7.03967 15.6104 7.1156 15.5789C7.19152 15.5475 7.26051 15.5014 7.31862 15.4433C7.37673 15.3852 7.42282 15.3162 7.45427 15.2403C7.48572 15.1643 7.50191 15.083 7.50191 15.0008C7.50191 14.9186 7.48572 14.8372 7.45427 14.7613C7.42282 14.6854 7.37673 14.6164 7.31862 14.5583L3.38487 10.6258H18.1261C18.2919 10.6258 18.4508 10.5599 18.5681 10.4427C18.6853 10.3255 18.7511 10.1666 18.7511 10.0008Z",fill:"white"},null,-1)]))):pt("",!0),L("span",null,rt(e.title),1)])]),_:1}),de(bb)])])}}});var Yf=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var jr,I_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(S,v){function y(){}y.prototype=v.prototype,S.D=v.prototype,S.prototype=new y,S.prototype.constructor=S,S.C=function(I,R,b){for(var E=Array(arguments.length-2),Ve=2;Ve<arguments.length;Ve++)E[Ve-2]=arguments[Ve];return v.prototype[R].apply(I,E)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(S,v,y){y||(y=0);var I=Array(16);if(typeof v=="string")for(var R=0;16>R;++R)I[R]=v.charCodeAt(y++)|v.charCodeAt(y++)<<8|v.charCodeAt(y++)<<16|v.charCodeAt(y++)<<24;else for(R=0;16>R;++R)I[R]=v[y++]|v[y++]<<8|v[y++]<<16|v[y++]<<24;v=S.g[0],y=S.g[1],R=S.g[2];var b=S.g[3],E=v+(b^y&(R^b))+I[0]+3614090360&4294967295;v=y+(E<<7&4294967295|E>>>25),E=b+(R^v&(y^R))+I[1]+3905402710&4294967295,b=v+(E<<12&4294967295|E>>>20),E=R+(y^b&(v^y))+I[2]+606105819&4294967295,R=b+(E<<17&4294967295|E>>>15),E=y+(v^R&(b^v))+I[3]+3250441966&4294967295,y=R+(E<<22&4294967295|E>>>10),E=v+(b^y&(R^b))+I[4]+4118548399&4294967295,v=y+(E<<7&4294967295|E>>>25),E=b+(R^v&(y^R))+I[5]+1200080426&4294967295,b=v+(E<<12&4294967295|E>>>20),E=R+(y^b&(v^y))+I[6]+2821735955&4294967295,R=b+(E<<17&4294967295|E>>>15),E=y+(v^R&(b^v))+I[7]+4249261313&4294967295,y=R+(E<<22&4294967295|E>>>10),E=v+(b^y&(R^b))+I[8]+1770035416&4294967295,v=y+(E<<7&4294967295|E>>>25),E=b+(R^v&(y^R))+I[9]+2336552879&4294967295,b=v+(E<<12&4294967295|E>>>20),E=R+(y^b&(v^y))+I[10]+4294925233&4294967295,R=b+(E<<17&4294967295|E>>>15),E=y+(v^R&(b^v))+I[11]+2304563134&4294967295,y=R+(E<<22&4294967295|E>>>10),E=v+(b^y&(R^b))+I[12]+1804603682&4294967295,v=y+(E<<7&4294967295|E>>>25),E=b+(R^v&(y^R))+I[13]+4254626195&4294967295,b=v+(E<<12&4294967295|E>>>20),E=R+(y^b&(v^y))+I[14]+2792965006&4294967295,R=b+(E<<17&4294967295|E>>>15),E=y+(v^R&(b^v))+I[15]+1236535329&4294967295,y=R+(E<<22&4294967295|E>>>10),E=v+(R^b&(y^R))+I[1]+4129170786&4294967295,v=y+(E<<5&4294967295|E>>>27),E=b+(y^R&(v^y))+I[6]+3225465664&4294967295,b=v+(E<<9&4294967295|E>>>23),E=R+(v^y&(b^v))+I[11]+643717713&4294967295,R=b+(E<<14&4294967295|E>>>18),E=y+(b^v&(R^b))+I[0]+3921069994&4294967295,y=R+(E<<20&4294967295|E>>>12),E=v+(R^b&(y^R))+I[5]+3593408605&4294967295,v=y+(E<<5&4294967295|E>>>27),E=b+(y^R&(v^y))+I[10]+38016083&4294967295,b=v+(E<<9&4294967295|E>>>23),E=R+(v^y&(b^v))+I[15]+3634488961&4294967295,R=b+(E<<14&4294967295|E>>>18),E=y+(b^v&(R^b))+I[4]+3889429448&4294967295,y=R+(E<<20&4294967295|E>>>12),E=v+(R^b&(y^R))+I[9]+568446438&4294967295,v=y+(E<<5&4294967295|E>>>27),E=b+(y^R&(v^y))+I[14]+3275163606&4294967295,b=v+(E<<9&4294967295|E>>>23),E=R+(v^y&(b^v))+I[3]+4107603335&4294967295,R=b+(E<<14&4294967295|E>>>18),E=y+(b^v&(R^b))+I[8]+1163531501&4294967295,y=R+(E<<20&4294967295|E>>>12),E=v+(R^b&(y^R))+I[13]+2850285829&4294967295,v=y+(E<<5&4294967295|E>>>27),E=b+(y^R&(v^y))+I[2]+4243563512&4294967295,b=v+(E<<9&4294967295|E>>>23),E=R+(v^y&(b^v))+I[7]+1735328473&4294967295,R=b+(E<<14&4294967295|E>>>18),E=y+(b^v&(R^b))+I[12]+2368359562&4294967295,y=R+(E<<20&4294967295|E>>>12),E=v+(y^R^b)+I[5]+4294588738&4294967295,v=y+(E<<4&4294967295|E>>>28),E=b+(v^y^R)+I[8]+2272392833&4294967295,b=v+(E<<11&4294967295|E>>>21),E=R+(b^v^y)+I[11]+1839030562&4294967295,R=b+(E<<16&4294967295|E>>>16),E=y+(R^b^v)+I[14]+4259657740&4294967295,y=R+(E<<23&4294967295|E>>>9),E=v+(y^R^b)+I[1]+2763975236&4294967295,v=y+(E<<4&4294967295|E>>>28),E=b+(v^y^R)+I[4]+1272893353&4294967295,b=v+(E<<11&4294967295|E>>>21),E=R+(b^v^y)+I[7]+4139469664&4294967295,R=b+(E<<16&4294967295|E>>>16),E=y+(R^b^v)+I[10]+3200236656&4294967295,y=R+(E<<23&4294967295|E>>>9),E=v+(y^R^b)+I[13]+681279174&4294967295,v=y+(E<<4&4294967295|E>>>28),E=b+(v^y^R)+I[0]+3936430074&4294967295,b=v+(E<<11&4294967295|E>>>21),E=R+(b^v^y)+I[3]+3572445317&4294967295,R=b+(E<<16&4294967295|E>>>16),E=y+(R^b^v)+I[6]+76029189&4294967295,y=R+(E<<23&4294967295|E>>>9),E=v+(y^R^b)+I[9]+3654602809&4294967295,v=y+(E<<4&4294967295|E>>>28),E=b+(v^y^R)+I[12]+3873151461&4294967295,b=v+(E<<11&4294967295|E>>>21),E=R+(b^v^y)+I[15]+530742520&4294967295,R=b+(E<<16&4294967295|E>>>16),E=y+(R^b^v)+I[2]+3299628645&4294967295,y=R+(E<<23&4294967295|E>>>9),E=v+(R^(y|~b))+I[0]+4096336452&4294967295,v=y+(E<<6&4294967295|E>>>26),E=b+(y^(v|~R))+I[7]+1126891415&4294967295,b=v+(E<<10&4294967295|E>>>22),E=R+(v^(b|~y))+I[14]+2878612391&4294967295,R=b+(E<<15&4294967295|E>>>17),E=y+(b^(R|~v))+I[5]+4237533241&4294967295,y=R+(E<<21&4294967295|E>>>11),E=v+(R^(y|~b))+I[12]+1700485571&4294967295,v=y+(E<<6&4294967295|E>>>26),E=b+(y^(v|~R))+I[3]+2399980690&4294967295,b=v+(E<<10&4294967295|E>>>22),E=R+(v^(b|~y))+I[10]+4293915773&4294967295,R=b+(E<<15&4294967295|E>>>17),E=y+(b^(R|~v))+I[1]+2240044497&4294967295,y=R+(E<<21&4294967295|E>>>11),E=v+(R^(y|~b))+I[8]+1873313359&4294967295,v=y+(E<<6&4294967295|E>>>26),E=b+(y^(v|~R))+I[15]+4264355552&4294967295,b=v+(E<<10&4294967295|E>>>22),E=R+(v^(b|~y))+I[6]+2734768916&4294967295,R=b+(E<<15&4294967295|E>>>17),E=y+(b^(R|~v))+I[13]+1309151649&4294967295,y=R+(E<<21&4294967295|E>>>11),E=v+(R^(y|~b))+I[4]+4149444226&4294967295,v=y+(E<<6&4294967295|E>>>26),E=b+(y^(v|~R))+I[11]+3174756917&4294967295,b=v+(E<<10&4294967295|E>>>22),E=R+(v^(b|~y))+I[2]+718787259&4294967295,R=b+(E<<15&4294967295|E>>>17),E=y+(b^(R|~v))+I[9]+3951481745&4294967295,S.g[0]=S.g[0]+v&4294967295,S.g[1]=S.g[1]+(R+(E<<21&4294967295|E>>>11))&4294967295,S.g[2]=S.g[2]+R&4294967295,S.g[3]=S.g[3]+b&4294967295}r.prototype.u=function(S,v){v===void 0&&(v=S.length);for(var y=v-this.blockSize,I=this.B,R=this.h,b=0;b<v;){if(R==0)for(;b<=y;)s(this,S,b),b+=this.blockSize;if(typeof S=="string"){for(;b<v;)if(I[R++]=S.charCodeAt(b++),R==this.blockSize){s(this,I),R=0;break}}else for(;b<v;)if(I[R++]=S[b++],R==this.blockSize){s(this,I),R=0;break}}this.h=R,this.o+=v},r.prototype.v=function(){var S=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);S[0]=128;for(var v=1;v<S.length-8;++v)S[v]=0;var y=8*this.o;for(v=S.length-8;v<S.length;++v)S[v]=y&255,y/=256;for(this.u(S),S=Array(16),v=y=0;4>v;++v)for(var I=0;32>I;I+=8)S[y++]=this.g[v]>>>I&255;return S};function i(S,v){var y=l;return Object.prototype.hasOwnProperty.call(y,S)?y[S]:y[S]=v(S)}function o(S,v){this.h=v;for(var y=[],I=!0,R=S.length-1;0<=R;R--){var b=S[R]|0;I&&b==v||(y[R]=b,I=!1)}this.g=y}var l={};function c(S){return-128<=S&&128>S?i(S,function(v){return new o([v|0],0>v?-1:0)}):new o([S|0],0>S?-1:0)}function u(S){if(isNaN(S)||!isFinite(S))return p;if(0>S)return P(u(-S));for(var v=[],y=1,I=0;S>=y;I++)v[I]=S/y|0,y*=4294967296;return new o(v,0)}function d(S,v){if(S.length==0)throw Error("number format error: empty string");if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(S.charAt(0)=="-")return P(d(S.substring(1),v));if(0<=S.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=u(Math.pow(v,8)),I=p,R=0;R<S.length;R+=8){var b=Math.min(8,S.length-R),E=parseInt(S.substring(R,R+b),v);8>b?(b=u(Math.pow(v,b)),I=I.j(b).add(u(E))):(I=I.j(y),I=I.add(u(E)))}return I}var p=c(0),g=c(1),m=c(16777216);t=o.prototype,t.m=function(){if(C(this))return-P(this).m();for(var S=0,v=1,y=0;y<this.g.length;y++){var I=this.i(y);S+=(0<=I?I:4294967296+I)*v,v*=4294967296}return S},t.toString=function(S){if(S=S||10,2>S||36<S)throw Error("radix out of range: "+S);if(T(this))return"0";if(C(this))return"-"+P(this).toString(S);for(var v=u(Math.pow(S,6)),y=this,I="";;){var R=F(y,v).g;y=O(y,R.j(v));var b=((0<y.g.length?y.g[0]:y.h)>>>0).toString(S);if(y=R,T(y))return b+I;for(;6>b.length;)b="0"+b;I=b+I}},t.i=function(S){return 0>S?0:S<this.g.length?this.g[S]:this.h};function T(S){if(S.h!=0)return!1;for(var v=0;v<S.g.length;v++)if(S.g[v]!=0)return!1;return!0}function C(S){return S.h==-1}t.l=function(S){return S=O(this,S),C(S)?-1:T(S)?0:1};function P(S){for(var v=S.g.length,y=[],I=0;I<v;I++)y[I]=~S.g[I];return new o(y,~S.h).add(g)}t.abs=function(){return C(this)?P(this):this},t.add=function(S){for(var v=Math.max(this.g.length,S.g.length),y=[],I=0,R=0;R<=v;R++){var b=I+(this.i(R)&65535)+(S.i(R)&65535),E=(b>>>16)+(this.i(R)>>>16)+(S.i(R)>>>16);I=E>>>16,b&=65535,E&=65535,y[R]=E<<16|b}return new o(y,y[y.length-1]&-2147483648?-1:0)};function O(S,v){return S.add(P(v))}t.j=function(S){if(T(this)||T(S))return p;if(C(this))return C(S)?P(this).j(P(S)):P(P(this).j(S));if(C(S))return P(this.j(P(S)));if(0>this.l(m)&&0>S.l(m))return u(this.m()*S.m());for(var v=this.g.length+S.g.length,y=[],I=0;I<2*v;I++)y[I]=0;for(I=0;I<this.g.length;I++)for(var R=0;R<S.g.length;R++){var b=this.i(I)>>>16,E=this.i(I)&65535,Ve=S.i(R)>>>16,Xe=S.i(R)&65535;y[2*I+2*R]+=E*Xe,N(y,2*I+2*R),y[2*I+2*R+1]+=b*Xe,N(y,2*I+2*R+1),y[2*I+2*R+1]+=E*Ve,N(y,2*I+2*R+1),y[2*I+2*R+2]+=b*Ve,N(y,2*I+2*R+2)}for(I=0;I<v;I++)y[I]=y[2*I+1]<<16|y[2*I];for(I=v;I<2*v;I++)y[I]=0;return new o(y,0)};function N(S,v){for(;(S[v]&65535)!=S[v];)S[v+1]+=S[v]>>>16,S[v]&=65535,v++}function $(S,v){this.g=S,this.h=v}function F(S,v){if(T(v))throw Error("division by zero");if(T(S))return new $(p,p);if(C(S))return v=F(P(S),v),new $(P(v.g),P(v.h));if(C(v))return v=F(S,P(v)),new $(P(v.g),v.h);if(30<S.g.length){if(C(S)||C(v))throw Error("slowDivide_ only works with positive integers.");for(var y=g,I=v;0>=I.l(S);)y=H(y),I=H(I);var R=ee(y,1),b=ee(I,1);for(I=ee(I,2),y=ee(y,2);!T(I);){var E=b.add(I);0>=E.l(S)&&(R=R.add(y),b=E),I=ee(I,1),y=ee(y,1)}return v=O(S,R.j(v)),new $(R,v)}for(R=p;0<=S.l(v);){for(y=Math.max(1,Math.floor(S.m()/v.m())),I=Math.ceil(Math.log(y)/Math.LN2),I=48>=I?1:Math.pow(2,I-48),b=u(y),E=b.j(v);C(E)||0<E.l(S);)y-=I,b=u(y),E=b.j(v);T(b)&&(b=g),R=R.add(b),S=O(S,E)}return new $(R,S)}t.A=function(S){return F(this,S).h},t.and=function(S){for(var v=Math.max(this.g.length,S.g.length),y=[],I=0;I<v;I++)y[I]=this.i(I)&S.i(I);return new o(y,this.h&S.h)},t.or=function(S){for(var v=Math.max(this.g.length,S.g.length),y=[],I=0;I<v;I++)y[I]=this.i(I)|S.i(I);return new o(y,this.h|S.h)},t.xor=function(S){for(var v=Math.max(this.g.length,S.g.length),y=[],I=0;I<v;I++)y[I]=this.i(I)^S.i(I);return new o(y,this.h^S.h)};function H(S){for(var v=S.g.length+1,y=[],I=0;I<v;I++)y[I]=S.i(I)<<1|S.i(I-1)>>>31;return new o(y,S.h)}function ee(S,v){var y=v>>5;v%=32;for(var I=S.g.length-y,R=[],b=0;b<I;b++)R[b]=0<v?S.i(b+y)>>>v|S.i(b+y+1)<<32-v:S.i(b+y);return new o(R,S.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,I_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=d,jr=o}).apply(typeof Yf<"u"?Yf:typeof self<"u"?self:typeof window<"u"?window:{});var Bo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var A_,gi,b_,na,xc,C_,S_,R_;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,h,f){return a==Array.prototype||a==Object.prototype||(a[h]=f.value),a};function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Bo=="object"&&Bo];for(var h=0;h<a.length;++h){var f=a[h];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=n(this);function s(a,h){if(h)e:{var f=r;a=a.split(".");for(var _=0;_<a.length-1;_++){var k=a[_];if(!(k in f))break e;f=f[k]}a=a[a.length-1],_=f[a],h=h(_),h!=_&&h!=null&&e(f,a,{configurable:!0,writable:!0,value:h})}}function i(a,h){a instanceof String&&(a+="");var f=0,_=!1,k={next:function(){if(!_&&f<a.length){var D=f++;return{value:h(D,a[D]),done:!1}}return _=!0,{done:!0,value:void 0}}};return k[Symbol.iterator]=function(){return k},k}s("Array.prototype.values",function(a){return a||function(){return i(this,function(h,f){return f})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},l=this||self;function c(a){var h=typeof a;return h=h!="object"?h:a?Array.isArray(a)?"array":h:"null",h=="array"||h=="object"&&typeof a.length=="number"}function u(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function d(a,h,f){return a.call.apply(a.bind,arguments)}function p(a,h,f){if(!a)throw Error();if(2<arguments.length){var _=Array.prototype.slice.call(arguments,2);return function(){var k=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(k,_),a.apply(h,k)}}return function(){return a.apply(h,arguments)}}function g(a,h,f){return g=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?d:p,g.apply(null,arguments)}function m(a,h){var f=Array.prototype.slice.call(arguments,1);return function(){var _=f.slice();return _.push.apply(_,arguments),a.apply(this,_)}}function T(a,h){function f(){}f.prototype=h.prototype,a.aa=h.prototype,a.prototype=new f,a.prototype.constructor=a,a.Qb=function(_,k,D){for(var G=Array(arguments.length-2),Me=2;Me<arguments.length;Me++)G[Me-2]=arguments[Me];return h.prototype[k].apply(_,G)}}function C(a){const h=a.length;if(0<h){const f=Array(h);for(let _=0;_<h;_++)f[_]=a[_];return f}return[]}function P(a,h){for(let f=1;f<arguments.length;f++){const _=arguments[f];if(c(_)){const k=a.length||0,D=_.length||0;a.length=k+D;for(let G=0;G<D;G++)a[k+G]=_[G]}else a.push(_)}}class O{constructor(h,f){this.i=h,this.j=f,this.h=0,this.g=null}get(){let h;return 0<this.h?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function N(a){return/^[\s\xa0]*$/.test(a)}function $(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function F(a){return F[" "](a),a}F[" "]=function(){};var H=$().indexOf("Gecko")!=-1&&!($().toLowerCase().indexOf("webkit")!=-1&&$().indexOf("Edge")==-1)&&!($().indexOf("Trident")!=-1||$().indexOf("MSIE")!=-1)&&$().indexOf("Edge")==-1;function ee(a,h,f){for(const _ in a)h.call(f,a[_],_,a)}function S(a,h){for(const f in a)h.call(void 0,a[f],f,a)}function v(a){const h={};for(const f in a)h[f]=a[f];return h}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function I(a,h){let f,_;for(let k=1;k<arguments.length;k++){_=arguments[k];for(f in _)a[f]=_[f];for(let D=0;D<y.length;D++)f=y[D],Object.prototype.hasOwnProperty.call(_,f)&&(a[f]=_[f])}}function R(a){var h=1;a=a.split(":");const f=[];for(;0<h&&a.length;)f.push(a.shift()),h--;return a.length&&f.push(a.join(":")),f}function b(a){l.setTimeout(()=>{throw a},0)}function E(){var a=Bt;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class Ve{constructor(){this.h=this.g=null}add(h,f){const _=Xe.get();_.set(h,f),this.h?this.h.next=_:this.g=_,this.h=_}}var Xe=new O(()=>new Le,a=>a.reset());class Le{constructor(){this.next=this.g=this.h=null}set(h,f){this.h=h,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let pe,Ee=!1,Bt=new Ve,Xt=()=>{const a=l.Promise.resolve(void 0);pe=()=>{a.then(zt)}};var zt=()=>{for(var a;a=E();){try{a.h.call(a.g)}catch(f){b(f)}var h=Xe;h.j(a),100>h.h&&(h.h++,a.next=h.g,h.g=a)}Ee=!1};function ze(){this.s=this.s,this.C=this.C}ze.prototype.s=!1,ze.prototype.ma=function(){this.s||(this.s=!0,this.N())},ze.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ke(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}Ke.prototype.h=function(){this.defaultPrevented=!0};var jn=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};l.addEventListener("test",f,h),l.removeEventListener("test",f,h)}catch{}return a}();function cn(a,h){if(Ke.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var f=this.type=a.type,_=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget){if(H){e:{try{F(h.nodeName);var k=!0;break e}catch{}k=!1}k||(h=null)}}else f=="mouseover"?h=a.fromElement:f=="mouseout"&&(h=a.toElement);this.relatedTarget=h,_?(this.clientX=_.clientX!==void 0?_.clientX:_.pageX,this.clientY=_.clientY!==void 0?_.clientY:_.pageY,this.screenX=_.screenX||0,this.screenY=_.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:Mt[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&cn.aa.h.call(this)}}T(cn,Ke);var Mt={2:"touch",3:"pen",4:"mouse"};cn.prototype.h=function(){cn.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var M="closure_listenable_"+(1e6*Math.random()|0),te=0;function J(a,h,f,_,k){this.listener=a,this.proxy=null,this.src=h,this.type=f,this.capture=!!_,this.ha=k,this.key=++te,this.da=this.fa=!1}function se(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function be(a){this.src=a,this.g={},this.h=0}be.prototype.add=function(a,h,f,_,k){var D=a.toString();a=this.g[D],a||(a=this.g[D]=[],this.h++);var G=w(a,h,_,k);return-1<G?(h=a[G],f||(h.fa=!1)):(h=new J(h,this.src,D,!!_,k),h.fa=f,a.push(h)),h};function xe(a,h){var f=h.type;if(f in a.g){var _=a.g[f],k=Array.prototype.indexOf.call(_,h,void 0),D;(D=0<=k)&&Array.prototype.splice.call(_,k,1),D&&(se(h),a.g[f].length==0&&(delete a.g[f],a.h--))}}function w(a,h,f,_){for(var k=0;k<a.length;++k){var D=a[k];if(!D.da&&D.listener==h&&D.capture==!!f&&D.ha==_)return k}return-1}var A="closure_lm_"+(1e6*Math.random()|0),V={};function j(a,h,f,_,k){if(Array.isArray(h)){for(var D=0;D<h.length;D++)j(a,h[D],f,_,k);return null}return f=ae(f),a&&a[M]?a.K(h,f,u(_)?!!_.capture:!!_,k):x(a,h,f,!1,_,k)}function x(a,h,f,_,k,D){if(!h)throw Error("Invalid event type");var G=u(k)?!!k.capture:!!k,Me=ue(a);if(Me||(a[A]=Me=new be(a)),f=Me.add(h,f,_,G,D),f.proxy)return f;if(_=q(),f.proxy=_,_.src=a,_.listener=f,a.addEventListener)jn||(k=G),k===void 0&&(k=!1),a.addEventListener(h.toString(),_,k);else if(a.attachEvent)a.attachEvent(z(h.toString()),_);else if(a.addListener&&a.removeListener)a.addListener(_);else throw Error("addEventListener and attachEvent are unavailable.");return f}function q(){function a(f){return h.call(a.src,a.listener,f)}const h=W;return a}function Y(a,h,f,_,k){if(Array.isArray(h))for(var D=0;D<h.length;D++)Y(a,h[D],f,_,k);else _=u(_)?!!_.capture:!!_,f=ae(f),a&&a[M]?(a=a.i,h=String(h).toString(),h in a.g&&(D=a.g[h],f=w(D,f,_,k),-1<f&&(se(D[f]),Array.prototype.splice.call(D,f,1),D.length==0&&(delete a.g[h],a.h--)))):a&&(a=ue(a))&&(h=a.g[h.toString()],a=-1,h&&(a=w(h,f,_,k)),(f=-1<a?h[a]:null)&&K(f))}function K(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[M])xe(h.i,a);else{var f=a.type,_=a.proxy;h.removeEventListener?h.removeEventListener(f,_,a.capture):h.detachEvent?h.detachEvent(z(f),_):h.addListener&&h.removeListener&&h.removeListener(_),(f=ue(h))?(xe(f,a),f.h==0&&(f.src=null,h[A]=null)):se(a)}}}function z(a){return a in V?V[a]:V[a]="on"+a}function W(a,h){if(a.da)a=!0;else{h=new cn(h,this);var f=a.listener,_=a.ha||a.src;a.fa&&K(a),a=f.call(_,h)}return a}function ue(a){return a=a[A],a instanceof be?a:null}var Z="__closure_events_fn_"+(1e9*Math.random()>>>0);function ae(a){return typeof a=="function"?a:(a[Z]||(a[Z]=function(h){return a.handleEvent(h)}),a[Z])}function ie(){ze.call(this),this.i=new be(this),this.M=this,this.F=null}T(ie,ze),ie.prototype[M]=!0,ie.prototype.removeEventListener=function(a,h,f,_){Y(this,a,h,f,_)};function he(a,h){var f,_=a.F;if(_)for(f=[];_;_=_.F)f.push(_);if(a=a.M,_=h.type||h,typeof h=="string")h=new Ke(h,a);else if(h instanceof Ke)h.target=h.target||a;else{var k=h;h=new Ke(_,a),I(h,k)}if(k=!0,f)for(var D=f.length-1;0<=D;D--){var G=h.g=f[D];k=ke(G,_,!0,h)&&k}if(G=h.g=a,k=ke(G,_,!0,h)&&k,k=ke(G,_,!1,h)&&k,f)for(D=0;D<f.length;D++)G=h.g=f[D],k=ke(G,_,!1,h)&&k}ie.prototype.N=function(){if(ie.aa.N.call(this),this.i){var a=this.i,h;for(h in a.g){for(var f=a.g[h],_=0;_<f.length;_++)se(f[_]);delete a.g[h],a.h--}}this.F=null},ie.prototype.K=function(a,h,f,_){return this.i.add(String(a),h,!1,f,_)},ie.prototype.L=function(a,h,f,_){return this.i.add(String(a),h,!0,f,_)};function ke(a,h,f,_){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();for(var k=!0,D=0;D<h.length;++D){var G=h[D];if(G&&!G.da&&G.capture==f){var Me=G.listener,dt=G.ha||G.src;G.fa&&xe(a.i,G),k=Me.call(dt,_)!==!1&&k}}return k&&!_.defaultPrevented}function Re(a,h,f){if(typeof a=="function")f&&(a=g(a,f));else if(a&&typeof a.handleEvent=="function")a=g(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(h)?-1:l.setTimeout(a,h||0)}function yt(a){a.g=Re(()=>{a.g=null,a.i&&(a.i=!1,yt(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class at extends ze{constructor(h,f){super(),this.m=h,this.l=f,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:yt(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ht(a){ze.call(this),this.h=a,this.g={}}T(ht,ze);var vt=[];function qn(a){ee(a.g,function(h,f){this.g.hasOwnProperty(f)&&K(h)},a),a.g={}}ht.prototype.N=function(){ht.aa.N.call(this),qn(this)},ht.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ns=l.JSON.stringify,Pt=l.JSON.parse,Kt=class{stringify(a){return l.JSON.stringify(a,void 0)}parse(a){return l.JSON.parse(a,void 0)}};function rs(){}rs.prototype.h=null;function wh(a){return a.h||(a.h=a.i())}function Eh(){}var Js={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function El(){Ke.call(this,"d")}T(El,Ke);function Tl(){Ke.call(this,"c")}T(Tl,Ke);var Pr={},Th=null;function vo(){return Th=Th||new ie}Pr.La="serverreachability";function Ih(a){Ke.call(this,Pr.La,a)}T(Ih,Ke);function Xs(a){const h=vo();he(h,new Ih(h))}Pr.STAT_EVENT="statevent";function Ah(a,h){Ke.call(this,Pr.STAT_EVENT,a),this.stat=h}T(Ah,Ke);function kt(a){const h=vo();he(h,new Ah(h,a))}Pr.Ma="timingevent";function bh(a,h){Ke.call(this,Pr.Ma,a),this.size=h}T(bh,Ke);function Zs(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){a()},h)}function ei(){this.g=!0}ei.prototype.xa=function(){this.g=!1};function Jy(a,h,f,_,k,D){a.info(function(){if(a.g)if(D)for(var G="",Me=D.split("&"),dt=0;dt<Me.length;dt++){var Pe=Me[dt].split("=");if(1<Pe.length){var wt=Pe[0];Pe=Pe[1];var Et=wt.split("_");G=2<=Et.length&&Et[1]=="type"?G+(wt+"="+Pe+"&"):G+(wt+"=redacted&")}}else G=null;else G=D;return"XMLHTTP REQ ("+_+") [attempt "+k+"]: "+h+`
`+f+`
`+G})}function Xy(a,h,f,_,k,D,G){a.info(function(){return"XMLHTTP RESP ("+_+") [ attempt "+k+"]: "+h+`
`+f+`
`+D+" "+G})}function ss(a,h,f,_){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+ev(a,f)+(_?" "+_:"")})}function Zy(a,h){a.info(function(){return"TIMEOUT: "+h})}ei.prototype.info=function(){};function ev(a,h){if(!a.g)return h;if(!h)return null;try{var f=JSON.parse(h);if(f){for(a=0;a<f.length;a++)if(Array.isArray(f[a])){var _=f[a];if(!(2>_.length)){var k=_[1];if(Array.isArray(k)&&!(1>k.length)){var D=k[0];if(D!="noop"&&D!="stop"&&D!="close")for(var G=1;G<k.length;G++)k[G]=""}}}}return ns(f)}catch{return h}}var wo={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ch={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Il;function Eo(){}T(Eo,rs),Eo.prototype.g=function(){return new XMLHttpRequest},Eo.prototype.i=function(){return{}},Il=new Eo;function Wn(a,h,f,_){this.j=a,this.i=h,this.l=f,this.R=_||1,this.U=new ht(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Sh}function Sh(){this.i=null,this.g="",this.h=!1}var Rh={},Al={};function bl(a,h,f){a.L=1,a.v=bo(An(h)),a.m=f,a.P=!0,Ph(a,null)}function Ph(a,h){a.F=Date.now(),To(a),a.A=An(a.v);var f=a.A,_=a.R;Array.isArray(_)||(_=[String(_)]),qh(f.i,"t",_),a.C=0,f=a.j.J,a.h=new Sh,a.g=ad(a.j,f?h:null,!a.m),0<a.O&&(a.M=new at(g(a.Y,a,a.g),a.O)),h=a.U,f=a.g,_=a.ca;var k="readystatechange";Array.isArray(k)||(k&&(vt[0]=k.toString()),k=vt);for(var D=0;D<k.length;D++){var G=j(f,k[D],_||h.handleEvent,!1,h.h||h);if(!G)break;h.g[G.key]=G}h=a.H?v(a.H):{},a.m?(a.u||(a.u="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,h)):(a.u="GET",a.g.ea(a.A,a.u,null,h)),Xs(),Jy(a.i,a.u,a.A,a.l,a.R,a.m)}Wn.prototype.ca=function(a){a=a.target;const h=this.M;h&&bn(a)==3?h.j():this.Y(a)},Wn.prototype.Y=function(a){try{if(a==this.g)e:{const Et=bn(this.g);var h=this.g.Ba();const as=this.g.Z();if(!(3>Et)&&(Et!=3||this.g&&(this.h.h||this.g.oa()||Yh(this.g)))){this.J||Et!=4||h==7||(h==8||0>=as?Xs(3):Xs(2)),Cl(this);var f=this.g.Z();this.X=f;t:if(kh(this)){var _=Yh(this.g);a="";var k=_.length,D=bn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){kr(this),ti(this);var G="";break t}this.h.i=new l.TextDecoder}for(h=0;h<k;h++)this.h.h=!0,a+=this.h.i.decode(_[h],{stream:!(D&&h==k-1)});_.length=0,this.h.g+=a,this.C=0,G=this.h.g}else G=this.g.oa();if(this.o=f==200,Xy(this.i,this.u,this.A,this.l,this.R,Et,f),this.o){if(this.T&&!this.K){t:{if(this.g){var Me,dt=this.g;if((Me=dt.g?dt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!N(Me)){var Pe=Me;break t}}Pe=null}if(f=Pe)ss(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Sl(this,f);else{this.o=!1,this.s=3,kt(12),kr(this),ti(this);break e}}if(this.P){f=!0;let Zt;for(;!this.J&&this.C<G.length;)if(Zt=tv(this,G),Zt==Al){Et==4&&(this.s=4,kt(14),f=!1),ss(this.i,this.l,null,"[Incomplete Response]");break}else if(Zt==Rh){this.s=4,kt(15),ss(this.i,this.l,G,"[Invalid Chunk]"),f=!1;break}else ss(this.i,this.l,Zt,null),Sl(this,Zt);if(kh(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Et!=4||G.length!=0||this.h.h||(this.s=1,kt(16),f=!1),this.o=this.o&&f,!f)ss(this.i,this.l,G,"[Invalid Chunked Response]"),kr(this),ti(this);else if(0<G.length&&!this.W){this.W=!0;var wt=this.j;wt.g==this&&wt.ba&&!wt.M&&(wt.j.info("Great, no buffering proxy detected. Bytes received: "+G.length),Dl(wt),wt.M=!0,kt(11))}}else ss(this.i,this.l,G,null),Sl(this,G);Et==4&&kr(this),this.o&&!this.J&&(Et==4?rd(this.j,this):(this.o=!1,To(this)))}else yv(this.g),f==400&&0<G.indexOf("Unknown SID")?(this.s=3,kt(12)):(this.s=0,kt(13)),kr(this),ti(this)}}}catch{}finally{}};function kh(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function tv(a,h){var f=a.C,_=h.indexOf(`
`,f);return _==-1?Al:(f=Number(h.substring(f,_)),isNaN(f)?Rh:(_+=1,_+f>h.length?Al:(h=h.slice(_,_+f),a.C=_+f,h)))}Wn.prototype.cancel=function(){this.J=!0,kr(this)};function To(a){a.S=Date.now()+a.I,Vh(a,a.I)}function Vh(a,h){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Zs(g(a.ba,a),h)}function Cl(a){a.B&&(l.clearTimeout(a.B),a.B=null)}Wn.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Zy(this.i,this.A),this.L!=2&&(Xs(),kt(17)),kr(this),this.s=2,ti(this)):Vh(this,this.S-a)};function ti(a){a.j.G==0||a.J||rd(a.j,a)}function kr(a){Cl(a);var h=a.M;h&&typeof h.ma=="function"&&h.ma(),a.M=null,qn(a.U),a.g&&(h=a.g,a.g=null,h.abort(),h.ma())}function Sl(a,h){try{var f=a.j;if(f.G!=0&&(f.g==a||Rl(f.h,a))){if(!a.K&&Rl(f.h,a)&&f.G==3){try{var _=f.Da.g.parse(h)}catch{_=null}if(Array.isArray(_)&&_.length==3){var k=_;if(k[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<a.F)Vo(f),Po(f);else break e;Ol(f),kt(18)}}else f.za=k[1],0<f.za-f.T&&37500>k[2]&&f.F&&f.v==0&&!f.C&&(f.C=Zs(g(f.Za,f),6e3));if(1>=Nh(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else Or(f,11)}else if((a.K||f.g==a)&&Vo(f),!N(h))for(k=f.Da.g.parse(h),h=0;h<k.length;h++){let Pe=k[h];if(f.T=Pe[0],Pe=Pe[1],f.G==2)if(Pe[0]=="c"){f.K=Pe[1],f.ia=Pe[2];const wt=Pe[3];wt!=null&&(f.la=wt,f.j.info("VER="+f.la));const Et=Pe[4];Et!=null&&(f.Aa=Et,f.j.info("SVER="+f.Aa));const as=Pe[5];as!=null&&typeof as=="number"&&0<as&&(_=1.5*as,f.L=_,f.j.info("backChannelRequestTimeoutMs_="+_)),_=f;const Zt=a.g;if(Zt){const Do=Zt.g?Zt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Do){var D=_.h;D.g||Do.indexOf("spdy")==-1&&Do.indexOf("quic")==-1&&Do.indexOf("h2")==-1||(D.j=D.l,D.g=new Set,D.h&&(Pl(D,D.h),D.h=null))}if(_.D){const Nl=Zt.g?Zt.g.getResponseHeader("X-HTTP-Session-Id"):null;Nl&&(_.ya=Nl,je(_.I,_.D,Nl))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-a.F,f.j.info("Handshake RTT: "+f.R+"ms")),_=f;var G=a;if(_.qa=od(_,_.J?_.ia:null,_.W),G.K){Lh(_.h,G);var Me=G,dt=_.L;dt&&(Me.I=dt),Me.B&&(Cl(Me),To(Me)),_.g=G}else td(_);0<f.i.length&&ko(f)}else Pe[0]!="stop"&&Pe[0]!="close"||Or(f,7);else f.G==3&&(Pe[0]=="stop"||Pe[0]=="close"?Pe[0]=="stop"?Or(f,7):Vl(f):Pe[0]!="noop"&&f.l&&f.l.ta(Pe),f.v=0)}}Xs(4)}catch{}}var nv=class{constructor(a,h){this.g=a,this.map=h}};function Oh(a){this.l=a||10,l.PerformanceNavigationTiming?(a=l.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Dh(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Nh(a){return a.h?1:a.g?a.g.size:0}function Rl(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function Pl(a,h){a.g?a.g.add(h):a.h=h}function Lh(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Oh.prototype.cancel=function(){if(this.i=xh(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function xh(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const f of a.g.values())h=h.concat(f.D);return h}return C(a.i)}function rv(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(c(a)){for(var h=[],f=a.length,_=0;_<f;_++)h.push(a[_]);return h}h=[],f=0;for(_ in a)h[f++]=a[_];return h}function sv(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(c(a)||typeof a=="string"){var h=[];a=a.length;for(var f=0;f<a;f++)h.push(f);return h}h=[],f=0;for(const _ in a)h[f++]=_;return h}}}function Mh(a,h){if(a.forEach&&typeof a.forEach=="function")a.forEach(h,void 0);else if(c(a)||typeof a=="string")Array.prototype.forEach.call(a,h,void 0);else for(var f=sv(a),_=rv(a),k=_.length,D=0;D<k;D++)h.call(void 0,_[D],f&&f[D],a)}var Fh=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function iv(a,h){if(a){a=a.split("&");for(var f=0;f<a.length;f++){var _=a[f].indexOf("="),k=null;if(0<=_){var D=a[f].substring(0,_);k=a[f].substring(_+1)}else D=a[f];h(D,k?decodeURIComponent(k.replace(/\+/g," ")):"")}}}function Vr(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Vr){this.h=a.h,Io(this,a.j),this.o=a.o,this.g=a.g,Ao(this,a.s),this.l=a.l;var h=a.i,f=new si;f.i=h.i,h.g&&(f.g=new Map(h.g),f.h=h.h),Uh(this,f),this.m=a.m}else a&&(h=String(a).match(Fh))?(this.h=!1,Io(this,h[1]||"",!0),this.o=ni(h[2]||""),this.g=ni(h[3]||"",!0),Ao(this,h[4]),this.l=ni(h[5]||"",!0),Uh(this,h[6]||"",!0),this.m=ni(h[7]||"")):(this.h=!1,this.i=new si(null,this.h))}Vr.prototype.toString=function(){var a=[],h=this.j;h&&a.push(ri(h,$h,!0),":");var f=this.g;return(f||h=="file")&&(a.push("//"),(h=this.o)&&a.push(ri(h,$h,!0),"@"),a.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&a.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(ri(f,f.charAt(0)=="/"?lv:av,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",ri(f,uv)),a.join("")};function An(a){return new Vr(a)}function Io(a,h,f){a.j=f?ni(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function Ao(a,h){if(h){if(h=Number(h),isNaN(h)||0>h)throw Error("Bad port number "+h);a.s=h}else a.s=null}function Uh(a,h,f){h instanceof si?(a.i=h,hv(a.i,a.h)):(f||(h=ri(h,cv)),a.i=new si(h,a.h))}function je(a,h,f){a.i.set(h,f)}function bo(a){return je(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function ni(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function ri(a,h,f){return typeof a=="string"?(a=encodeURI(a).replace(h,ov),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function ov(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var $h=/[#\/\?@]/g,av=/[#\?:]/g,lv=/[#\?]/g,cv=/[#\?@]/g,uv=/#/g;function si(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Hn(a){a.g||(a.g=new Map,a.h=0,a.i&&iv(a.i,function(h,f){a.add(decodeURIComponent(h.replace(/\+/g," ")),f)}))}t=si.prototype,t.add=function(a,h){Hn(this),this.i=null,a=is(this,a);var f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(h),this.h+=1,this};function Bh(a,h){Hn(a),h=is(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function jh(a,h){return Hn(a),h=is(a,h),a.g.has(h)}t.forEach=function(a,h){Hn(this),this.g.forEach(function(f,_){f.forEach(function(k){a.call(h,k,_,this)},this)},this)},t.na=function(){Hn(this);const a=Array.from(this.g.values()),h=Array.from(this.g.keys()),f=[];for(let _=0;_<h.length;_++){const k=a[_];for(let D=0;D<k.length;D++)f.push(h[_])}return f},t.V=function(a){Hn(this);let h=[];if(typeof a=="string")jh(this,a)&&(h=h.concat(this.g.get(is(this,a))));else{a=Array.from(this.g.values());for(let f=0;f<a.length;f++)h=h.concat(a[f])}return h},t.set=function(a,h){return Hn(this),this.i=null,a=is(this,a),jh(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=this.V(a),0<a.length?String(a[0]):h):h};function qh(a,h,f){Bh(a,h),0<f.length&&(a.i=null,a.g.set(is(a,h),C(f)),a.h+=f.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(var f=0;f<h.length;f++){var _=h[f];const D=encodeURIComponent(String(_)),G=this.V(_);for(_=0;_<G.length;_++){var k=D;G[_]!==""&&(k+="="+encodeURIComponent(String(G[_]))),a.push(k)}}return this.i=a.join("&")};function is(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function hv(a,h){h&&!a.j&&(Hn(a),a.i=null,a.g.forEach(function(f,_){var k=_.toLowerCase();_!=k&&(Bh(this,_),qh(this,k,f))},a)),a.j=h}function dv(a,h){const f=new ei;if(l.Image){const _=new Image;_.onload=m(zn,f,"TestLoadImage: loaded",!0,h,_),_.onerror=m(zn,f,"TestLoadImage: error",!1,h,_),_.onabort=m(zn,f,"TestLoadImage: abort",!1,h,_),_.ontimeout=m(zn,f,"TestLoadImage: timeout",!1,h,_),l.setTimeout(function(){_.ontimeout&&_.ontimeout()},1e4),_.src=a}else h(!1)}function fv(a,h){const f=new ei,_=new AbortController,k=setTimeout(()=>{_.abort(),zn(f,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:_.signal}).then(D=>{clearTimeout(k),D.ok?zn(f,"TestPingServer: ok",!0,h):zn(f,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(k),zn(f,"TestPingServer: error",!1,h)})}function zn(a,h,f,_,k){try{k&&(k.onload=null,k.onerror=null,k.onabort=null,k.ontimeout=null),_(f)}catch{}}function pv(){this.g=new Kt}function gv(a,h,f){const _=f||"";try{Mh(a,function(k,D){let G=k;u(k)&&(G=ns(k)),h.push(_+D+"="+encodeURIComponent(G))})}catch(k){throw h.push(_+"type="+encodeURIComponent("_badmap")),k}}function Co(a){this.l=a.Ub||null,this.j=a.eb||!1}T(Co,rs),Co.prototype.g=function(){return new So(this.l,this.j)},Co.prototype.i=function(a){return function(){return a}}({});function So(a,h){ie.call(this),this.D=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}T(So,ie),t=So.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=h,this.readyState=1,oi(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const h={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(h.body=a),(this.D||l).fetch(new Request(this.A,h)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,ii(this)),this.readyState=0},t.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,oi(this)),this.g&&(this.readyState=3,oi(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Wh(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Wh(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}t.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.v.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?ii(this):oi(this),this.readyState==3&&Wh(this)}},t.Ra=function(a){this.g&&(this.response=this.responseText=a,ii(this))},t.Qa=function(a){this.g&&(this.response=a,ii(this))},t.ga=function(){this.g&&ii(this)};function ii(a){a.readyState=4,a.l=null,a.j=null,a.v=null,oi(a)}t.setRequestHeader=function(a,h){this.u.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var f=h.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=h.next();return a.join(`\r
`)};function oi(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(So.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Hh(a){let h="";return ee(a,function(f,_){h+=_,h+=":",h+=f,h+=`\r
`}),h}function kl(a,h,f){e:{for(_ in f){var _=!1;break e}_=!0}_||(f=Hh(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):je(a,h,f))}function Qe(a){ie.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}T(Qe,ie);var mv=/^https?$/i,_v=["POST","PUT"];t=Qe.prototype,t.Ha=function(a){this.J=a},t.ea=function(a,h,f,_){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Il.g(),this.v=this.o?wh(this.o):wh(Il),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(D){zh(this,D);return}if(a=f||"",f=new Map(this.headers),_)if(Object.getPrototypeOf(_)===Object.prototype)for(var k in _)f.set(k,_[k]);else if(typeof _.keys=="function"&&typeof _.get=="function")for(const D of _.keys())f.set(D,_.get(D));else throw Error("Unknown input type for opt_headers: "+String(_));_=Array.from(f.keys()).find(D=>D.toLowerCase()=="content-type"),k=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(_v,h,void 0))||_||k||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[D,G]of f)this.g.setRequestHeader(D,G);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Qh(this),this.u=!0,this.g.send(a),this.u=!1}catch(D){zh(this,D)}};function zh(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.m=5,Kh(a),Ro(a)}function Kh(a){a.A||(a.A=!0,he(a,"complete"),he(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,he(this,"complete"),he(this,"abort"),Ro(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ro(this,!0)),Qe.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Gh(this):this.bb())},t.bb=function(){Gh(this)};function Gh(a){if(a.h&&typeof o<"u"&&(!a.v[1]||bn(a)!=4||a.Z()!=2)){if(a.u&&bn(a)==4)Re(a.Ea,0,a);else if(he(a,"readystatechange"),bn(a)==4){a.h=!1;try{const G=a.Z();e:switch(G){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var f;if(!(f=h)){var _;if(_=G===0){var k=String(a.D).match(Fh)[1]||null;!k&&l.self&&l.self.location&&(k=l.self.location.protocol.slice(0,-1)),_=!mv.test(k?k.toLowerCase():"")}f=_}if(f)he(a,"complete"),he(a,"success");else{a.m=6;try{var D=2<bn(a)?a.g.statusText:""}catch{D=""}a.l=D+" ["+a.Z()+"]",Kh(a)}}finally{Ro(a)}}}}function Ro(a,h){if(a.g){Qh(a);const f=a.g,_=a.v[0]?()=>{}:null;a.g=null,a.v=null,h||he(a,"ready");try{f.onreadystatechange=_}catch{}}}function Qh(a){a.I&&(l.clearTimeout(a.I),a.I=null)}t.isActive=function(){return!!this.g};function bn(a){return a.g?a.g.readyState:0}t.Z=function(){try{return 2<bn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),Pt(h)}};function Yh(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function yv(a){const h={};a=(a.g&&2<=bn(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let _=0;_<a.length;_++){if(N(a[_]))continue;var f=R(a[_]);const k=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const D=h[k]||[];h[k]=D,D.push(f)}S(h,function(_){return _.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function ai(a,h,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||h}function Jh(a){this.Aa=0,this.i=[],this.j=new ei,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=ai("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=ai("baseRetryDelayMs",5e3,a),this.cb=ai("retryDelaySeedMs",1e4,a),this.Wa=ai("forwardChannelMaxRetries",2,a),this.wa=ai("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Oh(a&&a.concurrentRequestLimit),this.Da=new pv,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Jh.prototype,t.la=8,t.G=1,t.connect=function(a,h,f,_){kt(0),this.W=a,this.H=h||{},f&&_!==void 0&&(this.H.OSID=f,this.H.OAID=_),this.F=this.X,this.I=od(this,null,this.W),ko(this)};function Vl(a){if(Xh(a),a.G==3){var h=a.U++,f=An(a.I);if(je(f,"SID",a.K),je(f,"RID",h),je(f,"TYPE","terminate"),li(a,f),h=new Wn(a,a.j,h),h.L=2,h.v=bo(An(f)),f=!1,l.navigator&&l.navigator.sendBeacon)try{f=l.navigator.sendBeacon(h.v.toString(),"")}catch{}!f&&l.Image&&(new Image().src=h.v,f=!0),f||(h.g=ad(h.j,null),h.g.ea(h.v)),h.F=Date.now(),To(h)}id(a)}function Po(a){a.g&&(Dl(a),a.g.cancel(),a.g=null)}function Xh(a){Po(a),a.u&&(l.clearTimeout(a.u),a.u=null),Vo(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function ko(a){if(!Dh(a.h)&&!a.s){a.s=!0;var h=a.Ga;pe||Xt(),Ee||(pe(),Ee=!0),Bt.add(h,a),a.B=0}}function vv(a,h){return Nh(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=h.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Zs(g(a.Ga,a,h),sd(a,a.B)),a.B++,!0)}t.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const k=new Wn(this,this.j,a);let D=this.o;if(this.S&&(D?(D=v(D),I(D,this.S)):D=this.S),this.m!==null||this.O||(k.H=D,D=null),this.P)e:{for(var h=0,f=0;f<this.i.length;f++){t:{var _=this.i[f];if("__data__"in _.map&&(_=_.map.__data__,typeof _=="string")){_=_.length;break t}_=void 0}if(_===void 0)break;if(h+=_,4096<h){h=f;break e}if(h===4096||f===this.i.length-1){h=f+1;break e}}h=1e3}else h=1e3;h=ed(this,k,h),f=An(this.I),je(f,"RID",a),je(f,"CVER",22),this.D&&je(f,"X-HTTP-Session-Id",this.D),li(this,f),D&&(this.O?h="headers="+encodeURIComponent(String(Hh(D)))+"&"+h:this.m&&kl(f,this.m,D)),Pl(this.h,k),this.Ua&&je(f,"TYPE","init"),this.P?(je(f,"$req",h),je(f,"SID","null"),k.T=!0,bl(k,f,null)):bl(k,f,h),this.G=2}}else this.G==3&&(a?Zh(this,a):this.i.length==0||Dh(this.h)||Zh(this))};function Zh(a,h){var f;h?f=h.l:f=a.U++;const _=An(a.I);je(_,"SID",a.K),je(_,"RID",f),je(_,"AID",a.T),li(a,_),a.m&&a.o&&kl(_,a.m,a.o),f=new Wn(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),h&&(a.i=h.D.concat(a.i)),h=ed(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Pl(a.h,f),bl(f,_,h)}function li(a,h){a.H&&ee(a.H,function(f,_){je(h,_,f)}),a.l&&Mh({},function(f,_){je(h,_,f)})}function ed(a,h,f){f=Math.min(a.i.length,f);var _=a.l?g(a.l.Na,a.l,a):null;e:{var k=a.i;let D=-1;for(;;){const G=["count="+f];D==-1?0<f?(D=k[0].g,G.push("ofs="+D)):D=0:G.push("ofs="+D);let Me=!0;for(let dt=0;dt<f;dt++){let Pe=k[dt].g;const wt=k[dt].map;if(Pe-=D,0>Pe)D=Math.max(0,k[dt].g-100),Me=!1;else try{gv(wt,G,"req"+Pe+"_")}catch{_&&_(wt)}}if(Me){_=G.join("&");break e}}}return a=a.i.splice(0,f),h.D=a,_}function td(a){if(!a.g&&!a.u){a.Y=1;var h=a.Fa;pe||Xt(),Ee||(pe(),Ee=!0),Bt.add(h,a),a.v=0}}function Ol(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Zs(g(a.Fa,a),sd(a,a.v)),a.v++,!0)}t.Fa=function(){if(this.u=null,nd(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Zs(g(this.ab,this),a)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,kt(10),Po(this),nd(this))};function Dl(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function nd(a){a.g=new Wn(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var h=An(a.qa);je(h,"RID","rpc"),je(h,"SID",a.K),je(h,"AID",a.T),je(h,"CI",a.F?"0":"1"),!a.F&&a.ja&&je(h,"TO",a.ja),je(h,"TYPE","xmlhttp"),li(a,h),a.m&&a.o&&kl(h,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=bo(An(h)),f.m=null,f.P=!0,Ph(f,a)}t.Za=function(){this.C!=null&&(this.C=null,Po(this),Ol(this),kt(19))};function Vo(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function rd(a,h){var f=null;if(a.g==h){Vo(a),Dl(a),a.g=null;var _=2}else if(Rl(a.h,h))f=h.D,Lh(a.h,h),_=1;else return;if(a.G!=0){if(h.o)if(_==1){f=h.m?h.m.length:0,h=Date.now()-h.F;var k=a.B;_=vo(),he(_,new bh(_,f)),ko(a)}else td(a);else if(k=h.s,k==3||k==0&&0<h.X||!(_==1&&vv(a,h)||_==2&&Ol(a)))switch(f&&0<f.length&&(h=a.h,h.i=h.i.concat(f)),k){case 1:Or(a,5);break;case 4:Or(a,10);break;case 3:Or(a,6);break;default:Or(a,2)}}}function sd(a,h){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*h}function Or(a,h){if(a.j.info("Error code "+h),h==2){var f=g(a.fb,a),_=a.Xa;const k=!_;_=new Vr(_||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Io(_,"https"),bo(_),k?dv(_.toString(),f):fv(_.toString(),f)}else kt(2);a.G=0,a.l&&a.l.sa(h),id(a),Xh(a)}t.fb=function(a){a?(this.j.info("Successfully pinged google.com"),kt(2)):(this.j.info("Failed to ping google.com"),kt(1))};function id(a){if(a.G=0,a.ka=[],a.l){const h=xh(a.h);(h.length!=0||a.i.length!=0)&&(P(a.ka,h),P(a.ka,a.i),a.h.i.length=0,C(a.i),a.i.length=0),a.l.ra()}}function od(a,h,f){var _=f instanceof Vr?An(f):new Vr(f);if(_.g!="")h&&(_.g=h+"."+_.g),Ao(_,_.s);else{var k=l.location;_=k.protocol,h=h?h+"."+k.hostname:k.hostname,k=+k.port;var D=new Vr(null);_&&Io(D,_),h&&(D.g=h),k&&Ao(D,k),f&&(D.l=f),_=D}return f=a.D,h=a.ya,f&&h&&je(_,f,h),je(_,"VER",a.la),li(a,_),_}function ad(a,h,f){if(h&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Ca&&!a.pa?new Qe(new Co({eb:f})):new Qe(a.pa),h.Ha(a.J),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function ld(){}t=ld.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Oo(){}Oo.prototype.g=function(a,h){return new jt(a,h)};function jt(a,h){ie.call(this),this.g=new Jh(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(a?a["X-WebChannel-Client-Profile"]=h.va:a={"X-WebChannel-Client-Profile":h.va}),this.g.S=a,(a=h&&h.Sb)&&!N(a)&&(this.g.m=a),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!N(h)&&(this.g.D=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new os(this)}T(jt,ie),jt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},jt.prototype.close=function(){Vl(this.g)},jt.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=ns(a),a=f);h.i.push(new nv(h.Ya++,a)),h.G==3&&ko(h)},jt.prototype.N=function(){this.g.l=null,delete this.j,Vl(this.g),delete this.g,jt.aa.N.call(this)};function cd(a){El.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const f in h){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}T(cd,El);function ud(){Tl.call(this),this.status=1}T(ud,Tl);function os(a){this.g=a}T(os,ld),os.prototype.ua=function(){he(this.g,"a")},os.prototype.ta=function(a){he(this.g,new cd(a))},os.prototype.sa=function(a){he(this.g,new ud)},os.prototype.ra=function(){he(this.g,"b")},Oo.prototype.createWebChannel=Oo.prototype.g,jt.prototype.send=jt.prototype.o,jt.prototype.open=jt.prototype.m,jt.prototype.close=jt.prototype.close,R_=function(){return new Oo},S_=function(){return vo()},C_=Pr,xc={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},wo.NO_ERROR=0,wo.TIMEOUT=8,wo.HTTP_ERROR=6,na=wo,Ch.COMPLETE="complete",b_=Ch,Eh.EventType=Js,Js.OPEN="a",Js.CLOSE="b",Js.ERROR="c",Js.MESSAGE="d",ie.prototype.listen=ie.prototype.K,gi=Eh,Qe.prototype.listenOnce=Qe.prototype.L,Qe.prototype.getLastError=Qe.prototype.Ka,Qe.prototype.getLastErrorCode=Qe.prototype.Ba,Qe.prototype.getStatus=Qe.prototype.Z,Qe.prototype.getResponseJson=Qe.prototype.Oa,Qe.prototype.getResponseText=Qe.prototype.oa,Qe.prototype.send=Qe.prototype.ea,Qe.prototype.setWithCredentials=Qe.prototype.Ha,A_=Qe}).apply(typeof Bo<"u"?Bo:typeof self<"u"?self:typeof window<"u"?window:{});const Jf="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=new bu("@firebase/firestore");function ds(){return Qr.logLevel}function ne(t,...e){if(Qr.logLevel<=Te.DEBUG){const n=e.map(Fu);Qr.debug(`Firestore (${Hs}): ${t}`,...n)}}function Fn(t,...e){if(Qr.logLevel<=Te.ERROR){const n=e.map(Fu);Qr.error(`Firestore (${Hs}): ${t}`,...n)}}function Os(t,...e){if(Qr.logLevel<=Te.WARN){const n=e.map(Fu);Qr.warn(`Firestore (${Hs}): ${t}`,...n)}}function Fu(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(t="Unexpected state"){const e=`FIRESTORE (${Hs}) INTERNAL ASSERTION FAILED: `+t;throw Fn(e),new Error(e)}function Ne(t,e){t||me()}function ve(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(t){if(t.code!==B.FAILED_PRECONDITION||t.message!==jb)throw t;ne("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qu(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ra(e)?"-0":e}}function K_(t){return{integerValue:""+t}}function _C(t,e){return Hb(e)?K_(e):qu(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VS extends class{}{constructor(e,n,r,s){super(),this.authCredentials=e,this.appCheckCredentials=n,this.connection=r,this.serializer=s,this.S_=!1}b_(){if(this.S_)throw new re(B.FAILED_PRECONDITION,"The client has already been terminated.")}Oo(e,n,r,s){return this.b_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.Oo(e,Wc(n,r),s,i,o)).catch(i=>{throw i.name==="FirebaseError"?(i.code===B.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new re(B.UNKNOWN,i.toString())})}ko(e,n,r,s,i){return this.b_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,l])=>this.connection.ko(e,Wc(n,r),s,o,l,i)).catch(o=>{throw o.name==="FirebaseError"?(o.code===B.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new re(B.UNKNOWN,o.toString())})}terminate(){this.S_=!0,this.connection.terminate()}}class OS{constructor(e,n){this.asyncQueue=e,this.onlineStateHandler=n,this.state="Unknown",this.D_=0,this.v_=null,this.C_=!0}F_(){this.D_===0&&(this.M_("Unknown"),this.v_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.v_=null,this.x_("Backend didn't respond within 10 seconds."),this.M_("Offline"),Promise.resolve())))}O_(e){this.state==="Online"?this.M_("Unknown"):(this.D_++,this.D_>=1&&(this.N_(),this.x_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.M_("Offline")))}set(e){this.N_(),this.D_=0,e==="Online"&&(this.C_=!1),this.M_(e)}M_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}x_(e){const n=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DS{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.L_=[],this.B_=new Map,this.k_=new Set,this.q_=[],this.Q_=i,this.Q_.uo(o=>{r.enqueueAndForget(async()=>{es(this)&&(ne("RemoteStore","Restarting streams for network reachability change."),await async function(c){const u=ve(c);u.k_.add(4),await po(u),u.K_.set("Unknown"),u.k_.delete(4),await pl(u)}(this))})}),this.K_=new OS(r,s)}}async function pl(t){if(es(t))for(const e of t.q_)await e(!0)}async function po(t){for(const e of t.q_)await e(!1)}function gy(t,e){const n=ve(t);n.B_.has(e.targetId)||(n.B_.set(e.targetId,e),eh(n)?Zu(n):Qs(n).s_()&&Xu(n,e))}function Ju(t,e){const n=ve(t),r=Qs(n);n.B_.delete(e),r.s_()&&my(n,e),n.B_.size===0&&(r.s_()?r.a_():es(n)&&n.K_.set("Unknown"))}function Xu(t,e){if(t.U_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(_e.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}Qs(t).V_(e)}function my(t,e){t.U_.xe(e),Qs(t).m_(e)}function Zu(t){t.U_=new VC({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ut:e=>t.B_.get(e)||null,nt:()=>t.datastore.serializer.databaseId}),Qs(t).start(),t.K_.F_()}function eh(t){return es(t)&&!Qs(t).i_()&&t.B_.size>0}function es(t){return ve(t).k_.size===0}function _y(t){t.U_=void 0}async function NS(t){t.K_.set("Online")}async function LS(t){t.B_.forEach((e,n)=>{Xu(t,e)})}async function xS(t,e){_y(t),eh(t)?(t.K_.O_(e),Zu(t)):t.K_.set("Unknown")}async function MS(t,e,n){if(t.K_.set("Online"),e instanceof ny&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const l of i.targetIds)s.B_.has(l)&&(await s.remoteSyncer.rejectListen(l,o),s.B_.delete(l),s.U_.removeTarget(l))}(t,e)}catch(r){ne("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Na(t,r)}else if(e instanceof oa?t.U_.$e(e):e instanceof ty?t.U_.Je(e):t.U_.Ge(e),!n.isEqual(_e.min()))try{const r=await dy(t.localStore);n.compareTo(r)>=0&&await function(i,o){const l=i.U_.it(o);return l.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const d=i.B_.get(u);d&&i.B_.set(u,d.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,u)=>{const d=i.B_.get(c);if(!d)return;i.B_.set(c,d.withResumeToken(_t.EMPTY_BYTE_STRING,d.snapshotVersion)),my(i,c);const p=new or(d.target,c,u,d.sequenceNumber);Xu(i,p)}),i.remoteSyncer.applyRemoteEvent(l)}(t,n)}catch(r){ne("RemoteStore","Failed to raise snapshot:",r),await Na(t,r)}}async function Na(t,e,n){if(!Ks(e))throw e;t.k_.add(1),await po(t),t.K_.set("Offline"),n||(n=()=>dy(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{ne("RemoteStore","Retrying IndexedDB access"),await n(),t.k_.delete(1),await pl(t)})}function yy(t,e){return e().catch(n=>Na(t,n,e))}async function gl(t){const e=ve(t),n=wr(e);let r=e.L_.length>0?e.L_[e.L_.length-1].batchId:-1;for(;FS(e);)try{const s=await ES(e.localStore,r);if(s===null){e.L_.length===0&&n.a_();break}r=s.batchId,US(e,s)}catch(s){await Na(e,s)}vy(e)&&wy(e)}function FS(t){return es(t)&&t.L_.length<10}function US(t,e){t.L_.push(e);const n=wr(t);n.s_()&&n.f_&&n.g_(e.mutations)}function vy(t){return es(t)&&!wr(t).i_()&&t.L_.length>0}function wy(t){wr(t).start()}async function $S(t){wr(t).w_()}async function BS(t){const e=wr(t);for(const n of t.L_)e.g_(n.mutations)}async function jS(t,e,n){const r=t.L_.shift(),s=Hu.from(r,e,n);await yy(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await gl(t)}async function qS(t,e){e&&wr(t).f_&&await async function(r,s){if(function(o){return RC(o)&&o!==B.ABORTED}(s.code)){const i=r.L_.shift();wr(r).__(),await yy(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await gl(r)}}(t,e),vy(t)&&wy(t)}async function Ap(t,e){const n=ve(t);n.asyncQueue.verifyOperationInProgress(),ne("RemoteStore","RemoteStore received new credentials");const r=es(n);n.k_.add(3),await po(n),r&&n.K_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.k_.delete(3),await pl(n)}async function WS(t,e){const n=ve(t);e?(n.k_.delete(2),await pl(n)):e||(n.k_.add(2),await po(n),n.K_.set("Unknown"))}function Qs(t){return t.W_||(t.W_=function(n,r,s){const i=ve(n);return i.b_(),new PS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Ro:NS.bind(null,t),mo:LS.bind(null,t),po:xS.bind(null,t),R_:MS.bind(null,t)}),t.q_.push(async e=>{e?(t.W_.__(),eh(t)?Zu(t):t.K_.set("Unknown")):(await t.W_.stop(),_y(t))})),t.W_}function wr(t){return t.G_||(t.G_=function(n,r,s){const i=ve(n);return i.b_(),new kS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Ro:()=>Promise.resolve(),mo:$S.bind(null,t),po:qS.bind(null,t),p_:BS.bind(null,t),y_:jS.bind(null,t)}),t.q_.push(async e=>{e?(t.G_.__(),await gl(t)):(await t.G_.stop(),t.L_.length>0&&(ne("RemoteStore",`Stopping write stream with ${t.L_.length} pending writes`),t.L_=[]))})),t.G_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HS{constructor(){this.H_=void 0,this.J_=[]}Y_(){return this.J_.some(e=>e.Z_())}}class zS{constructor(){this.queries=Cp(),this.onlineState="Unknown",this.X_=new Set}terminate(){(function(n,r){const s=ve(n),i=s.queries;s.queries=Cp(),i.forEach((o,l)=>{for(const c of l.J_)c.onError(r)})})(this,new re(B.ABORTED,"Firestore shutting down"))}}function Cp(){return new Zr(t=>j_(t),ll)}async function KS(t,e){const n=ve(t);let r=3;const s=e.query;let i=n.queries.get(s);i?!i.Y_()&&e.Z_()&&(r=2):(i=new HS,r=e.Z_()?0:1);try{switch(r){case 0:i.H_=await n.onListen(s,!0);break;case 1:i.H_=await n.onListen(s,!1);break;case 2:await n.onFirstRemoteStoreListen(s)}}catch(o){const l=nh(o,`Initialization of query '${fs(e.query)}' failed`);return void e.onError(l)}n.queries.set(s,i),i.J_.push(e),e.ea(n.onlineState),i.H_&&e.ta(i.H_)&&rh(n)}async function GS(t,e){const n=ve(t),r=e.query;let s=3;const i=n.queries.get(r);if(i){const o=i.J_.indexOf(e);o>=0&&(i.J_.splice(o,1),i.J_.length===0?s=e.Z_()?0:1:!i.Y_()&&e.Z_()&&(s=2))}switch(s){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function QS(t,e){const n=ve(t);let r=!1;for(const s of e){const i=s.query,o=n.queries.get(i);if(o){for(const l of o.J_)l.ta(s)&&(r=!0);o.H_=s}}r&&rh(n)}function YS(t,e,n){const r=ve(t),s=r.queries.get(e);if(s)for(const i of s.J_)i.onError(n);r.queries.delete(e)}function rh(t){t.X_.forEach(e=>{e.next()})}var Gc,Sp;(Sp=Gc||(Gc={})).na="default",Sp.Cache="cache";class JS{constructor(e,n,r){this.query=e,this.ra=n,this.ia=!1,this.sa=null,this.onlineState="Unknown",this.options=r||{}}ta(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new Ms(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.ia?this.oa(e)&&(this.ra.next(e),n=!0):this._a(e,this.onlineState)&&(this.aa(e),n=!0),this.sa=e,n}onError(e){this.ra.error(e)}ea(e){this.onlineState=e;let n=!1;return this.sa&&!this.ia&&this._a(this.sa,e)&&(this.aa(this.sa),n=!0),n}_a(e,n){if(!e.fromCache||!this.Z_())return!0;const r=n!=="Offline";return(!this.options.ua||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}oa(e){if(e.docChanges.length>0)return!0;const n=this.sa&&this.sa.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}aa(e){e=Ms.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.ia=!0,this.ra.next(e)}Z_(){return this.options.source!==Gc.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Fs(_t.fromBase64String(e))}catch(n){throw new re(B.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Fs(_t.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new re(B.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new gt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new re(B.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new re(B.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Ae(this._lat,e._lat)||Ae(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class $R extends Fy{constructor(e,n,r,s,i,o){super(e,n,r,s,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new aa(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(dh("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class aa extends $R{data(e={}){return super.data(e)}}class BR{constructor(e,n,r,s){this._firestore=e,this._userDataWriter=n,this._snapshot=s,this.metadata=new zo(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(r=>{e.call(n,new aa(this._firestore,this._userDataWriter,r.key,r,new zo(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new re(B.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let o=0;return s._snapshot.docChanges.map(l=>{const c=new aa(s._firestore,s._userDataWriter,l.doc.key,l.doc,new zo(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(l=>i||l.type!==3).map(l=>{const c=new aa(s._firestore,s._userDataWriter,l.doc.key,l.doc,new zo(s._snapshot.mutatedKeys.has(l.doc.key),s._snapshot.fromCache),s.query.converter);let u=-1,d=-1;return l.type!==0&&(u=o.indexOf(l.doc.key),o=o.delete(l.doc.key)),l.type!==1&&(o=o.add(l.doc),d=o.indexOf(l.doc.key)),{type:jR(l.type),doc:c,oldIndex:u,newIndex:d}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function jR(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return me()}}class qR extends FR{constructor(e){super(),this.firestore=e}convertBytes(e){return new Fs(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new $t(this.firestore,null,n)}}function WR(t){t=Er(t,ts);const e=Er(t.firestore,mo),n=Oy(e),r=new qR(e);return LR(t._query),ER(n,t._query).then(s=>new BR(e,r,t,s))}function HR(t,e,n){t=Er(t,$t);const r=Er(t.firestore,mo),s=UR(t.converter,e);return _h(r,[PR(ch(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,nn.none())])}function By(t,e,n,...r){t=Er(t,$t);const s=Er(t.firestore,mo),i=ch(s);let o;return o=typeof(e=ut(e))=="string"||e instanceof vl?VR(i,"updateDoc",t._key,e,n,r):kR(i,"updateDoc",t._key,e),_h(s,[o.toMutation(t._key,nn.exists(!0))])}function zR(t){return _h(Er(t.firestore,mo),[new Wu(t._key,nn.none())])}function _h(t,e){return function(r,s){const i=new dr;return r.asyncQueue.enqueueAndForget(async()=>aR(await vR(r),s,i)),i.promise}(Oy(t),e)}(function(e,n=!0){(function(s){Hs=s})(qs),ks(new zr("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),l=new mo(new Ob(r.getProvider("auth-internal")),new xb(r.getProvider("app-check-internal")),function(u,d){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new re(B.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Yi(u.options.projectId,d)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),hr(Jf,"4.7.5",e),hr(Jf,"4.7.5","esm2017")})();const Ys=js("user",()=>({userId:ge("")})),Rr=js("wordsStore",()=>{const t=sl(),e=Ys(),n=_o(),r=ge([]);let s=ge(!1);async function i(){if(!s.value){if(!navigator.onLine){console.error("No internet connection.");return}try{const l=xR(AR(n,`users/${e.userId}/words`),MR("createdAt","desc")),c=await WR(l);r.value=c.docs.map(u=>u.data()),s.value=!0,t.hideLoader()}catch(l){console.error("Error fetching data from Firestore:",l)}}}async function o(){s.value=!1,t.showLoader(),await i()}return{wordsList:r,getAllIWords:i,reloadWords:o,isDataLoaded:s}}),yh=js("search",()=>{const t=ge();function e(r){t.value=r}function n(){t.value={}}return{selectedWord:t,setWord:e,clearWord:n}});function KR(){const t=Rr(),e=yh(),n=Au(),r=ge(""),s=ge(!1),i=ge(null),o=we(()=>{const p=r.value.trim().toLowerCase(),g=t.wordsList.flatMap(m=>Object.entries(m.directions).filter(([C,P])=>P).map(([C])=>({...m,direction:C})));return p?g.filter(m=>m.word.toLowerCase().includes(p)||m.category.toLowerCase().includes(p)||m.direction.toLowerCase().includes(p)):g}),l=()=>{s.value=!s.value},c=p=>{i.value&&!i.value.contains(p.target)&&(s.value=!1)},u=()=>{console.log("Search value:",r.value)},d=p=>{e.setWord(p),n.push(`/words/${encodeURIComponent(p.direction)}`)};return Jr(()=>{document.addEventListener("click",c)}),pu(()=>{document.removeEventListener("click",c)}),{searchValue:r,filteredWords:o,isOpen:s,dropdownRef:i,toggleDropdown:l,handleSubmit:u,handleWordClick:d}}const GR={class:"search__results search-results filling filling--without-focus"},QR={key:0,class:"search-results__list results-list"},YR=["onClick"],JR={key:1,class:"search-results__no-results no-results"},jy=He({__name:"Search",setup(t){const{searchValue:e,filteredWords:n,isOpen:r,dropdownRef:s,toggleDropdown:i,handleSubmit:o,handleWordClick:l}=KR();return(c,u)=>(X(),oe("div",{class:We(["search",{"search--active":Q(r)}])},[L("form",{class:"search__form search-form",ref_key:"dropdownRef",ref:s,action:"#",method:"post",onClick:u[2]||(u[2]=(...d)=>Q(i)&&Q(i)(...d))},[tn(L("input",{class:"search-form__input filling filling--without-focus",type:"text",placeholder:"Search","onUpdate:modelValue":u[0]||(u[0]=d=>Ye(e)?e.value=d:null)},null,512),[[mn,Q(e)]]),L("button",{class:"search-form__btn",type:"button",onClick:u[1]||(u[1]=(...d)=>Q(o)&&Q(o)(...d))},u[4]||(u[4]=[L("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M6.74626 12.4959C3.56372 12.4959 1 9.93141 1 6.74794C1 3.56446 3.56372 1 6.74626 1C9.9288 1 12.4925 3.56446 12.4925 6.74794C12.4925 9.93141 9.9288 12.4959 6.74626 12.4959ZM6.74626 1.8843C4.04994 1.8843 1.88404 4.05083 1.88404 6.74794C1.88404 9.44505 4.04994 11.6116 6.74626 11.6116C9.44258 11.6116 11.6085 9.44505 11.6085 6.74794C11.6085 4.05083 9.44258 1.8843 6.74626 1.8843Z",fill:"white"}),L("path",{d:"M11.0313 10.4062L15.0006 14.3767L14.3756 15.0019L10.4062 11.0314L11.0313 10.4062Z",fill:"white"})],-1)]))],512),L("div",GR,[Q(n).length?(X(),oe("ul",QR,[(X(!0),oe(Be,null,En(Q(n),(d,p)=>(X(),oe("li",{key:p,class:"results-list__item"},[L("div",{class:"results-list__link",to:"/words/all",onClick:g=>Q(l)(d)},[L("span",null,rt(d.word),1),L("span",null,rt(d.direction+" words"),1)],8,YR)]))),128))])):(X(),oe("p",JR," Nothing found "))]),(X(),xt(Bs,{to:"body"},[de(Ya,{name:"opacity"},{default:St(()=>[Q(r)?(X(),oe("div",{class:"search__cover cover",onClick:u[3]||(u[3]=(...d)=>Q(i)&&Q(i)(...d)),key:"search-cover"})):pt("",!0)]),_:1})]))],2))}});function XR(){const t=ge([]),e=ge({all:0,repeat:0,learned:0});function n(s){return t.value.filter(i=>i.directions[s]===!0).length}function r(s){t.value=s,e.value.all=n("all"),e.value.repeat=n("repeat"),e.value.learned=n("learned")}return{coutsData:e,getCounts:r}}const ZR={class:"menu"},e2={class:"menu__list menu-list"},t2={class:"card__head card-head"},n2={class:"card-head__icon filling filling--round"},r2=["src"],s2={class:"card-head__digits digits"},i2={class:"digits__digit"},o2={class:"card__title"},a2=He({__name:"Menu",setup(t){const e=Rr(),n=we(()=>e.wordsList),{coutsData:r,getCounts:s}=XR(),i=ge([{icon:"/Re.Words//images/repeat-icon.svg",count:we(()=>r.value.all),title:"All",router:"/words/all"},{icon:"/Re.Words//images/repeat-icon.svg",count:we(()=>r.value.repeat),title:"Repeat",router:"/words/repeat"},{icon:"/Re.Words//images/learned-icon.svg",count:we(()=>r.value.learned),title:"Learned",router:"/words/learned"}]);return Jr(async()=>{await e.reloadWords(),s(n.value)}),mt(()=>e.wordsList,()=>{s(n.value)}),(o,l)=>{const c=gu("router-link");return X(),oe("nav",ZR,[L("ul",e2,[(X(!0),oe(Be,null,En(i.value,(u,d)=>(X(),oe("li",{key:d,class:"menu-list__item"},[de(c,{class:"menu-list__link card filling",to:u.router},{default:St(()=>[L("div",t2,[L("div",n2,[L("img",{class:"card-head__icon-img",src:u.icon,alt:"icon"},null,8,r2)]),L("div",s2,[L("div",i2,rt(u.count),1),l[0]||(l[0]=L("svg",{width:"6",height:"10",viewBox:"0 0 6 10",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M4.3148 4.9981L1.12138 8.36512C1.03345 8.45761 0.985075 8.58127 0.985075 8.71312C0.985075 8.84505 1.03345 8.96863 1.12138 9.06127L1.4012 9.35615C1.489 9.44893 1.60635 9.5 1.73141 9.5C1.85647 9.5 1.97369 9.44893 2.06155 9.35615L5.86383 5.34741C5.95204 5.25449 6.00035 5.13032 6 4.99832C6.00035 4.86573 5.95211 4.74171 5.86383 4.64871L2.06509 0.643854C1.97723 0.551074 1.86001 0.5 1.73488 0.5C1.60982 0.5 1.4926 0.551074 1.40467 0.643854L1.12492 0.938732C0.942879 1.13066 0.942879 1.4431 1.12492 1.63495L4.3148 4.9981Z",fill:"white"})],-1))])]),L("h2",o2,rt(u.title),1)]),_:2},1032,["to"])]))),128))])])}}});function qy(){const t=ge(!1);function e(){t.value=!t.value}return{isPopupVisible:t,togglePopup:e}}const l2={class:"popup",key:"addPopup"},c2={class:"container"},u2={class:"popup__inner"},h2={class:"popup__title"},Wy=He({__name:"Popup",props:{isShow:{type:Boolean}},setup(t){return(e,n)=>(X(),xt(Bs,{to:"body"},[de(Ya,{name:"opacity"},{default:St(()=>[e.isShow?(X(),oe("div",l2,[L("div",c2,[L("div",u2,[L("h2",h2,[Ed(e.$slots,"header")]),Ed(e.$slots,"content")])])])):pt("",!0)]),_:3})]))}});function d2(t){const e=In();let n=!0;const r={languagesStateFromError:!1,languagesStateToError:!1,wordError:!1,translateError:!1,addToError:!1};return[{field:t.languagesState.from,errorMessage:"Please select a language: from"},{field:t.languagesState.to,errorMessage:"Please select a language: to"},{field:t.word,errorMessage:"Please enter a word"},{field:t.translate,errorMessage:"Please enter a translation"},{field:t.addTo,errorMessage:"Please select a direction"}].forEach(({field:i,errorMessage:o})=>{var c;let l=(typeof i.chosenValue=="string"?!i.chosenValue:!((c=i.chosenValue)!=null&&c.longString))&&!i.value;i===t.addTo&&(l=!t.addTo.chosenValue),l&&(n=!1,e.showAlert(o,"alert--error"),i===t.languagesState.from&&(r.languagesStateFromError=!0),i===t.languagesState.to&&(r.languagesStateToError=!0),i===t.word&&(r.wordError=!0),i===t.translate&&(r.translateError=!0),i===t.addTo&&(r.addToError=!0))}),n?!0:r}const _s={Afrikaans:"af",Albanian:"sq",Amharic:"am",Arabic:"ar",Armenian:"hy",Azerbaijani:"az",Basque:"eu",Belarusian:"be",Bengali:"bn",Bosnian:"bs",Bulgarian:"bg",Catalan:"ca",Cebuano:"ceb",Chinese:"zh",Corsican:"co",Croatian:"hr",Czech:"cs",Danish:"da",Dutch:"nl",English:"en",Esperanto:"eo",Estonian:"et",Finnish:"fi",French:"fr",Frisian:"fy",Galician:"gl",Georgian:"ka",German:"de",Greek:"el",Gujarati:"gu","Haitian Creole":"ht",Hausa:"ha",Hawaiian:"haw",Hebrew:"he",Hindi:"hi",Hmong:"hmn",Hungarian:"hu",Icelandic:"is",Igbo:"ig",Indonesian:"id",Irish:"ga",Italian:"it",Japanese:"ja",Javanese:"jv",Kannada:"kn",Kazakh:"kk",Khmer:"km",Kinyarwanda:"rw",Korean:"ko",Kurdish:"ku",Kyrgyz:"ky",Lao:"lo",Latin:"la",Latvian:"lv",Lithuanian:"lt",Luxembourgish:"lb",Macedonian:"mk",Malagasy:"mg",Malay:"ms",Malayalam:"ml",Maltese:"mt",Maori:"mi",Marathi:"mr",Mongolian:"mn",Myanmar:"my",Nepali:"ne",Norwegian:"no",Odia:"or",Pashto:"ps",Persian:"fa",Polish:"pl",Portuguese:"pt",Punjabi:"pa",Romanian:"ro",Russian:"ru",Samoan:"sm","Scots Gaelic":"gd",Serbian:"sr",Sesotho:"st",Shona:"sn",Sindhi:"sd",Sinhala:"si",Slovak:"sk",Slovenian:"sl",Somali:"so",Spanish:"es",Sundanese:"su",Swahili:"sw",Swedish:"sv",Tagalog:"tl",Tajik:"tg",Tamil:"ta",Tatar:"tt",Telugu:"te",Thai:"th",Turkish:"tr",Turkmen:"tk",Ukrainian:"uk",Urdu:"ur",Uyghur:"ug",Uzbek:"uz",Vietnamese:"vi",Welsh:"cy",Xhosa:"xh",Yiddish:"yi",Yoruba:"yo",Zulu:"zu"};function Ko(t,e){return e?[...Object.keys(_s)].filter(n=>n!==t):[...Object.keys(_s)].filter(n=>n!==t)}async function f2(t){const e=Rr(),n=In(),r=Ys(),s=_o(),i={id:E_(),word:t.word.value,translate:t.translate.value,fromLanguage:t.languagesState.from.chosenValue.longString,fromLanguageCode:t.languagesState.from.chosenValue.shortString,toLanguage:t.languagesState.to.chosenValue.longString,toLanguageCode:t.languagesState.to.chosenValue.shortString,directions:{all:!0,repeat:t.addTo.chosenValue==="repeat words",learned:t.addTo.chosenValue==="learned words"},category:t.category.value!==""?t.category.value:"Uncategorized",createdAt:new Date};if(r.userId)try{await HR(yl(s,`users/${r.userId}/words`,i.id),i),n.showAlert("Word added successfully!","alert--success"),e.reloadWords()}catch(o){n.showAlert("Failed to add word: "+o.message,"alert--error")}else n.showAlert("User not authenticated","alert--error")}async function p2(t){const e=Rr(),n=In(),r=Ys(),s=_o();if(!r.userId){n.showAlert("User not authenticated","alert--error");return}try{const i=t.map(({id:o})=>zR(yl(s,`users/${r.userId}/words`,o)));await Promise.all(i),n.showAlert("Words deleted successfully!","alert--success"),e.reloadWords()}catch(i){n.showAlert("Failed to delete words: "+i.message,"alert--error")}}async function g2(t,e,n){const r=Rr(),s=In(),i=Ys(),o=_o();if(!i.userId){s.showAlert("User not authenticated","alert--error");return}try{const l=t.map(({id:c})=>By(yl(o,`users/${i.userId}/words`,c),{word:e,translate:n}));await Promise.all(l),s.showAlert("Words updated successfully!","alert--success"),r.reloadWords()}catch(l){s.showAlert("Failed to update words: "+l.message,"alert--error")}}async function Fp(t,e){const n=Rr(),r=In(),s=Ys(),i=_o();if(!s.userId){r.showAlert("User not authenticated","alert--error");return}const o=e==="repeat"?{"directions.learned":!1,"directions.repeat":!0}:{"directions.repeat":!1,"directions.learned":!0};try{const l=t.map(({id:c})=>By(yl(i,`users/${s.userId}/words`,c),o));await Promise.all(l),r.showAlert("Words updated successfully!","alert--success"),n.reloadWords()}catch(l){r.showAlert("Failed to update words: "+l.message,"alert--error")}}function m2(){const t=Rr(),e=sl(),n=ge({languagesState:{from:{langs:[...Object.keys(_s)],chosenValue:{longString:"",shortString:""},placeholder:"From",error:!1},to:{langs:[...Object.keys(_s)],chosenValue:{longString:"",shortString:""},placeholder:"To",error:!1}},word:{value:"",error:!1,placeholder:"Word"},translate:{value:"",error:!1,placeholder:"Translate"},category:{value:"",placeholder:"Category"},addTo:{directions:["all words","repeat words","learned words"],chosenValue:"all words",placeholder:"Add to:",error:!1}}),r=ge({languagesStateFromError:!1,languagesStateToError:!1,wordError:!1,translateError:!1,addToError:!1});mt(()=>n.value.languagesState.from.chosenValue.longString,l=>{const c=_s[l];n.value.languagesState.from.chosenValue.shortString=c,n.value.languagesState.to.langs=Ko(l,!0)}),mt(()=>n.value.languagesState.to.chosenValue.longString,l=>{const c=_s[l];n.value.languagesState.to.chosenValue.shortString=c,n.value.languagesState.from.langs=Ko(l,!1)});function s(){n.value.word.value="",n.value.translate.value=""}async function i(){const l=d2(n.value);if(typeof l=="object"&&l!==null)r.value=l;else{Object.keys(r.value).forEach(c=>r.value[c]=!1);try{e.showLoader(),await f2(n.value),t.reloadWords(),s()}catch(c){console.error(c)}finally{e.hideLoader()}}}function o(){const{from:l,to:c}=n.value.languagesState,u={...l};n.value.languagesState.from.chosenValue={...c.chosenValue},n.value.languagesState.from.langs=Ko(c.chosenValue.longString,!1),n.value.languagesState.to.chosenValue={...u.chosenValue},n.value.languagesState.to.langs=Ko(u.chosenValue.longString,!0)}return{form:n,formErrors:r,submitForm:i,replaceLang:o}}function _2(t){return ru()?(Jp(t),!0):!1}function Ni(t){return typeof t=="function"?t():Q(t)}const Hy=typeof window<"u"&&typeof document<"u";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const y2=Object.prototype.toString,v2=t=>y2.call(t)==="[object Object]",la=()=>{},w2=E2();function E2(){var t,e;return Hy&&((t=window==null?void 0:window.navigator)==null?void 0:t.userAgent)&&(/iP(?:ad|hone|od)/.test(window.navigator.userAgent)||((e=window==null?void 0:window.navigator)==null?void 0:e.maxTouchPoints)>2&&/iPad|Macintosh/.test(window==null?void 0:window.navigator.userAgent))}const zy=Hy?window:void 0;function yi(t){var e;const n=Ni(t);return(e=n==null?void 0:n.$el)!=null?e:n}function cc(...t){let e,n,r,s;if(typeof t[0]=="string"||Array.isArray(t[0])?([n,r,s]=t,e=zy):[e,n,r,s]=t,!e)return la;Array.isArray(n)||(n=[n]),Array.isArray(r)||(r=[r]);const i=[],o=()=>{i.forEach(d=>d()),i.length=0},l=(d,p,g,m)=>(d.addEventListener(p,g,m),()=>d.removeEventListener(p,g,m)),c=mt(()=>[yi(e),Ni(s)],([d,p])=>{if(o(),!d)return;const g=v2(p)?{...p}:p;i.push(...n.flatMap(m=>r.map(T=>l(d,m,T,g))))},{immediate:!0,flush:"post"}),u=()=>{c(),o()};return _2(u),u}let Up=!1;function T2(t,e,n={}){const{window:r=zy,ignore:s=[],capture:i=!0,detectIframe:o=!1}=n;if(!r)return la;w2&&!Up&&(Up=!0,Array.from(r.document.body.children).forEach(C=>C.addEventListener("click",la)),r.document.documentElement.addEventListener("click",la));let l=!0;const c=C=>Ni(s).some(P=>{if(typeof P=="string")return Array.from(r.document.querySelectorAll(P)).some(O=>O===C.target||C.composedPath().includes(O));{const O=yi(P);return O&&(C.target===O||C.composedPath().includes(O))}});function u(C){const P=Ni(C);return P&&P.$.subTree.shapeFlag===16}function d(C,P){const O=Ni(C),N=O.$.subTree&&O.$.subTree.children;return N==null||!Array.isArray(N)?!1:N.some($=>$.el===P.target||P.composedPath().includes($.el))}const p=C=>{const P=yi(t);if(C.target!=null&&!(!(P instanceof Element)&&u(t)&&d(t,C))&&!(!P||P===C.target||C.composedPath().includes(P))){if(C.detail===0&&(l=!c(C)),!l){l=!0;return}e(C)}};let g=!1;const m=[cc(r,"click",C=>{g||(g=!0,setTimeout(()=>{g=!1},0),p(C))},{passive:!0,capture:i}),cc(r,"pointerdown",C=>{const P=yi(t);l=!c(C)&&!!(P&&!C.composedPath().includes(P))},{passive:!0}),o&&cc(r,"blur",C=>{setTimeout(()=>{var P;const O=yi(t);((P=r.document.activeElement)==null?void 0:P.tagName)==="IFRAME"&&!(O!=null&&O.contains(r.document.activeElement))&&e(C)},0)})].filter(Boolean);return()=>m.forEach(C=>C())}const I2=["placeholder"],A2=["onClick"],b2=["value"],ca=He({__name:"CustomSelect",props:{options:{},modelValue:{},filterExcludeValue:{},placeholder:{},error:{type:Boolean},withSearch:{type:Boolean}},emits:["update:modelValue"],setup(t,{emit:e}){const n=t,r=e,s=ge(!1),i=ge(null),o=ge(""),l=we({get:()=>n.modelValue,set:g=>r("update:modelValue",g)}),c=we(()=>l.value||n.placeholder),u=we(()=>{let g=n.options.filter(m=>m!==n.filterExcludeValue);return n.withSearch?g.filter(m=>m.toLowerCase().includes(o.value.toLowerCase())):g}),d=()=>{s.value=!s.value},p=g=>{l.value=g,o.value=g,s.value=!1};return T2(i,()=>s.value=!1),mt(l,g=>{o.value=g}),(g,m)=>(X(),oe("div",{class:"form__select select",ref_key:"selectRef",ref:i},[L("div",{class:We(["select__custom-select custom-select",{open:s.value,"select--search":n.withSearch}]),onClick:d},[n.withSearch?tn((X(),oe("input",{key:0,type:"text","onUpdate:modelValue":m[0]||(m[0]=T=>o.value=T),placeholder:Q(n.placeholder),class:We(["select-selected filling",{"filling--error":n.error}]),onFocus:m[1]||(m[1]=T=>s.value=!0),onClick:m[2]||(m[2]=ji(()=>{},["stop"]))},null,42,I2)),[[mn,o.value]]):(X(),oe("div",{key:1,class:We(["select-selected filling",{"filling--error":n.error}])},rt(g.placeholder)+" "+rt(c.value),3)),L("div",{class:We(["select-items filling filling--without-focus",{"filling--error":n.error}])},[(X(!0),oe(Be,null,En(u.value,T=>(X(),oe("div",{key:T,onClick:ji(C=>p(T),["stop"]),class:We({selected:T===l.value})},[L("span",null,rt(T),1)],10,A2))),128))],2)],2),tn(L("select",{"onUpdate:modelValue":m[3]||(m[3]=T=>l.value=T),class:"real-select",style:{display:"none"}},[(X(!0),oe(Be,null,En(n.options,T=>(X(),oe("option",{key:T,value:T},rt(T),9,b2))),128))],512),[[lm,l.value]])],512))}}),C2={class:"adder"},S2={class:"adder__form form"},R2={class:"form__wrapper"},P2={class:"form__box form-box"},k2=["placeholder"],V2={class:"form__box form-box"},O2=["placeholder"],D2={class:"form__box form-box"},N2=["placeholder"],L2={class:"form__buttons buttons"},x2=He({__name:"AddWordForm",emits:["updatePopupVisibility"],setup(t,{emit:e}){const{form:n,formErrors:r,submitForm:s,replaceLang:i}=m2(),o=e;return(l,c)=>(X(),oe("div",C2,[L("form",S2,[L("div",R2,[de(ca,{options:Q(n).languagesState.from.langs,modelValue:Q(n).languagesState.from.chosenValue.longString,"onUpdate:modelValue":c[0]||(c[0]=u=>Q(n).languagesState.from.chosenValue.longString=u),placeholder:Q(n).languagesState.from.placeholder,error:Q(r).languagesStateFromError,selectedOptionWithPlaceholder:!1,withSearch:!0},null,8,["options","modelValue","placeholder","error"]),L("div",{class:"form__replace filling filling--round",onClick:c[1]||(c[1]=(...u)=>Q(i)&&Q(i)(...u))},c[9]||(c[9]=[L("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M4.42684 4.8332H12.4215L11.3328 5.85379C11.1343 6.03876 11.0174 6.295 11.0079 6.56614C10.9983 6.83729 11.0968 7.10113 11.2818 7.29963C11.4668 7.49813 11.723 7.61502 11.9942 7.62459C12.2653 7.63416 12.5291 7.53562 12.7276 7.35066L15.6874 4.56105C15.7861 4.46302 15.8645 4.34642 15.918 4.21797C15.9714 4.08952 15.999 3.95175 15.999 3.81261C15.999 3.67347 15.9714 3.53571 15.918 3.40726C15.8645 3.27881 15.7861 3.16221 15.6874 3.06418L12.7276 0.274565C12.5291 0.0896024 12.2653 -0.00893263 11.9942 0.000637268C11.723 0.0102072 11.4668 0.127098 11.2818 0.325595C11.0968 0.524091 10.9983 0.787935 11.0079 1.05908C11.0174 1.33023 11.1343 1.58647 11.3328 1.77143L12.4215 2.79202H4.42684C4.15616 2.79202 3.89657 2.89955 3.70517 3.09095C3.51378 3.28234 3.40625 3.54193 3.40625 3.81261C3.40625 4.08329 3.51378 4.34288 3.70517 4.53428C3.89657 4.72568 4.15616 4.8332 4.42684 4.8332Z",fill:"white"}),L("path",{d:"M3.27132 14.835C3.36961 14.9266 3.48497 14.9979 3.61082 15.0449C3.73667 15.0919 3.87055 15.1137 4.00481 15.109C4.13907 15.1042 4.27108 15.0731 4.3933 15.0173C4.51553 14.9616 4.62557 14.8823 4.71716 14.784C4.80874 14.6857 4.88007 14.5704 4.92707 14.4445C4.97407 14.3187 4.99582 14.1848 4.99109 14.0505C4.98635 13.9163 4.95521 13.7842 4.89945 13.662C4.8437 13.5398 4.76441 13.4298 4.66613 13.3382L3.5775 12.3176H11.5721C11.8428 12.3176 12.1024 12.2101 12.2938 12.0187C12.4852 11.8273 12.5927 11.5677 12.5927 11.297C12.5927 11.0263 12.4852 10.7667 12.2938 10.5753C12.1024 10.3839 11.8428 10.2764 11.5721 10.2764H3.5775L4.66613 9.25581C4.86463 9.07084 4.98152 8.8146 4.99109 8.54346C5.00066 8.27231 4.90212 8.00847 4.71716 7.80997C4.53219 7.61147 4.27596 7.49458 4.00481 7.48501C3.73366 7.47544 3.46982 7.57398 3.27132 7.75894L0.311609 10.5486C0.212864 10.6466 0.134494 10.7632 0.0810139 10.8916C0.0275334 11.0201 0 11.1578 0 11.297C0 11.4361 0.0275334 11.5739 0.0810139 11.7023C0.134494 11.8308 0.212864 11.9474 0.311609 12.0454L3.27132 14.835Z",fill:"white"})],-1)])),de(ca,{options:Q(n).languagesState.to.langs,modelValue:Q(n).languagesState.to.chosenValue.longString,"onUpdate:modelValue":c[2]||(c[2]=u=>Q(n).languagesState.to.chosenValue.longString=u),placeholder:Q(n).languagesState.to.placeholder,error:Q(r).languagesStateToError,selectedOptionWithPlaceholder:!1,withSearch:!0},null,8,["options","modelValue","placeholder","error"])]),L("div",P2,[tn(L("input",{class:We(["form-box__input filling filling--input filling--notblured",{"filling--error":Q(r).wordError}]),type:"text",placeholder:Q(n).word.placeholder,"onUpdate:modelValue":c[3]||(c[3]=u=>Q(n).word.value=u)},null,10,k2),[[mn,Q(n).word.value]])]),L("div",V2,[tn(L("input",{class:We(["form-box__input filling filling--input filling--notblured",{"filling--error":Q(r).translateError}]),type:"text",placeholder:Q(n).translate.placeholder,"onUpdate:modelValue":c[4]||(c[4]=u=>Q(n).translate.value=u)},null,10,O2),[[mn,Q(n).translate.value]])]),L("div",D2,[tn(L("input",{class:"form-box__input filling filling--input filling--notblured",type:"text",placeholder:Q(n).category.placeholder,"onUpdate:modelValue":c[5]||(c[5]=u=>Q(n).category.value=u)},null,8,N2),[[mn,Q(n).category.value]])]),de(ca,{options:Q(n).addTo.directions,modelValue:Q(n).addTo.chosenValue,"onUpdate:modelValue":c[6]||(c[6]=u=>Q(n).addTo.chosenValue=u),placeholder:Q(n).addTo.placeholder,error:Q(r).addToError,withSearch:!1},null,8,["options","modelValue","placeholder","error"]),L("div",L2,[L("div",{class:"buttons__btn btn btn--transparent filling--notblured",onClick:c[7]||(c[7]=u=>o("updatePopupVisibility"))}," Cancel "),L("button",{class:"buttons__btn btn btn--white",type:"button",onClick:c[8]||(c[8]=ji((...u)=>Q(s)&&Q(s)(...u),["prevent"]))}," Add ")])])]))}}),Ky=He({__name:"AddWordButton",setup(t){const{isPopupVisible:e,togglePopup:n}=qy();return(r,s)=>(X(),oe("div",{class:"add",onClick:s[0]||(s[0]=(...i)=>Q(n)&&Q(n)(...i))},[s[2]||(s[2]=L("div",{class:"add__icon filling filling--round"},[L("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M7 1V13",stroke:"white","stroke-width":"2","stroke-linecap":"round"}),L("path",{d:"M1 7L13 7",stroke:"white","stroke-width":"2","stroke-linecap":"round"})])],-1)),de(Wy,{isShow:Q(e)},{header:St(()=>s[1]||(s[1]=[Ga("Add word")])),content:St(()=>[de(x2,{onUpdatePopupVisibility:Q(n)},null,8,["onUpdatePopupVisibility"])]),_:1},8,["isShow"])]))}}),M2={class:"home page"},F2={class:"container"},U2={class:"home__inner"},$2=He({__name:"MenuView",setup(t){return(e,n)=>(X(),oe("div",M2,[L("div",F2,[L("div",U2,[de(T_,{title:"Words",isBack:!1,class:"home__head"}),de(jy,{class:"home__search"}),de(a2,{class:"home__menu"})])]),(X(),xt(Bs,{to:"body"},[de(Ky)]))]))}}),B2={class:"tub__text"},j2={class:"tub__quantity"},$p=He({__name:"Tub",props:{item:{},index:{},isActive:{type:Boolean}},emits:["updateActiveTub"],setup(t){return(e,n)=>{var r,s;return X(),oe("div",{class:We(["tubs__tub tub filling",{"tub--active":e.isActive}]),onClick:n[0]||(n[0]=i=>e.$emit("updateActiveTub",e.index))},[L("div",B2,rt((r=e.item)==null?void 0:r.text),1),L("div",j2,rt((s=e.item)==null?void 0:s.count),1)],2)}}}),q2={class:"tubs"},W2={class:"tubs__section"},H2={class:"tubs__list"},z2={class:"tubs__section"},K2={class:"tubs__list"},G2=He({__name:"Tubs",props:{langs:{},categories:{},activeLangTub:{},activeCategoryTub:{}},emits:["updateActiveTub"],setup(t,{emit:e}){const n=e;return(r,s)=>(X(),oe("div",q2,[L("div",W2,[L("div",H2,[(X(!0),oe(Be,null,En(r.langs,(i,o)=>(X(),xt($p,{key:o,item:i,index:o,isActive:o===r.activeLangTub,onUpdateActiveTub:l=>{n("updateActiveTub",o,"langs")}},null,8,["item","index","isActive","onUpdateActiveTub"]))),128))])]),L("div",z2,[L("div",K2,[(X(!0),oe(Be,null,En(r.categories,(i,o)=>(X(),xt($p,{key:o,item:i,index:o,isActive:o===r.activeCategoryTub,onUpdateActiveTub:l=>{n("updateActiveTub",o,"categories")}},null,8,["item","index","isActive","onUpdateActiveTub"]))),128))])])]))}});function Gy(){const t=In();async function e(r){try{const s=r.map(i=>`${i.word} - ${i.translate}`).join(`
`);if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(s);else{const i=document.createElement("textarea");i.value=s,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i)}t.showAlert("Copied successfully!","alert--success")}catch{t.showAlert("Copy failed!","alert--error")}}async function n(r,s,i){if(s.length)switch(r){case"Copy":e(s);break;case"Add to learned":Fp(s,"learned");break;case"Add to repeat":Fp(s,"repeat");break;case"Edit":i&&g2(s,i.word,i.translation);break;case"Delete":p2(s);break}}return{handleOption:n}}function Q2(){const t=ge(!1),e=ge({});function n(i,o,l){o?e.value[i]={state:!0,word:l}:delete e.value[i],t.value=Object.keys(e.value).length>0}const r=we(()=>Object.values(e.value).map(i=>i.word));function s(){e.value={},t.value=!1}return{withCheckboxes:t,checkboxesSelectedMap:e,selectedWords:r,updateSelect:n,resetSelect:s}}function Y2(t=250){const e=ge(null),n=ge(null),r=ge(0),s=ge(!1),i=ge(null),o=we(()=>r.value===0?1:1-r.value/100),l=we(()=>i.value?{top:i.value.top,translateY:window.innerHeight/1.8-(i.value.top+i.value.height/1.8)}:{top:0,translateY:0}),c=we(()=>({transform:`scale(${o.value}) translateY(${s.value?l.value.translateY+"px":"0"})`})),u=we(()=>i.value?{transform:`translateY(${l.value.translateY}px)`,top:`${l.value.top+48}px`}:{transform:"translateY(0px)",top:"0px"}),d=()=>{r.value+=.5,n.value=requestAnimationFrame(d)},p=P=>{g(),T(P),s.value=!1,n.value=requestAnimationFrame(d),e.value=window.setTimeout(()=>{s.value=!0,cancelAnimationFrame(n.value),r.value=0},t)},g=()=>{if(s.value){s.value=!1;return}},m=()=>{r.value>0?(r.value-=.5,n.value=requestAnimationFrame(m)):(cancelAnimationFrame(n.value),n.value=null)},T=P=>{const N=P.currentTarget.getBoundingClientRect();i.value=N};return{pressTime:r,isLongPress:s,scaleValue:o,wordPosition:l,handleTouchStart:p,handleTouchEnd:()=>{e.value!==null&&(clearTimeout(e.value),e.value=null),cancelAnimationFrame(n.value),n.value=null,s.value||(n.value=requestAnimationFrame(m))},disableLongPress:g,wordComputedPosition:c,optionsPosition:u}}const J2={class:"options"},X2={class:"options-block__list"},Z2=["onTouchend"],eP={key:0,class:"options-block__text"},tP={class:"options-options__icon"},nP=["src"],Qy=He({__name:"WordOptions",props:{optionsPosition:{},isShow:{type:Boolean},variant:{}},emits:["updateOption","closeOptions"],setup(t,{emit:e}){const n=t,r=Ht("optionsType"),s=we(()=>r==="all"?[{optionName:"Add to learned",optionIcon:"/Re.Words//images/learned-icon.svg"},{optionName:"Add to repeat",optionIcon:"/Re.Words//images/repeat-icon.svg"}]:r==="repeat"?[{optionName:"Add to learned",optionIcon:"/Re.Words//images/learned-icon.svg"}]:r==="learned"?[{optionName:"Add to repeat",optionIcon:"/Re.Words//images/repeat-icon.svg"}]:[]),i=we(()=>[{optionName:"Copy",optionIcon:"/Re.Words//images/copy-icon.svg"},...s.value,{optionName:"Edit",optionIcon:"/Re.Words//images/edit-icon.svg"},{optionName:"Delete",optionIcon:"/Re.Words//images/delete-icon.svg"},{optionName:"Select",optionIcon:"/Re.Words//images/select-icon.svg"}]),o=we(()=>[{optionName:"Copy",optionIcon:"/Re.Words//images/copy-icon.svg"},...s.value,{optionName:"Delete",optionIcon:"/Re.Words//images/delete-icon.svg"}]),l=we(()=>n.variant==="single"?i.value:o.value),c=we(()=>n.variant==="single"?n.optionsPosition:{bottom:"30px",left:"50%",transform:"translateX(-50%)"}),u=e;return(d,p)=>(X(),xt(Bs,{to:"body"},[L("div",J2,[de(va,{name:"opacity"},{default:St(()=>[d.variant==="single"&&d.isShow?(X(),oe("div",{key:"options-cover",class:"options__cover cover",onTouchstart:p[0]||(p[0]=g=>u("closeOptions"))},null,32)):pt("",!0),d.isShow?(X(),oe("div",{key:"options-block",class:We(["options-block filling filling--without-focus",{"options-block--multiple":d.variant==="multiple","filling--notblured":d.variant==="single"}]),style:$s(c.value)},[L("ul",X2,[(X(!0),oe(Be,null,En(l.value,(g,m)=>(X(),oe("li",{class:We(["options-block__item",{"options-block__item--delete":g.optionName==="Delete"}]),key:g.optionName,onTouchend:T=>u("updateOption",g.optionName)},[d.variant==="single"?(X(),oe("div",eP,rt(g.optionName),1)):pt("",!0),L("div",tP,[L("img",{src:g.optionIcon,alt:"icon"},null,8,nP)])],42,Z2))),128))])],6)):pt("",!0)]),_:1})])]))}}),rP={class:"edit"},sP={class:"edit__form form"},iP={class:"form__box form-box"},oP={class:"form__box form-box"},aP={class:"form__buttons buttons"},lP=He({__name:"EditWord",emits:["updatePopupVisibility","updateWord"],setup(t,{emit:e}){const n=In(),r=e,s=ge({word:"",translation:""}),i=ge({wordError:!1,translateError:!1});function o(){return s.value.word.length===0?(i.value.wordError=!0,n.showAlert("Word is empty","alert--error")):i.value.wordError=!1,s.value.translation.length===0?(i.value.translateError=!0,n.showAlert("Translation is empty","alert--error")):i.value.translateError=!1,i.value.wordError||i.value.translateError}function l(){o()||(r("updateWord",s.value),r("updatePopupVisibility"))}return(c,u)=>(X(),oe("div",rP,[L("form",sP,[L("div",iP,[tn(L("input",{class:We(["form-box__input filling filling--input filling--notblured",{"filling--error":i.value.wordError}]),type:"text",placeholder:"New word","onUpdate:modelValue":u[0]||(u[0]=d=>s.value.word=d)},null,2),[[mn,s.value.word]])]),L("div",oP,[tn(L("input",{class:We(["form-box__input filling filling--input filling--notblured",{"filling--error":i.value.translateError}]),type:"text",placeholder:"New translation","onUpdate:modelValue":u[1]||(u[1]=d=>s.value.translation=d)},null,2),[[mn,s.value.translation]])]),L("div",aP,[L("div",{class:"buttons__btn btn btn--transparent filling--notblured",onClick:u[2]||(u[2]=d=>r("updatePopupVisibility"))}," Cancel "),L("button",{class:"buttons__btn btn btn--white",type:"button",onClick:ji(l,["prevent"])}," Apply ")])])]))}}),cP={key:0,width:"16",height:"12",viewBox:"0 0 16 12",fill:"none",xmlns:"http://www.w3.org/2000/svg"},uP={class:"word__raw"},hP={class:"word__index"},dP={class:"word__translate"},fP=He({__name:"Word",props:{word:{},index:{},id:{},isSelected:{type:Boolean},withCheckbox:{type:Boolean},isActive:{type:Boolean}},emits:["updateSelect","updateActiveWordRef"],setup(t,{emit:e}){const n=t,r=e,{isPopupVisible:s,togglePopup:i}=qy(),{isLongPress:o,handleTouchStart:l,handleTouchEnd:c,disableLongPress:u,wordComputedPosition:d,optionsPosition:p}=Y2(),{handleOption:g}=Gy();function m(F,H){const ee=[n.word];if(F==="Select")r("updateSelect",n.index,!n.isSelected,n.word);else if(F==="Edit"&&!H){i(),setTimeout(u,500);return}else g(F,ee,H);u()}const T=ge(0),C=ge(!1),P=(F,H)=>{n.withCheckbox||(H==="start"&&(C.value=!1,T.value=F.touches[0].clientY,l(F)),H==="end"&&c())},O=F=>{const H=F.touches[0].clientY;Math.abs(H-T.value)>10&&(C.value=!0,u())},N=ge(null),$=()=>{n.isActive&&N.value&&r("updateActiveWordRef",N.value)};return Jr(()=>{$()}),mt(()=>n.isActive,F=>{F&&$()}),(F,H)=>(X(),oe("div",{class:We(["word",{"word--active":Q(o)}]),ref_key:"wordRef",ref:N},[F.withCheckbox?(X(),oe("div",{key:0,class:"word__checkbox checkbox filling filling--round",onClick:H[0]||(H[0]=ee=>r("updateSelect",F.index,!F.isSelected,F.word))},[de(Ya,{name:"opacity"},{default:St(()=>[F.isSelected?(X(),oe("svg",cP,H[4]||(H[4]=[L("path",{d:"M2.25 6.0013L6.08333 9.83464L13.75 2.16797",stroke:"#EEEEEE","stroke-width":"3","stroke-linecap":"round","stroke-linejoin":"round"},null,-1)]))):pt("",!0)]),_:1})])):pt("",!0),L("div",{class:We(["word__inner filling",{"filling--active":F.isActive}]),onTouchstart:H[1]||(H[1]=ee=>P(ee,"start")),onTouchend:H[2]||(H[2]=ee=>P(ee,"end")),onTouchmove:O,style:$s(Q(d))},[L("div",uP,[L("span",hP,rt(F.index+1+"."),1),L("span",null,rt(F.word.word),1)]),L("div",dP,rt(F.word.translate),1)],38),de(Qy,{isShow:Q(o),optionsPosition:Q(p),onUpdateOption:m,onCloseOptions:Q(u),variant:"single"},null,8,["isShow","optionsPosition","onCloseOptions"]),de(Wy,{isShow:Q(s)},{header:St(()=>H[5]||(H[5]=[Ga("Edit word")])),content:St(()=>[de(lP,{onUpdatePopupVisibility:Q(i),onUpdateWord:H[3]||(H[3]=ee=>m("Edit",ee))},null,8,["onUpdatePopupVisibility"])]),_:1},8,["isShow"])],2))}}),pP={class:"words"},gP={class:"words__list words-list"},mP=He({__name:"Words",props:{wordsList:{}},setup(t){const e=yh(),n=t,{handleOption:r}=Gy(),{withCheckboxes:s,selectedWords:i,resetSelect:o,updateSelect:l,checkboxesSelectedMap:c}=Q2();mt(()=>n.wordsList,()=>{o()});function u(d){d.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{e.clearWord()},2e3)}return(d,p)=>(X(),oe("div",pP,[L("ul",gP,[(X(!0),oe(Be,null,En(d.wordsList,(g,m)=>{var T,C,P;return X(),oe("li",{key:m,class:"words-list__item"},[de(fP,{word:g,index:m,id:+g.id,class:We(["words-list__word",{"is-active":g.id===((T=Q(e).selectedWord)==null?void 0:T.id)}]),onUpdateSelect:Q(l),isSelected:((C=Q(c)[m])==null?void 0:C.state)??!1,withCheckbox:Q(s),isActive:g.id===((P=Q(e).selectedWord)==null?void 0:P.id),onUpdateActiveWordRef:u},null,8,["word","index","id","class","onUpdateSelect","isSelected","withCheckbox","isActive"])])}),128))]),de(Qy,{isShow:Q(s),onUpdateOption:p[0]||(p[0]=g=>Q(r)(g,Q(i))),variant:"multiple"},null,8,["isShow"])]))}}),_P=["src"],yP={key:0,class:"filter__text"},vP=He({__name:"Filter",props:{itemData:{},filterName:{}},emits:["chooseFilter","chooseSort"],setup(t,{emit:e}){const n=t,r=ge(n.itemData.select.startedSelectedOption||""),s=e;function i(){n.itemData.select.isSelect||s("chooseFilter",n.filterName)}function o(){s("chooseSort",r.value)}return mt(()=>r.value,()=>{o()}),(l,c)=>(X(),oe("div",{class:"filter",onClick:c[1]||(c[1]=u=>i())},[L("div",{class:We(["filter__icon filling filling--round",{"filling--active":l.itemData.state.isActive}])},[L("img",{src:l.itemData.icon,alt:"icon"},null,8,_P)],2),l.itemData.select.isSelect?pt("",!0):(X(),oe("div",yP,rt(l.itemData.text),1)),l.itemData.select.isSelect?(X(),xt(ca,{key:1,options:l.itemData.select.optionsList,modelValue:r.value,"onUpdate:modelValue":c[0]||(c[0]=u=>r.value=u),placeholder:l.itemData.text,selectedOptionWithPlaceholder:!0,withSearch:!1},null,8,["options","modelValue","placeholder"])):pt("",!0)]))}}),Yy=js("filtersStore",()=>{const t=ge({switchLanguage:{state:{isActive:!1}},sortBy:{state:{isActive:!0},select:{selectedOptions:{new:!0,old:!1,longest:!1,shortest:!1,alphabet:!1}}},switchMix:{state:{isActive:!1}}});function e(){t.value.switchLanguage.state.isActive=!1,t.value.switchMix.state.isActive=!1}function n(s){t.value[s].state.isActive=!t.value[s].state.isActive}function r(s){const i=t.value.sortBy.select.selectedOptions;for(let o of Object.keys(i))i[o]=!1;i[s]=!i[s]}return{filtersState:t,switchFilter:n,resetFilterState:e,switchSortOption:r}}),wP={class:"filters"},EP={class:"filters__list filters-list"},TP=He({__name:"Filters",props:{wordPair:{},withMix:{type:Boolean}},setup(t){const e=Yy(),n=t,r=ge({switchLanguage:{state:{isShowed:!0,isActive:we(()=>e.filtersState.switchLanguage.state.isActive)},select:{isSelect:!1},icon:"/Re.Words//images/replace-icon.svg",text:we(()=>`${n.wordPair.word} - ${n.wordPair.translate}`)},sortBy:{state:{isShowed:!0,isActive:we(()=>e.filtersState.sortBy.state.isActive)},select:{isSelect:!0,optionsList:["new","old","longest","shortest","alphabet"],startedSelectedOption:"new"},icon:"/Re.Words//images/sort-icon.svg",text:"Sort by:"},switchMix:{state:{isShowed:n.withMix,isActive:we(()=>e.filtersState.switchMix.state.isActive)},select:{isSelect:!1},icon:"/Re.Words//images/mix-icon.svg",text:"Mix"}});function s(o){e.switchFilter(o)}function i(o){e.switchSortOption(o)}return(o,l)=>(X(),oe("div",wP,[L("ul",EP,[(X(!0),oe(Be,null,En(r.value,(c,u)=>(X(),oe("li",{key:u,class:"filters-list__item"},[c&&c.state.isShowed?(X(),xt(vP,{key:0,class:"filters-list__filter",itemData:c,onChooseFilter:s,onChooseSort:i,filterName:u,startedSelectedOption:c.select.startedSelectedOption},null,8,["itemData","filterName","startedSelectedOption"])):pt("",!0)]))),128))])]))}}),IP={},AP={class:"empty"};function bP(t,e){return X(),oe("div",AP,e[0]||(e[0]=[L("svg",{width:"31",height:"30",viewBox:"0 0 31 30",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[L("path",{d:"M15.4976 12.2133L10.9235 7.63923C10.4842 7.19992 9.77182 7.19992 9.3325 7.63923L7.34375 9.62798L12.7133 14.9976L8.13923 19.5717C7.69992 20.011 7.69992 20.7233 8.13923 21.1627L10.128 23.1514L15.4976 17.7818L20.0717 22.3559C20.511 22.7952 21.2233 22.7952 21.6627 22.3559L23.6514 20.3672L18.2818 14.9976L22.8559 10.4235C23.2952 9.98415 23.2952 9.27182 22.8559 8.8325L20.8672 6.84375L15.4976 12.2133ZM15.5 29.625C7.42285 29.625 0.875 23.0771 0.875 15C0.875 6.92285 7.42285 0.375 15.5 0.375C23.5771 0.375 30.125 6.92285 30.125 15C30.125 23.0771 23.5771 29.625 15.5 29.625Z",fill:"white"})],-1),L("span",null," This is empty ",-1)]))}const CP=w_(IP,[["render",bP]]);function SP(){const t=ge([]),e=ge(),n=ge([]),r=ge([]),s=ge(0),i=ge(0);function o(T,C){var P;C==="langs"?(s.value=T,i.value=0):i.value=T,d(),p(((P=n.value[i.value])==null?void 0:P.ids)||[])}function l(T){return T.charAt(0).toUpperCase()+T.slice(1)}const c=we(()=>{const T={};return t.value.forEach(({fromLanguage:C,toLanguage:P,id:O})=>{const N=`${C.trim()} - ${P.trim()}`;T[N]||(T[N]={count:0,ids:[]}),T[N].count++,T[N].ids.push(O)}),Object.entries(T).map(([C,{count:P,ids:O}])=>({text:C,count:P,ids:O}))}),u=we(()=>{const T={};return t.value.forEach(({category:C,fromLanguage:P,toLanguage:O,id:N})=>{const $=`${C.trim().toLowerCase()}|${P.trim()}-${O.trim()}`;T[$]||(T[$]={count:0,ids:[]}),T[$].count++,T[$].ids.push(N)}),Object.entries(T).map(([C,{count:P,ids:O}])=>{const[N,$]=C.split("|");return{text:l(N),count:P,ids:O}})});function d(){var T;try{const C=u.value,P=c.value;s.value>=P.length&&(s.value=Math.max(P.length-1,0));const O=new Set(((T=P[s.value])==null?void 0:T.ids)||[]);n.value=C.filter(N=>N.ids.some($=>O.has($))),r.value=P,i.value>=n.value.length&&(i.value=Math.max(n.value.length-1,0))}catch(C){console.error("Ошибка при загрузке категорий и языков:",C)}}function p(T){e.value=t.value.filter(C=>T.some(P=>C.id.includes(P)))}function g(T){var C;try{const P=u.value||[],O=c.value||[],N=`${T.fromLanguage.trim()} - ${T.toLanguage.trim()}`,$=O.findIndex(S=>S.text===N);$!==-1&&(s.value=$),r.value=O;const F=new Set(((C=O[s.value])==null?void 0:C.ids)||[]);n.value=P.filter(S=>S.ids.some(v=>F.has(v)));const H=T.category.trim(),ee=n.value.findIndex(S=>S.text===H);ee!==-1&&(i.value=ee)}catch(P){console.error("Ошибка при загрузке категорий и языков:",P)}}function m(T,C){var P;T.length>0?(t.value=T,C&&Object.keys(C).length>0?g(C):d(),i.value=n.value.length>0?i.value:0,s.value=r.value.length>0?s.value:0,n.value.length>0?p(((P=n.value[i.value])==null?void 0:P.ids)||[]):e.value=[]):(t.value=[],n.value=[],r.value=[],e.value=[],s.value=0,i.value=0)}return{categories:n,langs:r,loadCategories:d,activeLangTub:s,activeCategoryTub:i,changeActiveTub:o,categoryWords:e,refreshCategoriesAndWords:m}}function RP(){const t=Yy(),e=In(),n=ge();mt(()=>t.filtersState.switchLanguage.state.isActive,(g,m)=>{g!==m&&o(n.value)}),mt(()=>t.filtersState.switchMix.state.isActive,(g,m)=>{g!==m&&u(n.value)});const r=ge("");mt(()=>t.filtersState.sortBy.select.selectedOptions,g=>{r.value=Object.keys(g).find(m=>g[m]===!0)??"new",d(n.value,r.value)},{deep:!0});const s=g=>g[0].toUpperCase()+g.slice(1),i=we(()=>{if(!n.value)return{word:"",translate:""};const{fromLanguageCode:g,toLanguageCode:m}=n.value[0];return t.filtersState.switchLanguage.state.isActive?{word:s(m),translate:s(g)}:{word:s(g),translate:s(m)}});function o(g){n.value=g.map(m=>({...m,word:m.translate,translate:m.word}))}let l=[],c=!1;function u(g){if(l.length||(l=[...g]),c)n.value=[...l];else if(g.length<=1)n.value=[...g],e.showAlert("Not enough words to mix!","alert--error");else{let m;do m=[...g].sort(()=>Math.random()-.5);while(JSON.stringify(m)===JSON.stringify(l));n.value=m}c=!c}function d(g,m){m==="new"&&(n.value=g.sort((T,C)=>C.createdAt.seconds-T.createdAt.seconds)),m==="old"&&(n.value=g.sort((T,C)=>T.createdAt.seconds-C.createdAt.seconds)),m==="longest"&&(n.value=g.sort((T,C)=>C.word.length-T.word.length)),m==="shortest"&&(n.value=g.sort((T,C)=>T.word.length-C.word.length)),m==="alphabet"&&(n.value=g.sort((T,C)=>T.word.localeCompare(C.word)))}function p(g){n.value=g,t.resetFilterState(),d(n.value,r.value)}return{filteredWords:n,resetFilter:p,wordPair:i}}const PP={class:"wordspage page"},kP={class:"container"},VP={class:"wordspage__inner"},OP=He({__name:"WordsList",setup(t){const e=uE(),n=Rr(),r=yh(),s=we(()=>e.params.category),i=we(()=>n.wordsList.filter(P=>P.directions[s.value])),{changeActiveTub:o,activeLangTub:l,activeCategoryTub:c,langs:u,categories:d,categoryWords:p,refreshCategoriesAndWords:g}=SP(),{filteredWords:m,wordPair:T,resetFilter:C}=RP();return Jr(()=>{n.reloadWords()}),K0(()=>{g(i.value,r.selectedWord)}),mt(()=>p.value,()=>C(p.value)),Ai("optionsType",s.value),(P,O)=>(X(),oe("div",PP,[L("div",kP,[L("div",VP,[de(T_,{title:`${s.value[0].toUpperCase()+s.value.slice(1)} words`,isBack:!0,class:"wordspage__head"},null,8,["title"]),i.value.length>0?(X(),oe(Be,{key:0},[de(jy,{class:"wordspage__search"}),de(G2,{class:"wordspage__tubs",langs:Q(u),categories:Q(d),activeLangTub:Q(l)||0,activeCategoryTub:Q(c)||0,onUpdateActiveTub:Q(o)},null,8,["langs","categories","activeLangTub","activeCategoryTub","onUpdateActiveTub"]),de(TP,{withMix:s.value==="repeat",class:"wordspage__filters",wordPair:Q(T)},null,8,["withMix","wordPair"]),de(mP,{class:"wordspage__words",wordsList:Q(m)||[]},null,8,["wordsList"])],64)):(X(),xt(CP,{key:1}))])]),(X(),xt(Bs,{to:"body"},[de(Ky)]))]))}}),Bp=(t,e,n)=>{let r=!1;Lu(Vs(),s=>{s&&!r?(r=!0,n()):!s&&!r&&(r=!0,n("/entrance"))})},DP=(t,e,n)=>{const r=Vs();Lu(r,s=>{s?n("/menu"):n()})},NP=[{path:"/",name:"greeting",component:lb,beforeEnter:DP},{path:"/menu",name:"menu",component:$2,beforeEnter:Bp},{path:"/entrance",name:"entrance",component:Ab},{path:"/words/:category",name:"words-list",component:OP,beforeEnter:Bp,props:!0}],LP=lE({history:Fw("/Re.Words/"),routes:NP});var xP="firebase",MP="11.0.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */hr(xP,MP,"app");const FP={key:0,class:"loader"},UP=He({__name:"Loader",setup(t){const e=sl(),n=we(()=>e.isLoading);return(r,s)=>(X(),xt(Ya,{name:"opacity"},{default:St(()=>[n.value?(X(),oe("div",FP,s[0]||(s[0]=[L("div",{class:"loader__inner"},[L("div",{class:"loader__circle"})],-1)]))):pt("",!0)]),_:1}))}}),$P={class:"alert"},BP={class:"alert__inner"},jP={class:"icon"},qP=["src"],WP={class:"message"},HP=He({__name:"Alert",setup(t){const e=In(),n={"alert--error":"/Re.Words//images/error-icon.svg","alert--warning":"/Re.Words//images/warning-icon.svg","alert--success":"/Re.Words//images/success-icon.svg"};return(r,s)=>(X(),oe("div",$P,[L("div",BP,[de(va,{name:"fade"},{default:St(()=>[(X(!0),oe(Be,null,En(Q(e).alerts,(i,o)=>(X(),oe("div",{key:i.id,class:We(["alert__item alert-item",i.class]),style:$s({transitionDelay:`${o*50}ms`})},[L("span",jP,[L("img",{src:n[i.class],alt:"icon"},null,8,qP)]),L("span",WP,rt(i.message),1)],6))),128))]),_:1})])]))}}),zP=He({__name:"App",setup(t){const e=Ys();return Jr(()=>{Lu(Vs(),n=>{n?e.userId=n.uid:e.userId=""})}),(n,r)=>(X(),oe(Be,null,[de(Q(Cm)),(X(),xt(Bs,{to:"body"},[de(HP),de(UP)]))],64))}}),KP=tw(),vh=J1(zP);vh.use(KP);vh.use(LP);Lm({apiKey:"AIzaSyBZYNWHpi28gT9EubW4T9vOaXRuQtJ_faI",authDomain:"rewords-842b9.firebaseapp.com",projectId:"rewords-842b9",storageBucket:"rewords-842b9.firebasestorage.app",messagingSenderId:"794162625825",appId:"1:794162625825:web:c64508775c4ad103379260"});vh.mount("#app");
